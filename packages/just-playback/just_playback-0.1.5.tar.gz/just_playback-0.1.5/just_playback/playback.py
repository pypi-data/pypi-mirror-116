...
class Playback:
    ...
    def __init__(self, path_to_file: Optional[str] = ''):
        ...
        if self.__ma_attrs.num_playback_devices < 1:
            raise MiniaudioError('No device playback device is available!!')
    ...
    def loop_at_end(self, loops_at_end: bool) -> None:
        """
            Make sure playback automatically restarts an audio file when 
            it plays to completion. By default this doesn't happen. Persists
            across audio file loads until reset
    ...
    @property
    def loops_at_end(self) -> None:
        return self.__ma_attrs.loops_at_end

    def __bind(self, ma_res: int) -> None:
        """ 
            Internal method for checking and throwing possible ma errors. DO NOT CALL
        """
