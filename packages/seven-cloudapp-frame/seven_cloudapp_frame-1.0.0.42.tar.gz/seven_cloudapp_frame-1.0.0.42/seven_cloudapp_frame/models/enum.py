...
@LastEditTime: 2021-08-17 10:19:45
...
class TaskType(Enum):
    ...
    buy_goods = 10
    # 下单指定金额，格式：{"effective_date_start":'1900-01-01 00:00:00',"effective_date_end":'1900-01-01 00:00:00',"satisfy_num":0,"limit_num":0,"goods_ids":"","goods_list":[],"reward_list":[{"key":"前端算唯一值","money":累计消费金额,"reward_value":0}],asset_object_id:""}
    arbitrarily_consumption = 11
    # 全店消费金额，格式：{"effective_date_start":'1900-01-01 00:00:00',"effective_date_end":'1900-01-01 00:00:00',"goods_ids":"","goods_list":[],"reward_list":[{"key":"前端算唯一值","money":累计消费金额,"reward_value":0}],asset_object_id:""}
    totle_consumption = 12
