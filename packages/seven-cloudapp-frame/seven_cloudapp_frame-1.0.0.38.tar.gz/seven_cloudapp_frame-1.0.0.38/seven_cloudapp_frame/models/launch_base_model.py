...
class LaunchBaseModel():
    ...
    def add_launch_goods(self, app_id, act_id, goods_id, old_goods_id,source_types):
        ...
        if total <= 0:
            ...
            launch_goods.throw_date = now_datetime
    ...
    def launch_goods_list(self,app_id,act_id,page_size,page_index,access_token,app_key, app_secret):
        ...
        if len(launch_goods_list) > 0:
            ...
            if "items_seller_list_get_response" in resq.keys():
                ...
                return self.response_json_error(resq["error_code"], resq["error_message"])
        else:
        ...
        invoke_result_data.data = {"is_throw": act_info_dict['is_launch'], "page_info": page_info.__dict__}
        return invoke_result_data