...
@LastEditTime: 2021-08-12 13:57:44
...
class UserBaseModel(FrameBaseModel):
    ...
    def update_user_info(self, app_id, act_id, user_id, open_id, user_nick, avatar):
        """
        ...
        try:
            ...
            if not user_info_dict:
                ...
                user_info_model.update_table("user_nick=%s,avatar=%s,modify_date=%s","id=%s",params=[user_info_dict["user_nick"],user_info_dict["avatar"],user_info_dict["modify_date"],user_info_dict["id"]])
    ...
    def get_prize_roster_list(self,app_id,act_id,user_id,open_id='',order_no='',goods_type=-1,prize_type=-1,logistics_status=-1,prize_status=-1,pay_status=-1,page_size=20,page_index=0,order_by="id desc",field="*",is_cache=True):
        """
