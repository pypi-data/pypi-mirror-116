...
@LastEditTime: 2021-08-18 09:20:00
...
class TaskBaseModel(FrameBaseModel):
    ...
    def process_one_sign(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_id,check_new_user=False,check_user_nick=True,continue_request_expire=5,task_sub_table=None,asset_sub_table=None,stat_sub_table=None):
        """
    ...
    def process_weekly_sign(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_id,check_new_user=False,check_user_nick=True,continue_request_expire=5,task_sub_table=None,asset_sub_table=None,stat_sub_table=None):
        """
    ...
    def process_favor_store(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_id,check_user_nick=True,continue_request_expire=5,asset_sub_table=None,stat_sub_table=None):
        """
    ...
    def process_join_member(self,app_id,act_id,module_id,user_id,login_token,handler_name,request_id,check_user_nick=True,continue_request_expire=5,asset_sub_table=None,stat_sub_table=None):
        """
