...
@LastEditTime: 2021-08-16 18:55:12
...
class TaskInfoListHandler(TaoBaseHandler):
    ...
    def get_async(self):
        ...
        return self.reponse_json_success(task_base_model.get_task_info_dict_list(app_id, act_id, module_id,is_release,False))
        ...
        for item in task_list:
            ...
            if "id" in item.keys():
                ...
                if task_info:
                    ...
                    task_info_model.update_entity(task_info, "complete_type,task_name,sort_index,is_release,task_config,modify_date")
