...
@LastEditTime: 2021-08-10 11:09:36
...
class FrameBaseHandler(BaseApiHandler):
    ...
    def check_continue_request(self, handler_name, app_id, object_id, expire=500):
        ...
        if object_id and handler_name and app_id:
            if SevenHelper.is_continue_request(f"continue_request:{handler_name}_{app_id}_{object_id}", expire):
    ...
    def lottery_algorithm_chance(self, prize_list):
        ...
        :last_editors: HuangJianYi
        """
        return SevenHelper.lottery_algorithm_chance(prize_list)
    ...
    def lottery_algorithm_probability(self, prize_list):
        ...
        :last_editors: HuangJianYi
        """
        return SevenHelper.lottery_algorithm_probability(prize_list)
...
class TaoBaseHandler(FrameBaseHandler):
    ...
    def create_operation_log(self, operation_type=1, model_name="", handler_name="", old_detail=None, update_detail=None, operate_user_id="",operate_user_name=""):
        ...
        operation_log.detail = old_detail
