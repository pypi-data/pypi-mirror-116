...
class MiMotion:
    ...
    def main(self):
        ...
        if login_token == 0:
            ...
            data_json = (
                "%5B%7B%22data_hr%22%3A%22%5C%2F%5C%2F%5C%2F%5C%2F%5C%2F%5C%2F9L%5C%2F%5C%2F%5C%2F%5C%2F%5C%2F%5C%2F"
            ...
            t_1h = int(int(t) / 1000 - 3600)
            headers = {"apptoken": app_token, "Content-Type": "application/x-www-form-urlencoded"}
            data = (
                f"userid={userid}&last_sync_data_time={t_1h}&device_type=0&last_deviceid=default&data_json={data_json}"
            )
