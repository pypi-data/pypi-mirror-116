...
class PFFundDailyCollection(Base):
    ...
    # 风险
    history_vol = Column(DOUBLE(asdecimal=False))  # 成立以来收益
    history_mdd = Column(DOUBLE(asdecimal=False))  # 成立以来最大收益
