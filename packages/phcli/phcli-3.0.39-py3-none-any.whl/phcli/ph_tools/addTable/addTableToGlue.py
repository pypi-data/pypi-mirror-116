...
__path_of_file__ = "s3://ph-platform/2020-11-11/etl/temporary_files/"
...
class AddTableToGlue(object):
    ...
    def __init__(self ,df ,database_name_of_output ,table_name_of_output ,path_of_output_file=__path_of_file__,mode=__mode__,share_num=__share_num__):
