...
class Id(
    ...
    def __init__(
        ...
        *,
        ...
        :param byte_length: The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/id.html#byte_length Id#byte_length}
        :param keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See `the main provider documentation <../index.html>`_ for more information. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/id.html#keepers Id#keepers}
        :param prefix: Arbitrary string to prefix the output value with. This string is supplied as-is, meaning it is not guaranteed to be URL-safe or base64 encoded. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/id.html#prefix Id#prefix}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
        ...
        jsii.create(Id, self, [scope, id, config])
    ...
    def byte_length_input(self) -> jsii.Number:
        return typing.cast(jsii.Number, jsii.get(self, "byteLengthInput"))
...
class Integer(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param max: The maximum inclusive value of the range. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/integer.html#max Integer#max}
        :param min: The minimum inclusive value of the range. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/integer.html#min Integer#min}
        :param keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See `the main provider documentation <../index.html>`_ for more information. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/integer.html#keepers Integer#keepers}
        :param seed: A custom seed to always produce the same value. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/integer.html#seed Integer#seed}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
        ...
        jsii.create(Integer, self, [scope, id, config])
    ...
    def max_input(self) -> jsii.Number:
        return typing.cast(jsii.Number, jsii.get(self, "maxInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="minInput")
    def min_input(self) -> jsii.Number:
        return typing.cast(jsii.Number, jsii.get(self, "minInput"))
...
class Password(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param length: The length of the string desired. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#length Password#length}
        :param keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See `the main provider documentation <../index.html>`_ for more information. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#keepers Password#keepers}
        :param lower: Include lowercase alphabet characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#lower Password#lower}
        :param min_lower: Minimum number of lowercase alphabet characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#min_lower Password#min_lower}
        :param min_numeric: Minimum number of numeric characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#min_numeric Password#min_numeric}
        :param min_special: Minimum number of special characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#min_special Password#min_special}
        :param min_upper: Minimum number of uppercase alphabet characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#min_upper Password#min_upper}
        :param number: Include numeric characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#number Password#number}
        :param override_special: Supply your own list of special characters to use for string generation. This overrides the default character list in the special argument. The ``special`` argument must still be set to true for any overwritten characters to be used in generation. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#override_special Password#override_special}
        :param special: Include special characters in the result. These are ``!@#$%&*()-_=+[]{}<>:?``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#special Password#special}
        :param upper: Include uppercase alphabet characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/password.html#upper Password#upper}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
        ...
        jsii.create(Password, self, [scope, id, config])
    ...
    def length_input(self) -> jsii.Number:
        return typing.cast(jsii.Number, jsii.get(self, "lengthInput"))
    ...
    def lower_input(self) -> typing.Optional[builtins.bool]:
        return typing.cast(typing.Optional[builtins.bool], jsii.get(self, "lowerInput"))
    ...
    def number_input(self) -> typing.Optional[builtins.bool]:
        return typing.cast(typing.Optional[builtins.bool], jsii.get(self, "numberInput"))
    ...
    def special_input(self) -> typing.Optional[builtins.bool]:
        return typing.cast(typing.Optional[builtins.bool], jsii.get(self, "specialInput"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="upperInput")
    def upper_input(self) -> typing.Optional[builtins.bool]:
        return typing.cast(typing.Optional[builtins.bool], jsii.get(self, "upperInput"))
    ...
    def lower(self) -> builtins.bool:
        return typing.cast(builtins.bool, jsii.get(self, "lower"))

    @lower.setter
    def lower(self, value: builtins.bool) -> None:
    ...
    def number(self) -> builtins.bool:
        return typing.cast(builtins.bool, jsii.get(self, "number"))

    @number.setter
    def number(self, value: builtins.bool) -> None:
    ...
    def special(self) -> builtins.bool:
        return typing.cast(builtins.bool, jsii.get(self, "special"))

    @special.setter
    def special(self, value: builtins.bool) -> None:
        jsii.set(self, "special", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="upper")
    def upper(self) -> builtins.bool:
        return typing.cast(builtins.bool, jsii.get(self, "upper"))

    @upper.setter
    def upper(self, value: builtins.bool) -> None:
...
class Pet(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See `the main provider documentation <../index.html>`_ for more information. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/pet.html#keepers Pet#keepers}
        :param length: The length (in words) of the pet name. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/pet.html#length Pet#length}
        :param prefix: A string to prefix the name with. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/pet.html#prefix Pet#prefix}
        :param separator: The character to separate words in the pet name. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/pet.html#separator Pet#separator}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
        ...
        jsii.create(Pet, self, [scope, id, config])
...
class RandomProvider(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(RandomProvider, self, [scope, id, config])
...
class Shuffle(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(Shuffle, self, [scope, id, config])
    ...
    def input_input(self) -> typing.List[builtins.str]:
        return typing.cast(typing.List[builtins.str], jsii.get(self, "inputInput"))
...
class String(
    cdktf.TerraformResource,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-random.String",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param length: The length of the string desired. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#length String#length}
        :param keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See `the main provider documentation <../index.html>`_ for more information. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#keepers String#keepers}
        :param lower: Include lowercase alphabet characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#lower String#lower}
        :param min_lower: Minimum number of lowercase alphabet characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#min_lower String#min_lower}
        :param min_numeric: Minimum number of numeric characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#min_numeric String#min_numeric}
        :param min_special: Minimum number of special characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#min_special String#min_special}
        :param min_upper: Minimum number of uppercase alphabet characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#min_upper String#min_upper}
        :param number: Include numeric characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#number String#number}
        :param override_special: Supply your own list of special characters to use for string generation. This overrides the default character list in the special argument. The ``special`` argument must still be set to true for any overwritten characters to be used in generation. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#override_special String#override_special}
        :param special: Include special characters in the result. These are ``!@#$%&*()-_=+[]{}<>:?``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#special String#special}
        :param upper: Include uppercase alphabet characters in the result. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/string.html#upper String#upper}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
        ...
        jsii.create(String, self, [scope, id, config])
...
@jsii.data_type(
    jsii_type="@cdktf/provider-random.StringConfig",
    jsii_struct_bases=[cdktf.TerraformMetaArguments],
    name_mapping={
        "count": "count",
        "depends_on": "dependsOn",
...
class StringConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        count: typing.Optional[jsii.Number] = None,
...
class Uuid(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See `the main provider documentation <../index.html>`_ for more information. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/random/r/uuid.html#keepers Uuid#keepers}
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
        ...
        jsii.create(Uuid, self, [scope, id, config])
