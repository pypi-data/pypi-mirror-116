...
def _get_scoring_file(is_pandas_data_frame: bool, input_sample_str: str, output_sample_str: str,
                      is_forecasting: bool = False) -> Tuple[str, str]:
    """
    ...
    if not is_forecasting:
        content_v1 = _format_scoring_file('score.txt', inference_data_type, input_sample_str, output_sample_str)
        content_v2 = _format_scoring_file('score_v2.txt', inference_data_type, input_sample_str, output_sample_str)
    else:
