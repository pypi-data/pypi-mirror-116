...
class ModelManager:
    ...
    @classmethod
    def config_has_changed(cls, token_info: Any) -> bool:
        return token_info.tenant_config[cls._config_key]['has_changed']

    @classmethod
    def update_config_from_json(cls, token_info: Any) -> None:
        ...
        check_has_changed = cls.config_has_changed(token_info=token_info)
