...
logging.config.fileConfig(
    os.path.join(os.getcwd(), "./logging/logging.conf"), disable_existing_loggers=False
)
...
class ModelManager:
        ...
        for model in models_to_delete:
            ...
            for pandora_model in cls._downloaded_models:
                if (
                    ...
                    and (pandora_model.version == version_model)
                ):
    ...
    def update_config_from_json(cls, token_info: Any, bg_task: Any = None):
        ...
        msg = JSONResponse(
            status_code=503,
            content={
                "message": "Config has changed: updating models. This might take a couple of minutes."
            },
        )
        ...
        if check_has_changed and check_has_changed:
    ...
    @classmethod
    def get_model(
        cls, model_name: str, language: str, token_info: Any = {}, path: bool = False
    ) -> Any:
        version = ""
        tenant_name = None
        client = ""
    ...
    def __download_model_dataservices(cls, model: Dict[str, str]) -> None:
        ...
        if len(matched_models) == 0:
            ...
            if temp_path.exists():
                ...
                url = cls._download_file_url.replace("{container}", str(cls._container))
    ...
    def upload_model(
        ...
        if path.exists():
            ...
            files = {
                "file": (final_path.name, open(final_path, "rb"), "multipart/form-data")
            }
