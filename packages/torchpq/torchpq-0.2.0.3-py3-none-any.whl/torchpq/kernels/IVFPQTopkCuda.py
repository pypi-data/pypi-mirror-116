...
class IVFPQTopkCuda(CustomKernel):
  def __init__(
    ...
    self._topk_smart_probing_fn = cp.RawKernel(
      code = code,
      name = 'ivfpq_topk_smart_probing',
      options = (
        '--maxrregcount=255',
        '--use_fast_math'
      ),
    ...
    self._topk_smart_probing_fn.max_dynamic_shared_size_bytes = sm_size

    self._topk_residual_smart_probing_fn = cp.RawKernel(
      code = code,
      name = 'ivfpq_topk_residual_smart_probing',
      options = (
        '--maxrregcount=255',
        '--use_fast_math'
      ),
    ...
    self._topk_residual_smart_probing_fn.max_dynamic_shared_size_bytes = sm_size

    self._topk_residual_precomputed_smart_probing_fn = cp.RawKernel(
      code = code,
      name = 'ivfpq_topk_residual_precomputed_smart_probing',
      options = (
        '--maxrregcount=255',
        '--use_fast_math'
      ),
    ...
    self._topk_residual_precomputed_smart_probing_fn.max_dynamic_shared_size_bytes = sm_size
  ...
  def topk_residual_smart_probing(
      self, data, precomputed,
      is_empty, cell_start, cell_size,
    ...
    self._topk_residual_smart_probing_fn(
      grid=blocks_per_grid,
      block=threads_per_block,
      shared_mem = self.sm_size,
      args=[
  ...
  def topk_residual_precomputed_smart_probing(
      self, data, part1, part2, cells, base_sims,
      is_empty, cell_start, cell_size,
      n_probe_list, n_candidates=None
    ):
    ...
    self._topk_residual_precomputed_smart_probing_fn(
      grid=blocks_per_grid,
      block=threads_per_block,
      shared_mem = self.sm_size,
      args=[
