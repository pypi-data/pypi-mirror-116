...
def get_streams_location_config(resolver: str, auth: str):
    ...
    return get_config(options=STREAMS_OPTIONS, resolver=resolver, auth=auth, service=service)
...
def get_k8s_location_config(resolver: str, auth: str):
    ...
    return get_config(options=K8S_OPTIONS, resolver=resolver, auth=auth, service=service)
