...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '3.2.0-alpha.1629366124+c7a1ceb9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 3.2.0-alpha.1629366124+c7a1ceb9`
                """)
            else:
                raise
