...
def geopandas_by_workflow_id(workflow_id: WorkflowId, bbox: QueryRectangle, srs='EPSG:4326') -> gpd.GeoDataFrame:
    '''
...
def geopandas_by_workflow(workflow: str, bbox: QueryRectangle) -> gpd.GeoDataFrame:
    '''
