...
def _equal_variances_plot(plot_obj, **kwargs):
    ...
    # add suptitle
    fig.suptitle(t=f'{plot_obj.test} for {bluebelt.core.helpers._get_nice_list(plot_obj.frame.columns)}', x=fig.subplotpars.left, **style.equal_variances_plot.suptitle)
