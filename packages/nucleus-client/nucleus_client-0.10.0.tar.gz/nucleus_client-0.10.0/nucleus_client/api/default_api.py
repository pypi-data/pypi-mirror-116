...
class DefaultApi(object):
    ...
    def add_stream_job_submission(self, stream_job_id, **kwargs):  # noqa: E501
        """Add a new stream_job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_stream_job_submission(stream_job_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.add_stream_job_submission_with_http_info(stream_job_id, **kwargs)  # noqa: E501
        else:
            (data) = self.add_stream_job_submission_with_http_info(stream_job_id, **kwargs)  # noqa: E501
            return data

    def add_stream_job_submission_with_http_info(self, stream_job_id, **kwargs):  # noqa: E501
        """Add a new stream_job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_stream_job_submission_with_http_info(stream_job_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['stream_job_id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('stream_job_id' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `stream_job_id` when calling `add_stream_job_submission`")  # noqa: E501
        ...
        if 'stream_job_id' in local_var_params:
            query_params.append(('stream_job_id', local_var_params['stream_job_id']))  # noqa: E501
    ...
    def delete_stream_job_submission(self, stream_job_id, client_id, **kwargs):  # noqa: E501
        """Deletes a stream job by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_stream_job_submission(stream_job_id, client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_stream_job_submission_with_http_info(stream_job_id, client_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_stream_job_submission_with_http_info(stream_job_id, client_id, **kwargs)  # noqa: E501
            return data

    def delete_stream_job_submission_with_http_info(self, stream_job_id, client_id, **kwargs):  # noqa: E501
        """Deletes a stream job by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_stream_job_submission_with_http_info(stream_job_id, client_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_stream_job_submission" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'stream_job_id' is set
        if ('stream_job_id' not in local_var_params or
                local_var_params['stream_job_id'] is None):
            raise ValueError("Missing the required parameter `stream_job_id` when calling `delete_stream_job_submission`")  # noqa: E501
        # verify the required parameter 'client_id' is set
        if ('client_id' not in local_var_params or
                local_var_params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `delete_stream_job_submission`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/stream-job-submissions/{stream_job_id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
