...
*DefaultApi* | [**delete_stream_job_submission**](docs/DefaultApi.md#delete_stream_job_submission) | **DELETE** /stream-job-submissions/{stream_job_id} | Deletes a stream job by ID
