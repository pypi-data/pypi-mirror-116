...
def deviceprint(printer_name, folder_path=None, **kwargs):
	"""
	...
	- Input:
		* printer_name: e.g. 
			...
			- ARGOX_D2-250_PPLZ
	"""
	output_pdf = kwargs.get("output_pdf_name", "output_pdf")
	...
	def print_func(func):
		...
		def handle_print(*args, **kwargs):
			...
			conn.printFile(printer_name,temp_file_path+"/"+output_pdf+".pdf",job_name,{})
