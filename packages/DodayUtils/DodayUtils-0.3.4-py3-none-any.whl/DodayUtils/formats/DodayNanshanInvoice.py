from DodayUtils.format._Barcode import *
from DodayUtils.format._QRCode import *
from DodayUtils.format._Basic import BasicFormat
from DodayUtils.format._Graphic import GraphicFormat
...
class DodayNanshanInvoice(GraphicFormat):
	...
	def order_info_to_order_invoice(self, order_info):
		...
		if self.invoice_for == "kitchen":
			...
			barcode_class_data = code128_format(get_nanshan_class_code(order_info_clone))
