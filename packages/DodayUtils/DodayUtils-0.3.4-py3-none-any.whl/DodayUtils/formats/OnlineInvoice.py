...
filename = os.path.join(directory, 'font/msyh.ttf')
pdfmetrics.registerFont(TTFont('msyh', filename))
...
class OnlineInvoice:
	...
	@dutils
	def order_info_to_invoice_pdf(self, order_info):
		"""
		...
		cvs.drawString(500, 60, order_info["total_price"])
		cvs.line(50, 50, 580, 50)#FROM TOP LAST LINE
