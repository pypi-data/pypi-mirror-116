...
def create_schema():
    # We manually import query_and_mutation of this app, since we need to include them as well
    from django_app_graphql.graphene.graphqls.query_and_mutations import UploadMutation
