...
class Orm:
    ...
    @classmethod
    def image_with_default(cls, upload_to: str, default_image: str, description: str = None) -> models.ImageField:
        """
        ...
        :param upload_to: storage location where the image will be saved
        ...
        return models.ImageField(default=default_image, upload_to=upload_to, help_text=description)
