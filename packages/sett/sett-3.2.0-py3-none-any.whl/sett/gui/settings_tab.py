...
class SettingsTab(QtWidgets.QWidget):
    ...
    def _add_settings(self):
        ...
        self._add_widget_int_range(
            ...
            "Max CPU",
            "max_cpu",
            "Maximum number of CPU cores for parallel computation (use all CPU cores if value equals 0)",
            0,
            # In case cpu_count fails to detect the number of available cores
        ...
        self.field_keyserver_url = self._add_widget_str(
            pgp_keys_group,
            "Keyserver URL",
            "keyserver_url",
            "URL of the keyserver: used for publishing/fetching public PGP keys.",
        )
        self.checkbox_gpg_key_autodownload = self._add_widget_bool(
            pgp_keys_group,
            "Allow PGP key auto-download",
            "gpg_key_autodownload",
            "Allow the automatic download and refresh of PGP keys from the Keyserver.",
        )
