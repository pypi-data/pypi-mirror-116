...
- French school year:
  ...
  - 2020-2021:
    :download:`zone A <examples/fr_20202021_A.pdf>` (:download:`source <examples/fr_20202021_A.scl>`),
    :download:`zone B <examples/fr_20202021_B.pdf>` (:download:`source <examples/fr_20202021_B.scl>`),
    :download:`zone C <examples/fr_20202021_C.pdf>` (:download:`source <examples/fr_20202021_C.scl>`)
  - 2021-2022:
    :download:`zone A <examples/fr_20212022_A.pdf>` (:download:`source <examples/fr_20212022_A.scl>`),
    :download:`zone B <examples/fr_20212022_B.pdf>` (:download:`source <examples/fr_20212022_B.scl>`),
    :download:`zone C <examples/fr_20212022_C.pdf>` (:download:`source <examples/fr_20212022_C.scl>`)
...
- Moreover, the following configuration variables can be set, as ``VARIABLE = VALUE``:
  ...
  - ``language``: Language of the calendar (this string must be recognized by the `babel <http://www.ctan.org/pkg/babel>`_ LaTeX package).
