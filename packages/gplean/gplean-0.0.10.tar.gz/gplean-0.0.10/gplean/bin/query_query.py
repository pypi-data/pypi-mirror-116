...
parser.add_argument('-offset','--offset', default=0,help="offset")
parser.add_argument('-limit','--limit', default=100,help="limit")
parser.add_argument('-howmany','--howmany', default=100,help="howmany")
...
if(mode == 'sync'):
    def main():
        d = {'cfg':cfg,'cls':cls,'howmany':howmany,'offset':offset,'limit':limit}
        rslt = query(d)
        pobj(rslt)
else:
    import asyncio
