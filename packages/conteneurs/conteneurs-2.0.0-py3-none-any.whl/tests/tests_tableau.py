...
class TestsTableau(unittest.TestCase) :
    ...
    def test_getitem(self) :
        ...
        """
        ligne_theorique = [215, "Cette méthode n'est pas définie pour cette classe (classe virtuelle).", "NotImplementedError", 20,1,2021,8]
        self.assertEqual(self.T2[3], ligne_theorique)
        colonne_theorique = ["Jour", 17, 19, 20, 22, 22, 23]
        self.assertEqual(self.T2["C"], colonne_theorique)
    ...
    def test_get_tableau(self) :
        ...
        for i in range(len(self._tableau_T4)) :
            del self._tableau_T4[i][0]#on enlève les cases des en-tetes_v désactivées
        self.assertEqual(self.T4.tableau, self._tableau_T4)
    ...
    def test_get_ligne(self) :
        ...
        ligne_theorique = [215, "Cette méthode n'est pas définie pour cette classe (classe virtuelle).", "NotImplementedError", 20,1,2021,8]
        self.assertEqual(self.T2.get_ligne(3), ligne_theorique)
    ...
    def test_get_colonne(self) :
        ...
        colonne_theorique = ["Jour", 17, 19, 20, 22, 22, 23]
        self.assertEqual(self.T2.get_colonne("C"), colonne_theorique)
    ...
    def test_str_noms_colonnes(self) :
        """Méthode testant la méthode interne _str_noms_colonnes."""
        str_theorique = """      287      |   Nom erreur  | Type d'erreur |      Jour     |      Mois     |     Année     |     Heure     |"""
        self.assertEqual(self.T2._str_noms_colonnes(), str_theorique)

    def test_str_ligne(self) :
        """Méthode testant la méthode interne _str_ligne de la classe testée"""
        str_theorique = """      381      | Le tableau es»|   ValueError  |       19      |       1       |      2021     |       10      |"""
        self.assertEqual(self.T2._str_ligne(2), str_theorique)
    ...
    def test_index_case_int(self) :
        ...
        Vérifie que cette méthode renvoie bien un tuple avec deux entier correspondant aux index de la case.
        """
