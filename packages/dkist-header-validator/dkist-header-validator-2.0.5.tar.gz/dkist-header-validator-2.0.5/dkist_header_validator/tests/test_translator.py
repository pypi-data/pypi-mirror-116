...
def test_translate_and_sanitize(valid_spec_122_header):
    """
    Translates a SPEC-0122 object to a SPEC-214 L1 object and sanitizes
    Given: A valid SPEC-0122 object
    ...
    """
    s214_header = translate_spec122_to_spec214(valid_spec_122_header)
    sanitize_to_spec214_level1(s214_header)


def test_sanitize_s122(valid_spec_122_header):
    """
    ...
    with pytest.raises(TypeError):
        sanitize_to_spec214_level1(valid_spec_122_header)


def test_sanitize_trsnslated_s214l0(valid_spec_122_header):
    """
    ...
    Then: Raises a TypeError exception
    """
    s214_l0_header = translate_spec122_to_spec214_l0(valid_spec_122_header)
    with pytest.raises(TypeError):
        sanitize_to_spec214_level1(s214_l0_header)


def test_sanitize(valid_spec_214_header):
    """
    ...
    Then: For a header or a dict, return a fits header and do not raise an exception
          For an HDUList or a file, return an HDUList and do not raise an exception
    """
    sanitize_to_spec214_level1(valid_spec_214_header)
