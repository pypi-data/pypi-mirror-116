...
class HyperdataHttpClient:
    ...
    def get_do_simple_list(self, auth: HyperdataUserAuth, experiment_id: int) ->dict:
        res = self.send_request(
            "mllabExperimentDataObject",
        ...
        result = []
        for do in res.data["dto"]["dataOjbecdtInfoList"]:
            result[do["name"]] = do["id"]
        return result
