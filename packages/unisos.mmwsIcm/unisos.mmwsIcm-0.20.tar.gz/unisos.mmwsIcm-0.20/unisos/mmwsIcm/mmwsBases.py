...
** TODO [[elisp:(org-cycle)][| ]]  General       :: Provide the equivalent fuctionality to wsCodeGen.sh [[elisp:(org-cycle)][| ]]
**      [End-Of-Status]
"""
...
####+BEGIN: bx:icm:python:func :funcName "examples_tokenGenerator" :funcType "anyOrNone" :retType "bool" :deco "" :argsList "userName role resGroupIds"
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Func-anyOrNone :: /examples_tokenGenerator/ retType=bool argsList=(userName role resGroupIds)  [[elisp:(org-cycle)][| ]]
"""
...
####+BEGIN: bx:icm:python:cmnd:classHead :cmndName "apiCodeGenPyFlask" :parsMand "" :parsOpt "" :argsMin "2" :argsMax "2" :asFunc "" :interactiveP ""
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || ICM-Cmnd       :: /apiCodeGenPyFlask/ parsMand= parsOpt= argsMin=2 argsMax=2 asFunc= interactive=  [[elisp:(org-cycle)][| ]]
"""
class apiCodeGenPyFlask(icm.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
