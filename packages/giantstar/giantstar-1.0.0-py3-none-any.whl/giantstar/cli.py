...
from giantstar import __description__, __version__

import sys
import argparse
from argparse import Namespace

from giantstar.utils.scaffold import command_parser_scaffold, main_scaffold


def command_parser_run(subparsers):
    sub_parser_run = subparsers.add_parser('run', help="Make giantstar testcase and run with runner.")
