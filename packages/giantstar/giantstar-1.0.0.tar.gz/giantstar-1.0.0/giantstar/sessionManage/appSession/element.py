...
from giantstar.sessionManage.webSession.element import _Select, Input, MouseEvent, WindowEvent, CompatElement
from giantstar.utils.logger import logger
from giantstar.utils.controller import OCRDiscern
from giantstar.utils.error import AcquireElementError
...
class GiantElement(_Select, Button, Input, MouseEvent, AppWindowEvent, CompatElement):
    """ 元素对象处理 """
...
class Swipe:
    ...
    @staticmethod
    def _gen_swipe_args(browser, direction='down', max_swipe_screen_count=3.0):
        """
        生成滑动屏幕参数
