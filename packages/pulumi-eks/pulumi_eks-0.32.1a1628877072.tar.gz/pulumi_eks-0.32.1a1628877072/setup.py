...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.32.1-alpha.1628877072+9159ea0a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.32.1-alpha.1628877072+9159ea0a`
                """)
            else:
                raise
