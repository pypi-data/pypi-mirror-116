...
class Peak():
    ...
    def __init__(self, sample, RT, mz, rt_start, rt_end, mz_min, mz_max, height, area, feature = None, monoisotopic= None, valid=None, area_baseline_corrected=None, sn=None, rt_adjusted=None, rt_start_adjusted=None, rt_end_adjusted=None):
        ...
        self.sn = sn
        self.rt_adjusted = rt_adjusted 
        self.rt_start_adjusted = rt_start_adjusted
        self.rt_end_adjusted = rt_end_adjusted
