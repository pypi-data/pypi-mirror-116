...
class AnalogIO(AbstractDwfDeviceSubApi):
    ...
    def reset(self) -> None:
        ...
        If auto-configure is enabled, the changes take effect immediately.
    ...
    def channelNodeInfo(self, channel_index: int, node_index: int) -> DwfAnalogIO:
        ...
        Parameters:
            channel_index (int): The channel from which we want to get the type of physical quantity.
            node_index (int): The node from which we want to get the type of physical quantity.
    ...
    def channelNodeGet(self, channel_index: int, node_index: int) -> float:
        ...
        Parameters:
            channel_index (int): The channel from which we want to get the current value.
            node_index (int): The node from which we want to get the current value.
