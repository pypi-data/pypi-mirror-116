...
from wizzi_utils.models.test.shared_code_for_tests import TR_MODEL, TR_VID_TEST, DEBUG_DETECTIONS
...
def tr_Model_video_test(
    ...
    if cam is not None:
        ...
        fps = mt.FPS(summary_title='{}'.format(model.tracker_type))
            ...
            if success:
                ...
                if vid_path.endswith('woman_yoga.mp4'):
                    ...
                    if i == 14:
                        ...
                        model.add_obj_bbox_manual(cv_img, xywh=bbox, frame_idx=i, ack=DEBUG_DETECTIONS)
