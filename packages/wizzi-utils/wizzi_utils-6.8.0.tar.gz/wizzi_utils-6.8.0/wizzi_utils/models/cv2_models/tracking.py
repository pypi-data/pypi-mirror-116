...
class Cv2Tracker:
    ...
    def add_obj_bbox_manual(self, cv_img: np.array, xywh: tuple, frame_idx: int, ack: bool = False):
        """
        :param cv_img:
        :param xywh:
        :param ack:
        ...
        if not xywh == (0, 0, 0, 0):  # clicked space\enter after selecting a bbox
            ...
            tracker_dict = {
                ...
                'bboxes': {},  # will contain all bboxes of object found over iters
                'tracks': []  # will contain all center of mass points from previous iterations
            }
        ...
        for detection in detections:
            ...
            if success:
                ...
                if tracks_dict is not None:
                    ...
                    tracks_list = self.get_tracker_dict(tracker_id=tracker_idx)['tracks']
