...
def main():
    ...
    parser.add_argument("--model_path",help="Flag that indicates ICD10-CM codes will be converted to UKBB. Note, will raise error if encoding is already 'ICD10-UKBB'",action="store_true")
