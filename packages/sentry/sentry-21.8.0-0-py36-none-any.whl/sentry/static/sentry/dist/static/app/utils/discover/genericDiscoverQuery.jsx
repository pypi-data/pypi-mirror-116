...
exports.doDiscoverQuery = void 0;
...
var GenericDiscoverQuery = /** @class */ (function (_super) {
    tslib_1.__extends(GenericDiscoverQuery, _super);
    function GenericDiscoverQuery() {
        ...
        _this.fetchData = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, api, beforeFetch, afterFetch, didFetch, eventView, orgSlug, route, limit, cursor, setError, noPagination, referrer, url, tableFetchID, apiPayload, _b, data, resp_1, tableData_1, err_1, error;
            var _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this.props, api = _a.api, beforeFetch = _a.beforeFetch, afterFetch = _a.afterFetch, didFetch = _a.didFetch, eventView = _a.eventView, orgSlug = _a.orgSlug, route = _a.route, limit = _a.limit, cursor = _a.cursor, setError = _a.setError, noPagination = _a.noPagination, referrer = _a.referrer;
                    ...
                    case 2:
                        _b = tslib_1.__read.apply(void 0, [_d.sent(), 3]), data = _b[0], resp_1 = _b[2];
                        if (this.state.tableFetchID !== tableFetchID) {
                            // invariant: a different request was initiated after this request
                            return [2 /*return*/];
                        }
                        tableData_1 = afterFetch ? afterFetch(data, this.props) : data;
                        didFetch === null || didFetch === void 0 ? void 0 : didFetch(tableData_1);
                        this.setState(function (prevState) {
                            ...
                            return ({
                                ...
                                tableFetchID: undefined,
                                error: null,
                                pageLinks: (_a = resp_1 === null || resp_1 === void 0 ? void 0 : resp_1.getResponseHeader('Link')) !== null && _a !== void 0 ? _a : prevState.pageLinks,
                    ...
                    case 3:
                        err_1 = _d.sent();
                        error = ((_c = err_1 === null || err_1 === void 0 ? void 0 : err_1.responseJSON) === null || _c === void 0 ? void 0 : _c.detail) || locale_1.t('An unknown error occurred.');
                        this.setState({
                            isLoading: false,
                            tableFetchID: undefined,
                            error: error,
