...
var IssueActions = /** @class */ (function (_super) {
    ...
    function IssueActions() {
        ...
        _this.changeField = function (action, name, value) {
            ...
            var formData = tslib_1.__assign(tslib_1.__assign({}, _this.state[key]), (_a = {}, _a[name] = value, _a));
            var state = tslib_1.__assign(tslib_1.__assign({}, _this.state), (_b = {}, _b[key] = formData, _b));
            if (name === 'issuetype') {
