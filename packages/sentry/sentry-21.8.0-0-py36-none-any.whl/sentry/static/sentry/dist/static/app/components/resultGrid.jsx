...
var Filter = /** @class */ (function (_super) {
    ...
    function Filter() {
        ...
        _this.getSelector = function () { return (<dropdownLink_1.default title={_this.getCurrentLabel()}>
      {_this.getDefaultItem()}
      {_this.props.options.map(function (_a) {
                var _b;
                var _c = tslib_1.__read(_a, 2), value = _c[0], label = _c[1];
                var filterQuery = (_b = {},
                    _b[_this.props.queryKey] = value,
                    _b.cursor = '',
                    _b);
                var query = tslib_1.__assign(tslib_1.__assign({}, _this.props.location.query), filterQuery);
                return (<menuItem_1.default key={value} isActive={_this.props.value === value} to={{ pathname: _this.props.path, query: query }}>
            {label}
          </menuItem_1.default>);
            })}
    ...
    Filter.prototype.getDefaultItem = function () {
        var query = tslib_1.__assign(tslib_1.__assign({}, this.props.location.query), { cursor: '' });
        delete query[this.props.queryKey];
        return (<menuItem_1.default key="" isActive={this.props.value === '' || !this.props.value} to={{ pathname: this.props.path, query: query }}>
        Any
      </menuItem_1.default>);
    };
...
var SortBy = /** @class */ (function (_super) {
    tslib_1.__extends(SortBy, _super);
    function SortBy() {
    ...
    SortBy.prototype.getSortBySelector = function () {
        ...
        {this.props.options.map(function (_a) {
                ...
                var query = tslib_1.__assign(tslib_1.__assign({}, _this.props.location.query), { sortBy: value, cursor: '' });
                return (<menuItem_1.default isActive={_this.props.value === value} key={value} to={{ pathname: _this.props.path, query: query }}>
              {label}
            </menuItem_1.default>);
            })}
      </dropdownLink_1.default>);
...
var ResultGrid = /** @class */ (function (_super) {
    tslib_1.__extends(ResultGrid, _super);
    function ResultGrid() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        ...
        _this.onSearch = function (e) {
            ...
            var targetQueryParams = tslib_1.__assign(tslib_1.__assign({}, ((_b = location.query) !== null && _b !== void 0 ? _b : {})), { query: query, cursor: '' });
            e.preventDefault();
    ...
    ResultGrid.prototype.componentWillReceiveProps = function () {
        ...
        this.setState({
            ...
            filters: tslib_1.__assign({}, queryParams),
            pageLinks: null,
            loading: true,
            error: false,
        }, this.fetchData);
    ...
    ResultGrid.prototype.fetchData = function () {
        ...
        var queryParams = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, this.props.defaultParams), { sortBy: this.state.sortBy }), this.query);
...
exports.default = withApi_1.default(ResultGrid);
