...
var backgroundAvatar_1 = tslib_1.__importDefault(require("app/components/avatar/backgroundAvatar"));
var letterAvatar_1 = tslib_1.__importDefault(require("app/components/letterAvatar"));
var tooltip_1 = tslib_1.__importDefault(require("app/components/tooltip"));
var gravatar_1 = tslib_1.__importDefault(require("./gravatar"));
...
// sensible default.
var StyledBaseAvatar = styled_1.default('span')(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  flex-shrink: 0;\n  border-radius: ", ";\n  border: ", ";\n  background-color: ", ";\n"], ["\n  flex-shrink: 0;\n  border-radius: ", ";\n  border: ", ";\n  background-color: ", ";\n"])), function (p) { return (p.round ? '50%' : '3px'); }, function (p) { return (p.suggested ? "1px dashed " + p.theme.gray400 : 'none'); }, function (p) {
...
var BaseAvatar = /** @class */ (function (_super) {
    tslib_1.__extends(BaseAvatar, _super);
    function BaseAvatar(props) {
        ...
        _this.renderImg = function () {
            ...
            if (type === 'gravatar') {
                return (<gravatar_1.default placeholder={_this.props.default} gravatarId={gravatarId} round={round} remoteSize={DEFAULT_REMOTE_SIZE} suggested={suggested} grayscale={suggested} {...eventProps}/>);
            }
            if (type === 'upload') {
    ...
    BaseAvatar.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, round = _a.round, hasTooltip = _a.hasTooltip, size = _a.size, suggested = _a.suggested, tooltip = _a.tooltip, tooltipOptions = _a.tooltipOptions, forwardedRef = _a.forwardedRef, props = tslib_1.__rest(_a, ["className", "style", "round", "hasTooltip", "size", "suggested", "tooltip", "tooltipOptions", "forwardedRef"]);
        var sizeStyle = {};
        if (size) {
            sizeStyle = {
                width: size + "px",
        ...
        <StyledBaseAvatar ref={forwardedRef} loaded={this.state.hasLoaded} className={classnames_1.default('avatar', className)} round={!!round} suggested={!!suggested} style={tslib_1.__assign(tslib_1.__assign({}, sizeStyle), style)} {...props}>
...
var Image = styled_1.default('img')(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  ", ";\n"], ["\n  ", ";\n"])), styles_1.imageStyle);
