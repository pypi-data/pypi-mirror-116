...
var SplitDiff = function (_a) {
    ...
    var _c = tslib_1.__read(baseLines.length > targetLines.length
...
var SplitTable = styled_1.default('table')(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  table-layout: fixed;\n  border-collapse: collapse;\n  width: 100%;\n"], ["\n  table-layout: fixed;\n  border-collapse: collapse;\n  width: 100%;\n"])));
var SplitBody = styled_1.default('tbody')(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  font-family: ", ";\n  font-size: ", ";\n"], ["\n  font-family: ", ";\n  font-size: ", ";\n"])), function (p) { return p.theme.text.familyMono; }, function (p) { return p.theme.fontSizeSmall; });
var Cell = styled_1.default('td')(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  vertical-align: top;\n  ", ";\n  ", ";\n"], ["\n  vertical-align: top;\n  ", ";\n  ", ";\n"])), function (p) { return p.isRemoved && "background-color: " + p.theme.diff.removedRow; }, function (p) { return p.isAdded && "background-color: " + p.theme.diff.addedRow; });
var Gap = styled_1.default('td')(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n  width: 20px;\n"], ["\n  width: 20px;\n"])));
var Line = styled_1.default('div')(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  flex-wrap: wrap;\n"], ["\n  display: flex;\n  flex-wrap: wrap;\n"])));
var Word = styled_1.default('span')(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["\n  white-space: pre-wrap;\n  word-break: break-all;\n  ", ";\n  ", ";\n"], ["\n  white-space: pre-wrap;\n  word-break: break-all;\n  ", ";\n  ", ";\n"])), function (p) { return p.isRemoved && "background-color: " + p.theme.diff.removed; }, function (p) { return p.isAdded && "background-color: " + p.theme.diff.added; });
