...
function convertRelayPiiConfig(relayPiiConfig) {
    ...
    for (var application in applications) {
        try {
            for (var _b = (e_1 = void 0, tslib_1.__values(applications[application])), _c = _b.next(); !_c.done; _c = _b.next()) {
                var rule = _c.value;
                ...
                if (!resolvedRule) {
                    ...
                    if (rule[0] === '@') {
                        ...
                        var _d = tslib_1.__read(typeAndMethod, 1), type_1 = _d[0];
                        var _e = tslib_1.__read(typeAndMethod, 2), method_1 = _e[1];
                        if (type_1 === 'urlauth')
                            type_1 = 'url_auth';
                        if (type_1 === 'usssn')
                            type_1 = 'us_ssn';
