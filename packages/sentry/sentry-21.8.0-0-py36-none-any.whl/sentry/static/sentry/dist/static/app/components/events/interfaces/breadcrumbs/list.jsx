...
var listBody_1 = tslib_1.__importDefault(require("./listBody"));
var listHeader_1 = tslib_1.__importDefault(require("./listHeader"));
...
var ListContainer = /** @class */ (function (_super) {
    tslib_1.__extends(ListContainer, _super);
    function ListContainer() {
        ...
        {function (_a) {
              ...
              {_this.renderBody(breadcrumb, height, isLastItem)}
            </Row>) : (<Row style={style} onLoad={measure}>
              {_this.renderBody(breadcrumb, height)}
            </Row>);
                }}
    ...
    ListContainer.prototype.componentDidUpdate = function (prevProps) {
        this.updateGrid();
        if (!isEqual_1.default(prevProps.breadcrumbs, this.props.breadcrumbs) &&
    ...
    ListContainer.prototype.renderBody = function (breadcrumb, height, isLastItem) {
...
var StyledList = styled_1.default(react_virtualized_1.List)(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  height: auto !important;\n  max-height: ", "px;\n  overflow-y: auto !important;\n  outline: none;\n"], ["\n  height: auto !important;\n  max-height: ", "px;\n  overflow-y: auto !important;\n  outline: none;\n"])), function (p) { return p.height; });
...
var RowSticky = styled_1.default(Row)(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (p) {
