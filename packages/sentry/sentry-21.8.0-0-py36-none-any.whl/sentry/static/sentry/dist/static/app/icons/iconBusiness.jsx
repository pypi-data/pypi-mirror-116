...
function IconBusinessComponent(_a) {
    var _b = _a.gradient, gradient = _b === void 0 ? false : _b, _c = _a.withShine, withShine = _c === void 0 ? false : _c, forwardRef = _a.forwardRef, theme = _a.theme, props = tslib_1.__rest(_a, ["gradient", "withShine", "forwardRef", "theme"]);
    var uid = React.useMemo(function () { return guid_1.uniqueId(); }, []);
    var maskId = "icon-business-mask-" + uid;
    var gradientId = "icon-business-gradient-" + uid;
    var shineId = "icon-business-shine-" + uid;
...
var ThemedIconBusiness = react_1.withTheme(IconBusinessComponent);
var IconBusiness = React.forwardRef(function (props, ref) { return (<ThemedIconBusiness {...props} forwardRef={ref}/>); });
exports.IconBusiness = IconBusiness;
IconBusiness.displayName = 'IconBusiness';
var shine = react_1.keyframes(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  0% {\n    transform: translateX(-100%);\n  }\n  94% {\n    transform: translateX(-100%);\n  }\n  100% {\n    transform: translateX(100%);\n  }\n"], ["\n  0% {\n    transform: translateX(-100%);\n  }\n  94% {\n    transform: translateX(-100%);\n  }\n  100% {\n    transform: translateX(100%);\n  }\n"])));
var ShineRect = styled_1.default('rect')(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  transform: translateX(-100%);\n  animation: ", " 8s ease-in-out infinite;\n"], ["\n  transform: translateX(-100%);\n  animation: ", " 8s ease-in-out infinite;\n"])), shine);
