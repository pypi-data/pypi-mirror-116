...
var SelectField = /** @class */ (function (_super) {
    ...
    SelectField.prototype.render = function () {
        var _this = this;
        var _a = this.props, multiple = _a.multiple, allowClear = _a.allowClear, small = _a.small, otherProps = tslib_1.__rest(_a, ["multiple", "allowClear", "small"]);
        return (<inputField_1.default {...otherProps} alignRight={small} field={function (_a) {
                var onChange = _a.onChange, onBlur = _a.onBlur, _required = _a.required, props = tslib_1.__rest(_a, ["onChange", "onBlur", "required"]);
                return (<selectControl_1.default {...props} clearable={allowClear} multiple={multiple} onChange={_this.handleChange.bind(_this, onBlur, onChange)}/>);
            }}/>);
    };
