...
function recreateRoute(to, options) {
    ...
    if (typeof to !== 'string') {
        ...
        lastRootIndex = findLastIndex_1.default(paths.slice(0, routeIndex), function (path) { return path[0] === '/'; });
    }
    else {
        lastRootIndex = findLastIndex_1.default(paths, function (path) { return path[0] === '/'; });
    }
    ...
    return replaceRouterParams_1.default(fullRoute, params);
}
