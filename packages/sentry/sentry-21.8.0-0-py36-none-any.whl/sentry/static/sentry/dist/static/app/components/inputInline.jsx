...
var InputInline = /** @class */ (function (_super) {
    tslib_1.__extends(InputInline, _super);
    function InputInline() {
        ...
        _this.onBlur = function (event) {
            ...
            callIfFunction_1.callIfFunction(_this.props.onBlur, InputInline.setValueOnEvent(event));
        };
        _this.onFocus = function (event) {
            _this.setState({ isFocused: true });
            callIfFunction_1.callIfFunction(_this.props.onFocus, InputInline.setValueOnEvent(event));
        ...
        _this.onChangeUsingOnInput = function (event) {
            callIfFunction_1.callIfFunction(_this.props.onChange, InputInline.setValueOnEvent(event));
        };
        _this.onKeyDown = function (event) {
            ...
            callIfFunction_1.callIfFunction(_this.props.onKeyUp, InputInline.setValueOnEvent(event));
        };
        ...
        _this.onClickIcon = function (event) {
            ...
            callIfFunction_1.callIfFunction(_this.props.onClick, InputInline.setValueOnEvent(event));
        };
        return _this;
    }
    /**
...
var Input = styled_1.default('div')(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  min-width: 40px;\n  margin: 0;\n  border: 1px solid ", ";\n  outline: none;\n\n  line-height: inherit;\n  border-radius: ", ";\n  background: transparent;\n  padding: 1px;\n\n  &:focus,\n  &:active {\n    border: 1px solid ", ";\n    background-color: ", ";\n  }\n"], ["\n  min-width: 40px;\n  margin: 0;\n  border: 1px solid ", ";\n  outline: none;\n\n  line-height: inherit;\n  border-radius: ", ";\n  background: transparent;\n  padding: 1px;\n\n  &:focus,\n  &:active {\n    border: 1px solid ", ";\n    background-color: ", ";\n  }\n"])), function (p) { return (p.isHovering ? p.theme.border : 'transparent'); }, space_1.default(0.5), function (p) { return (p.isDisabled ? 'transparent' : p.theme.border); }, function (p) { return (p.isDisabled ? 'transparent' : p.theme.gray200); });
var StyledIconEdit = styled_1.default(icons_1.IconEdit)(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  color: ", ";\n  margin-left: ", ";\n\n  &:hover {\n    cursor: pointer;\n  }\n"], ["\n  color: ", ";\n  margin-left: ", ";\n\n  &:hover {\n    cursor: pointer;\n  }\n"])), function (p) { return p.theme.gray300; }, space_1.default(0.5));
