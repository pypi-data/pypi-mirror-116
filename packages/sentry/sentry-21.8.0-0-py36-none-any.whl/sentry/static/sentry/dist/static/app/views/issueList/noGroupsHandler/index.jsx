...
var noUnresolvedIssues_1 = tslib_1.__importDefault(require("./noUnresolvedIssues"));
/**
...
var NoGroupsHandler = /** @class */ (function (_super) {
    tslib_1.__extends(NoGroupsHandler, _super);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _b = tslib_1.__read.apply(void 0, [_c.sent(), 2]), sentFirstEvent = _b[0].sentFirstEvent, projects = _b[1];
    ...
    NoGroupsHandler.prototype.renderAwaitingEvents = function (projects) {
        ...
        var ErrorRobot = React.lazy(function () { return Promise.resolve().then(function () { return tslib_1.__importStar(require('app/components/errorRobot')); }); });
    ...
    NoGroupsHandler.prototype.renderEmpty = function () {
        ...
        <p>{emptyMessage !== null && emptyMessage !== void 0 ? emptyMessage : locale_1.t('Sorry, no issues match your filters.')}</p>
