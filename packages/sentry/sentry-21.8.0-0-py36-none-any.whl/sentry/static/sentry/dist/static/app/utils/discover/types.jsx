...
exports.CHART_AXIS_OPTIONS = exports.DISPLAY_MODE_FALLBACK_OPTIONS = exports.DISPLAY_MODE_OPTIONS = exports.DisplayModes = exports.TOP_N = void 0;
...
exports.DISPLAY_MODE_OPTIONS = [
    { value: DisplayModes.DEFAULT, label: locale_1.t('Total Period') },
    { value: DisplayModes.PREVIOUS, label: locale_1.t('Previous Period') },
    { value: DisplayModes.TOP5, label: locale_1.t('Top 5 Period') },
    { value: DisplayModes.DAILY, label: locale_1.t('Total Daily') },
    { value: DisplayModes.DAILYTOP5, label: locale_1.t('Top 5 Daily') },
];
/**
 ...
 */
exports.DISPLAY_MODE_FALLBACK_OPTIONS = (_a = {},
