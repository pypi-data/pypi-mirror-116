...
function Item(_a) {
    ...
    return (<Wrapper ref={forwardRef} style={tslib_1.__assign(tslib_1.__assign({}, wrapperStyle), { transition: transition, '--translate-x': transform ? Math.round(transform.x) + "px" : undefined, '--translate-y': transform ? Math.round(transform.y) + "px" : undefined, '--scale-x': (transform === null || transform === void 0 ? void 0 : transform.scaleX) ? "" + transform.scaleX : undefined, '--scale-y': (transform === null || transform === void 0 ? void 0 : transform.scaleY) ? "" + transform.scaleY : undefined })}>
