...
var ContextSummaryOS = function (_a) {
    ...
    if (Object.keys(data).length === 0 || !data.name) {
        return <contextSummaryNoSummary_1.default title={locale_1.t('Unknown OS')}/>;
    }
    ...
    var getVersionElement = function () {
        if (data.version) {
            return {
                ...
                value: data.version,
                meta: metaProxy_1.getMeta(data, 'version'),
            };
        }
        if (data.kernel_version) {
            return {
                subject: locale_1.t('Kernel:'),
                value: data.kernel_version,
                meta: metaProxy_1.getMeta(data, 'kernel_version'),
            };
        }
        return {
            subject: locale_1.t('Version:'),
