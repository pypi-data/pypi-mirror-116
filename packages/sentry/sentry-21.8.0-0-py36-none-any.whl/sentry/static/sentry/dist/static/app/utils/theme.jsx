...
var lightAliases = {
    ...
    searchTokenBackground: {
        valid: '#E8F3FE',
        validActive: color_1.default('#E8F3FE').darken(0.02).string(),
        invalid: colors.red100,
        invalidActive: color_1.default(colors.red100).darken(0.02).string(),
    },
    /**
    ...
    searchTokenBorder: {
        valid: '#B5DAFF',
        validActive: color_1.default('#B5DAFF').darken(0.15).string(),
        invalid: colors.red300,
        invalidActive: color_1.default(colors.red300).darken(0.15).string(),
    },
    /**
...
var dataCategory = (_a = {},
    _a[types_1.DataCategory.ERRORS] = chartPalette_1.default[4][3],
    _a[types_1.DataCategory.TRANSACTIONS] = chartPalette_1.default[4][2],
    _a[types_1.DataCategory.ATTACHMENTS] = chartPalette_1.default[4][1],
    _a[types_1.DataCategory.DEFAULT] = chartPalette_1.default[4][0],
    _a);
var generateAlertTheme = function (alias) { return ({
    ...
    info: {
        ...
        backgroundLight: color_1.default(colors.blue100).alpha(alias.alertBackgroundAlpha).string(),
        border: colors.blue200,
        iconColor: colors.blue300,
    },
    warning: {
        background: colors.yellow300,
        backgroundLight: color_1.default(colors.yellow100).alpha(alias.alertBackgroundAlpha).string(),
        border: colors.yellow300,
        iconColor: colors.yellow300,
    },
    success: {
        background: colors.green300,
        backgroundLight: color_1.default(colors.green100).alpha(alias.alertBackgroundAlpha).string(),
        border: colors.green200,
        iconColor: colors.green300,
    },
    error: {
        background: colors.red300,
        backgroundLight: color_1.default(colors.red100).alpha(alias.alertBackgroundAlpha).string(),
...
var generateButtonTheme = function (alias) { return ({
    ...
    default: {
        ...
        focusShadow: color_1.default(colors.gray200).alpha(0.5).string(),
    },
    primary: {
        color: colors.white,
        ...
        focusShadow: color_1.default(colors.purple300).alpha(0.4).string(),
    },
    success: {
        color: colors.white,
        colorActive: colors.white,
        ...
        border: '#7ccca5',
        borderActive: '#7ccca5',
        focusShadow: color_1.default(colors.green300).alpha(0.5).string(),
    },
    danger: {
        color: colors.white,
        colorActive: colors.white,
        ...
        border: '#bf2a1d',
        borderActive: '#7d1c13',
        focusShadow: color_1.default(colors.red300).alpha(0.5).string(),
    },
    link: {
...
var commonTheme = tslib_1.__assign(tslib_1.__assign({ breakpoints: ['800px', '992px', '1200px', '1440px', '2560px'] }, colors), { iconSizes: iconSizes, iconDirections: {
        up: '0',
        right: '90',
        down: '180',
        left: '270',
    ...
    fontSizeRelativeSmall: '0.9em', fontSizeExtraSmall: '11px', fontSizeSmall: '12px', fontSizeMedium: '14px', fontSizeLarge: '16px', fontSizeExtraLarge: '18px', headerFontSize: '22px', settings: {
        ...
        getColorPalette: function (length) {
            return chartPalette_1.default[Math.min(chartPalette_1.default.length - 1, length + 1)];
        },
