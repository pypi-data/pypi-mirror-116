...
function PlatformList(_a) {
    ...
    function renderContent() {
        ...
        if (displayCounter) {
            return (<InnerWrapper>
          <PlatformIcons>
            {platformIcons.map(function (visiblePlatform, index) { return (<tooltip_1.default key={visiblePlatform + index} title={getPlatformName_1.default(visiblePlatform)} containerDisplayMode="inline-flex">
                <StyledPlatformIcon platform={visiblePlatform} size={size}/>
              </tooltip_1.default>); })}
          </PlatformIcons>
          <tooltip_1.default title={locale_1.tn('%s other platform', '%s other platforms', numNotVisiblePlatforms)} containerDisplayMode="inline-flex">
            <Counter>
...
var PlatformIcons = styled_1.default('div')(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  display: flex;\n"], ["\n  display: flex;\n"])));
var InnerWrapper = styled_1.default('div')(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  position: relative;\n"], ["\n  display: flex;\n  position: relative;\n"])));
var Plus = styled_1.default('span')(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  font-size: 10px;\n"], ["\n  font-size: 10px;\n"])));
var StyledPlatformIcon = styled_1.default(platformicons_1.PlatformIcon)(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n  ", ";\n"], ["\n  ", ";\n"])), function (p) { return commonStyles(p); });
var Counter = styled_1.default('div')(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["\n  ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  text-align: center;\n  font-weight: 600;\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  padding: 0 1px;\n  position: absolute;\n  right: -1px;\n"], ["\n  ", ";\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  text-align: center;\n  font-weight: 600;\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  padding: 0 1px;\n  position: absolute;\n  right: -1px;\n"])), function (p) { return commonStyles(p); }, function (p) { return p.theme.fontSizeExtraSmall; }, function (p) { return p.theme.gray200; }, function (p) { return p.theme.gray300; });
var Wrapper = styled_1.default('div')(templateObject_8 || (templateObject_8 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  flex-shrink: 0;\n  justify-content: ", ";\n  ", ";\n\n  ", " {\n    ", "\n  }\n\n  ", " {\n    padding-right: ", "px;\n  }\n\n  ", " {\n    height: ", "px;\n    min-width: ", "px;\n  }\n"], ["\n  display: flex;\n  flex-shrink: 0;\n  justify-content: ", ";\n  ", ";\n\n  ", " {\n    ", "\n  }\n\n  ", " {\n    padding-right: ", "px;\n  }\n\n  ", " {\n    height: ", "px;\n    min-width: ", "px;\n  }\n"])), function (p) { return (p.direction === 'right' ? 'flex-end' : 'flex-start'); }, function (p) {
    return p.consistentWidth && "width: " + (p.size + (p.max - 1) * getOverlapWidth(p.size)) + "px;";
}, PlatformIcons, function (p) {
    return p.showCounter
        ? react_1.css(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["\n            z-index: 1;\n            flex-direction: row-reverse;\n            > * :not(:first-child) {\n              margin-right: ", "px;\n            }\n          "], ["\n            z-index: 1;\n            flex-direction: row-reverse;\n            > * :not(:first-child) {\n              margin-right: ", "px;\n            }\n          "])), p.size * -1 + getOverlapWidth(p.size)) : react_1.css(templateObject_7 || (templateObject_7 = tslib_1.__makeTemplateObject(["\n            > * :not(:first-child) {\n              margin-left: ", "px;\n            }\n          "], ["\n            > * :not(:first-child) {\n              margin-left: ", "px;\n            }\n          "])), p.size * -1 + getOverlapWidth(p.size));
