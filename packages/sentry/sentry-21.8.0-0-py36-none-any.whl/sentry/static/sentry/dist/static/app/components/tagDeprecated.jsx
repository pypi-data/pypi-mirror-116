...
var Tag = styled_1.default(function (_a) {
    var children = _a.children, icon = _a.icon, _inline = _a.inline, _priority = _a.priority, _size = _a.size, _border = _a.border, props = tslib_1.__rest(_a, ["children", "icon", "inline", "priority", "size", "border"]);
    return (<div {...props}>
      {icon && (<IconWrapper>
