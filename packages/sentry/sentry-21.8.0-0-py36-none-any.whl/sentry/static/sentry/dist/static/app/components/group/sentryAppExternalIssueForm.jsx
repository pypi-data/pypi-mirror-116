...
var SentryAppExternalIssueForm = /** @class */ (function (_super) {
    tslib_1.__extends(SentryAppExternalIssueForm, _super);
    function SentryAppExternalIssueForm() {
        ...
        _this.onSubmitError = function () {
            ...
            indicator_1.addErrorMessage(locale_1.t('Unable to %s %s issue.', action, appName));
        };
        ...
        _this.debouncedOptionLoad = debounce_1.default(
        // debounce is used to prevent making a request for every input change and
        // instead makes the requests every 200ms
        function (field, input, resolve) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        _this.makeExternalRequest = function (field, input) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
         ...
         */
        _this.handleFieldChange = function (id) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    case 1:
                        ...
                        this.setState(function (state) {
                            ...
                            impactedFields.forEach(function (impactedField, i) {
                                ...
                                var updatedField = tslib_1.__assign(tslib_1.__assign({}, impactedField), { choices: choices });
                                // immutably update the lists with the updated field depending where we got it from
                                if (requiredIndex > -1) {
                                    requiredFields = replaceAtArrayIndex_1.replaceAtArrayIndex(requiredFields, requiredIndex, updatedField);
                                }
                                else if (optionalIndex > -1) {
                                    optionalFields = replaceAtArrayIndex_1.replaceAtArrayIndex(optionalFields, optionalIndex, updatedField);
                                }
                            });
                            return {
        ...
        _this.renderField = function (field, required) {
            ...
            var fieldToPass = tslib_1.__assign(tslib_1.__assign({}, field), { inline: false, stacked: true, flexibleControlStateSize: true, required: required });
            ...
            if (fieldToPass.type === 'select') {
                ...
                var filterOption = react_select_1.createFilter({});
                fieldToPass = tslib_1.__assign(tslib_1.__assign({}, fieldToPass), { options: options, defaultOptions: defaultOptions, filterOption: filterOption, allowClear: allowClear });
                ...
                fieldToPass = tslib_1.__assign(tslib_1.__assign({}, fieldToPass), { defaultValue: _this.getFieldDefault(field) });
            }
            if (field.depends_on) {
                ...
                if (shouldDisable) {
                    fieldToPass = tslib_1.__assign(tslib_1.__assign({}, fieldToPass), { disabled: true });
                }
            }
    ...
    SentryAppExternalIssueForm.prototype.getStacktrace = function () {
        ...
        var contentArr = getStacktraceBody_1.default(evt);
    ...
    SentryAppExternalIssueForm.prototype.getFieldDefault = function (field) {
        ...
        switch (field.default) {
            ...
            case 'issue.description':
                ...
                var url = queryString_1.addQueryParamsToExistingUrl(group.permalink, queryParams);
                var shortId = group.shortId;
                return locale_1.t('Sentry Issue: [%s](%s)%s', shortId, url, stacktrace);
            default:
                return '';
        }
    };
    SentryAppExternalIssueForm.prototype.render = function () {
        ...
        return (<form_1.default key={action} apiEndpoint={"/sentry-app-installations/" + sentryAppInstallation.uuid + "/external-issue-actions/"} apiMethod="POST" onSubmitSuccess={this.onSubmitSuccess} onSubmitError={this.onSubmitError} onFieldChange={this.handleFieldChange} model={this.model}>
...
exports.default = withApi_1.default(SentryAppExternalIssueForm);
