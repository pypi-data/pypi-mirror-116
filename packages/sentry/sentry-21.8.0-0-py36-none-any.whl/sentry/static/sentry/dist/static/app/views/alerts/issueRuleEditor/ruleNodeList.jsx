...
var ruleNode_1 = tslib_1.__importDefault(require("./ruleNode"));
var RuleNodeList = /** @class */ (function (_super) {
    tslib_1.__extends(RuleNodeList, _super);
    ...
    RuleNodeList.prototype.render = function () {
        ...
        var createSelectOptions = function (actions) {
            return actions.map(function (node) {
                var _a;
                var isBeta = node.id === issueAlertOptions_1.EVENT_FREQUENCY_PERCENT_CONDITION;
                return {
                    value: node.id,
        ...
        if (selectType === 'grouped') {
            ...
            options = Object.entries(grouped)
                ...
                var label = key === 'ticket'
                    ? locale_1.t("Create new\u2026")
                    : locale_1.t("Send notification to\u2026");
        ...
        <RuleNodes>
          {error}
          {items.map(function (item, idx) { return (<ruleNode_1.default key={idx} index={idx} node={_this.getNode(item.id)} onDelete={onDeleteRow} onPropertyChange={onPropertyChange} onReset={onResetRow} data={item} organization={organization} project={project} disabled={disabled}/>); })}
        </RuleNodes>
...
var RuleNodes = styled_1.default('div')(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  display: grid;\n  margin-bottom: ", ";\n  grid-gap: ", ";\n\n  @media (max-width: ", ") {\n    grid-auto-flow: row;\n  }\n"], ["\n  display: grid;\n  margin-bottom: ", ";\n  grid-gap: ", ";\n\n  @media (max-width: ", ") {\n    grid-auto-flow: row;\n  }\n"])), space_1.default(1), space_1.default(1), function (p) { return p.theme.breakpoints[1]; });
var StyledFeatureBadge = styled_1.default(featureBadge_1.default)(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  margin: 0 ", " 0 0;\n"], ["\n  margin: 0 ", " 0 0;\n"])), space_1.default(1));
