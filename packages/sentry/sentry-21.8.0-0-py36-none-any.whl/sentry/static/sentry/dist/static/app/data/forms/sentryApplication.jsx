...
var getPublicFormFields = function () { return [
    ...
    },
    {
        ...
        help: locale_1.tct('All webhook requests for your integration will be sent to this URL. Visit the [webhook_docs:documentation] to see the different types and payloads.', {
    ...
    },
    {
        ...
        help: locale_1.tct('If enabled, this integration will be available in Issue Alert rules and Metric Alert rules in Sentry. The notification destination is the Webhook URL specified above. More on actions [learn_more:here].', {
    ...
    },
    {
        ...
        autosize: true,
        rows: 1,
        help: locale_1.tct('Schema for your UI components. Click [schema_docs:here] for documentation.', {
