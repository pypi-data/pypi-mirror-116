...
var Settings = /** @class */ (function (_super) {
    ...
    function Settings(props, context) {
        ...
        _this.back = function (ev) {
            ev.preventDefault();
            if (_this.state.state === forms_1.FormState.SAVING) {
                return;
            }
            _this.setState({
    ...
    Settings.prototype.onSubmit = function () {
        var _this = this;
        var _a;
        if (isEqual_1.default(this.state.initialData, this.state.formData)) {
            if (this.isLastPage()) {
    ...
    Settings.prototype.render = function () {
        ...
        if (this.state.editing) {
            ...
            fields = (_b = this.state.fieldList) === null || _b === void 0 ? void 0 : _b.map(function (f) { return (tslib_1.__assign(tslib_1.__assign({}, f), { readonly: true })); });
