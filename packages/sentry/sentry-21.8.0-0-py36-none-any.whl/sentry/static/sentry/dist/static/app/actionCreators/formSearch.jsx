...
var createSearchMap = function (_a) {
    var route = _a.route, formGroups = _a.formGroups, fields = _a.fields, other = tslib_1.__rest(_a, ["route", "formGroups", "fields"]);
    ...
    var listOfFields = formGroups
        ? flatMap_1.default(formGroups, function (formGroup) { return formGroup.fields; })
        : Object.keys(fields).map(function (fieldName) { return fields[fieldName]; });
    return listOfFields.map(function (field) { return (tslib_1.__assign(tslib_1.__assign({}, other), { route: route, title: typeof field !== 'function' ? field.label : undefined, description: typeof field !== 'function' ? field.help : undefined, field: field })); });
};
function loadSearchMap() {
    ...
    var allFormFields = flatten_1.default(context
        .keys()
        .map(function (key) {
        var mod = context(key);
