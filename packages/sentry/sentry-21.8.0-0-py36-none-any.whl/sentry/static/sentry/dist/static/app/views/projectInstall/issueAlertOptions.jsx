...
function unpackConditions(conditions) {
    ...
    var equalityReducer = function (acc, curr) {
        if (!acc || !curr || !isEqual_1.default(acc, curr)) {
            return null;
        }
        return acc;
    };
...
var IssueAlertOptions = /** @class */ (function (_super) {
    tslib_1.__extends(IssueAlertOptions, _super);
    function IssueAlertOptions() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    IssueAlertOptions.prototype.getDefaultState = function () {
        return tslib_1.__assign(tslib_1.__assign({}, _super.prototype.getDefaultState.call(this)), { conditions: [], intervalChoices: [], alertSetting: Actions.CREATE_ALERT_LATER.toString(), metric: MetricValues.ERRORS, interval: '', threshold: '' });
    };
    IssueAlertOptions.prototype.getAvailableMetricChoices = function () {
        var _this = this;
        return [
            [MetricValues.ERRORS, locale_1.t('occurrences of')],
            [MetricValues.USERS, locale_1.t('users affected by')],
        ].filter(function (valueDescriptionPair) {
            var _a, _b;
            var _c = tslib_1.__read(valueDescriptionPair, 1), value = _c[0];
    ...
    IssueAlertOptions.prototype.getIssueAlertsChoices = function (hasProperlyLoadedConditions) {
        var _this = this;
        var options = [
            [Actions.CREATE_ALERT_LATER.toString(), locale_1.t("I'll create my own alerts later")],
            [Actions.ALERT_ON_EVERY_ISSUE.toString(), locale_1.t('Alert me on every new issue')],
        ];
        if (hasProperlyLoadedConditions) {
          ...
          {locale_1.t('When there are more than')}
          <InlineInput type="number" min="0" name="" placeholder={DEFAULT_PLACEHOLDER_VALUE} value={this.state.threshold} onChange={function (threshold) {
        ...
        return options.map(function (_a) {
            var _b = tslib_1.__read(_a, 2), choiceValue = _b[0], node = _b[1];
            return [
                choiceValue,
    ...
    IssueAlertOptions.prototype.renderBody = function () {
        ...
        <PageHeadingWithTopMargins withMargins>
          {locale_1.t('Set your default alert settings')}
        </PageHeadingWithTopMargins>
        <RadioGroupWithPadding choices={issueAlertOptionsChoices} label={locale_1.t('Options for creating an alert')} onChange={function (alertSetting) { return _this.setStateAndUpdateParents({ alertSetting: alertSetting }); }} value={this.state.alertSetting}/>
      </React.Fragment>);
    };
    return IssueAlertOptions;
}(asyncComponent_1.default));
exports.default = withOrganization_1.default(IssueAlertOptions);
var CustomizeAlertsGrid = styled_1.default('div')(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  display: grid;\n  grid-template-columns: repeat(5, max-content);\n  grid-gap: ", ";\n  align-items: center;\n"], ["\n  display: grid;\n  grid-template-columns: repeat(5, max-content);\n  grid-gap: ", ";\n  align-items: center;\n"])), space_1.default(1));
var InlineInput = styled_1.default(input_1.default)(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  width: 80px;\n"], ["\n  width: 80px;\n"])));
...
var RadioGroupWithPadding = styled_1.default(radioGroup_1.default)(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n  padding: ", " 0;\n  margin-bottom: 50px;\n  box-shadow: 0 -1px 0 rgba(0, 0, 0, 0.1);\n"], ["\n  padding: ", " 0;\n  margin-bottom: 50px;\n  box-shadow: 0 -1px 0 rgba(0, 0, 0, 0.1);\n"])), space_1.default(3));
var PageHeadingWithTopMargins = styled_1.default(pageHeading_1.default)(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["\n  margin-top: 65px;\n"], ["\n  margin-top: 65px;\n"])));
var RadioItemWrapper = styled_1.default('div')(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["\n  min-height: 35px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n"], ["\n  min-height: 35px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n"])));
