...
var getGPUKnownDataDetails_1 = tslib_1.__importDefault(require("./getGPUKnownDataDetails"));
function getGPUKnownData(data, gpuKnownDataValues) {
    var e_1, _a;
    var knownData = [];
    var dataKeys = gpuKnownDataValues.filter(function (gpuKnownDataValue) {
        return utils_1.defined(data[gpuKnownDataValue]);
    });
    try {
        for (var dataKeys_1 = tslib_1.__values(dataKeys), dataKeys_1_1 = dataKeys_1.next(); !dataKeys_1_1.done; dataKeys_1_1 = dataKeys_1.next()) {
            ...
            var knownDataDetails = getGPUKnownDataDetails_1.default(data, key);
