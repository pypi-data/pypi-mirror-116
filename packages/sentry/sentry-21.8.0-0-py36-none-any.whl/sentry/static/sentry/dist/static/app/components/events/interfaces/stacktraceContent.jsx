...
var StacktraceContent = /** @class */ (function (_super) {
    tslib_1.__extends(StacktraceContent, _super);
    function StacktraceContent() {
        ...
        _this.renderOmittedFrames = function (firstFrameOmitted, lastFrameOmitted) {
            ...
            var text = locale_1.t('Frames %d until %d were omitted and not available.', firstFrameOmitted, lastFrameOmitted);
        ...
        return images && address
            ? images.find(function (img, idx) {
                if (!addrMode || addrMode === 'abs') {
                    var _a = tslib_1.__read(utils_1.getImageRange(img), 2), startAddress = _a[0], endAddress = _a[1];
    ...
    StacktraceContent.prototype.render = function () {
        ...
        var maxLengthOfAllRelativeAddresses = ((_c = data.frames) !== null && _c !== void 0 ? _c : []).reduce(function (maxLengthUntilThisPoint, frame) {
            ...
            try {
                var relativeAddress = (utils_1.parseAddress(frame.instructionAddr) -
                    utils_1.parseAddress(correspondingImage.image_addr)).toString(16);
        ...
        ((_d = data.frames) !== null && _d !== void 0 ? _d : []).forEach(function (frame, frameIdx) {
            ...
            if (_this.frameIsVisible(frame, nextFrame) && !repeatedFrame) {
                ...
                frames.push(<line_1.default key={frameIdx} event={event} data={frame} isExpanded={expandFirstFrame && lastFrameIdx === frameIdx} emptySourceNotation={lastFrameIdx === frameIdx && frameIdx === 0} isOnlyFrame={((_c = data.frames) !== null && _c !== void 0 ? _c : []).length === 1} nextFrame={nextFrame} prevFrame={prevFrame} platform={platform} timesRepeated={nRepeats} showingAbsoluteAddress={showingAbsoluteAddresses} onAddressToggle={_this.handleToggleAddresses} image={image} maxLengthOfRelativeAddress={maxLengthOfAllRelativeAddresses} registers={{}} // TODO: Fix registers
        ...
        <StyledPlatformIcon platform={utils_1.stackTracePlatformIcon(platform, (_e = data.frames) !== null && _e !== void 0 ? _e : [])} size="20px" style={{ borderRadius: '3px 0 0 3px' }}/>
...
exports.default = withOrganization_1.default(StacktraceContent);
...
var StyledList = styled_1.default('ul')(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  list-style: none;\n"], ["\n  list-style: none;\n"])));
