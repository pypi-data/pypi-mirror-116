...
var projectSelector_1 = tslib_1.__importDefault(require("./projectSelector"));
var MultipleProjectSelector = /** @class */ (function (_super) {
    tslib_1.__extends(MultipleProjectSelector, _super);
    function MultipleProjectSelector() {
        ...
        _this.handleQuickSelect = function (selected) {
            analytics_1.analytics('projectselector.direct_selection', {
        ...
        _this.handleClose = function () {
            ...
            analytics_1.analytics('projectselector.update', {
                count: value.length,
                path: getRouteStringFromRoutes_1.default(_this.props.router.routes),
                org_id: parseInt(_this.props.organization.id, 10),
                multi: multi,
        ...
        _this.handleClear = function () {
            analytics_1.analytics('projectselector.clear', {
                path: getRouteStringFromRoutes_1.default(_this.props.router.routes),
                org_id: parseInt(_this.props.organization.id, 10),
            });
        ...
        _this.handleMultiSelect = function (selected) {
            ...
            analytics_1.analytics('projectselector.toggle', {
    ...
    MultipleProjectSelector.prototype.renderProjectName = function () {
        var _a = this.props, forceProject = _a.forceProject, location = _a.location, multi = _a.multi, organization = _a.organization, showIssueStreamLink = _a.showIssueStreamLink;
        if (showIssueStreamLink && forceProject && multi) {
            return (<tooltip_1.default title={locale_1.t('Issues Stream')} position="bottom">
          <StyledLink to={{
                    pathname: "/organizations/" + organization.slug + "/issues/",
                    query: tslib_1.__assign(tslib_1.__assign({}, location.query), { project: forceProject.id }),
                }}>
            {forceProject.slug}
          </StyledLink>
        </tooltip_1.default>);
    ...
    MultipleProjectSelector.prototype.getLockedMessage = function () {
        ...
        if (forceProject) {
            return locale_1.tct('This [subject] is unique to the [projectSlug] project', {
                subject: lockedMessageSubject,
                projectSlug: forceProject.slug,
            });
        }
        return locale_1.tct('This [subject] is unique to a project', { subject: lockedMessageSubject });
    };
    MultipleProjectSelector.prototype.render = function () {
        ...
        var allProjects = tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(projects)), tslib_1.__read(nonMemberProjects));
        ...
        {function (_a) {
                var css = _a.css;
                return (<StyledProjectSelector {..._this.props} multi={!!multi} selectedProjects={selected} multiProjects={projects} onSelect={_this.handleQuickSelect} onClose={_this.handleClose} onMultiSelect={_this.handleMultiSelect} rootClassName={css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n              display: flex;\n            "], ["\n              display: flex;\n            "])))} menuFooter={function (_a) {
                        ...
                        return (<SelectorFooterControls selected={selectedProjectIds} multi={multi} organization={organization} hasChanges={_this.state.hasChanges} onApply={function () { return _this.handleUpdate(actions); }} onShowAllProjects={function () {
                                _this.handleQuickSelect({ id: globalSelectionHeader_1.ALL_ACCESS_PROJECTS.toString() });
                                actions.close();
            ...
            {function (_a) {
                        ...
                        var title = hasSelected
                            ...
                            : selectedProjectIds.has(globalSelectionHeader_1.ALL_ACCESS_PROJECTS)
                                ...
                                : locale_1.t('My Projects');
                        var icon = hasSelected ? (<platformList_1.default platforms={selectedProjects.map(function (p) { var _a; return (_a = p.platform) !== null && _a !== void 0 ? _a : 'other'; }).reverse()} max={5}/>) : (<icons_1.IconProject />);
    ...
    MultipleProjectSelector.defaultProps = {
        multi: true,
        lockedMessageSubject: locale_1.t('page'),
    };
...
var SelectorFooterControls = function (_a) {
    ...
    if (multi) {
        ...
        var allSelected = selected && selected.has(globalSelectionHeader_1.ALL_ACCESS_PROJECTS);
    ...
    return (<FooterContainer>
      ...
      <FooterActions>
        {showAllProjects && (<button_1.default onClick={onShowAllProjects} priority="default" size="xsmall">
            {locale_1.t('View All Projects')}
          </button_1.default>)}
        {showMyProjects && (<button_1.default onClick={onShowMyProjects} priority="default" size="xsmall">
            {locale_1.t('View My Projects')}
          </button_1.default>)}
        {hasChanges && (<SubmitButton onClick={onApply} size="xsmall" priority="primary">
            {locale_1.t('Apply Filter')}
          </SubmitButton>)}
      </FooterActions>
    </FooterContainer>);
};
exports.default = react_router_1.withRouter(MultipleProjectSelector);
var FooterContainer = styled_1.default('div')(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  padding: ", " 0;\n"], ["\n  padding: ", " 0;\n"])), space_1.default(1));
var FooterActions = styled_1.default('div')(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  justify-content: flex-end;\n  & > * {\n    margin-left: ", ";\n  }\n"], ["\n  display: flex;\n  justify-content: flex-end;\n  & > * {\n    margin-left: ", ";\n  }\n"])), space_1.default(0.5));
var SubmitButton = styled_1.default(button_1.default)(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n  animation: 0.1s ", " ease-in;\n"], ["\n  animation: 0.1s ", " ease-in;\n"])), animations_1.growIn);
var FooterMessage = styled_1.default('div')(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["\n  font-size: ", ";\n  padding: 0 ", ";\n"], ["\n  font-size: ", ";\n  padding: 0 ", ";\n"])), function (p) { return p.theme.fontSizeSmall; }, space_1.default(0.5));
var StyledProjectSelector = styled_1.default(projectSelector_1.default)(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["\n  background-color: ", ";\n  color: ", ";\n  margin: 1px 0 0 -1px;\n  border-radius: ", ";\n  width: 100%;\n"], ["\n  background-color: ", ";\n  color: ", ";\n  margin: 1px 0 0 -1px;\n  border-radius: ", ";\n  width: 100%;\n"])), function (p) { return p.theme.background; }, function (p) { return p.theme.textColor; }, function (p) { return p.theme.borderRadiusBottom; });
var StyledHeaderItem = styled_1.default(headerItem_1.default)(templateObject_7 || (templateObject_7 = tslib_1.__makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n  ", ";\n"], ["\n  height: 100%;\n  width: 100%;\n  ", ";\n"])), function (p) { return p.locked && 'cursor: default'; });
var StyledLink = styled_1.default(react_router_1.Link)(templateObject_8 || (templateObject_8 = tslib_1.__makeTemplateObject(["\n  color: ", ";\n\n  &:hover {\n    color: ", ";\n  }\n"], ["\n  color: ", ";\n\n  &:hover {\n    color: ", ";\n  }\n"])), function (p) { return p.theme.subText; }, function (p) { return p.theme.subText; });
