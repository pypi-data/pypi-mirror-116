...
var pluginComponentBase_1 = tslib_1.__importDefault(require("app/components/bases/pluginComponentBase"));
...
var IssueActions = /** @class */ (function (_super) {
    tslib_1.__extends(IssueActions, _super);
    function IssueActions(props, context) {
        var _this = _super.call(this, props, context) || this;
        _this.loadOptionsForDependentField = function (field) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        query = tslib_1.__assign({ option_field: field.name }, dependentFormValues);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
        ...
        _this.updateOptionsOfDependentField = function (field, choices) {
            ...
            field = tslib_1.__assign(tslib_1.__assign({}, field), { choices: choices });
            // make a copy of the array to avoid mutation
            fieldList = fieldList.slice();
            fieldList[indexOfField] = field;
            _this.setState(function (prevState) {
                var _a;
                return (tslib_1.__assign(tslib_1.__assign({}, prevState), (_a = {}, _a[formListKey] = fieldList, _a)));
            });
        };
        _this.resetOptionsOfDependentField = function (field) {
            ...
            var formData = tslib_1.__assign({}, _this.state[formDataKey]);
            formData[field.name] = '';
            _this.setState(function (prevState) {
                var _a;
                return (tslib_1.__assign(tslib_1.__assign({}, prevState), (_a = {}, _a[formDataKey] = formData, _a)));
            });
            _this.setDependentFieldState(field.name, forms_1.FormState.DISABLED);
        };
        ...
        _this.state = tslib_1.__assign(tslib_1.__assign({}, _this.state), { loading: ['link', 'create'].includes(_this.props.actionType), state: ['link', 'create'].includes(_this.props.actionType)
    ...
    IssueActions.prototype.setDependentFieldState = function (fieldName, state) {
        var _a;
        var dependentFieldState = tslib_1.__assign(tslib_1.__assign({}, this.state.dependentFieldState), (_a = {}, _a[fieldName] = state, _a));
    ...
    IssueActions.prototype.errorHandler = function (error) {
        ...
        if (error.status === 400 && error.responseJSON) {
            ...
            state.error = { message: locale_1.t('An unknown error occurred.') };
        }
        this.setState(state);
    };
    ...
    IssueActions.prototype.createIssue = function () {
        ...
        this.api.request(this.getPluginCreateEndpoint(), {
            ...
            error: this.onSaveError.bind(this, function (error) {
                _this.setError(error, locale_1.t('There was an error creating the issue.'));
            }),
    ...
    IssueActions.prototype.linkIssue = function () {
        ...
        this.api.request(this.getPluginLinkEndpoint(), {
            ...
            success: this.onSuccess,
            error: this.onSaveError.bind(this, function (error) {
                _this.setError(error, locale_1.t('There was an error linking the issue.'));
            }),
            complete: this.onSaveComplete,
        });
    };
    IssueActions.prototype.unlinkIssue = function () {
        ...
        this.api.request(this.getPluginUnlinkEndpoint(), {
            success: this.onSuccess,
            error: this.onSaveError.bind(this, function (error) {
                _this.setError(error, locale_1.t('There was an error unlinking the issue.'));
            }),
            complete: this.onSaveComplete,
        });
    };
    IssueActions.prototype.changeField = function (action, name, value) {
        ...
        var formData = tslib_1.__assign({}, this.state[formDataKey]);
        var fieldList = this.getFieldList();
        formData[name] = value;
        ...
        switch (this.props.actionType) {
            case 'create':
                if (this.state.createFieldList) {
                    return (<forms_1.Form onSubmit={this.createIssue} submitLabel={locale_1.t('Create Issue')} footerClass="">
              {this.state.createFieldList.map(function (field) {
                    ...
                    {_this.renderField({
                                    config: tslib_1.__assign(tslib_1.__assign({}, field), _this.getInputProps(field)),
            ...
            case 'link':
                if (this.state.linkFieldList) {
                    return (<forms_1.Form onSubmit={this.linkIssue} submitLabel={locale_1.t('Link Issue')} footerClass="">
            ...
            case 'unlink':
                return (<div>
            <p>{locale_1.t('Are you sure you want to unlink this issue?')}</p>
            <button onClick={this.unlinkIssue} className="btn btn-danger">
              {locale_1.t('Unlink Issue')}
            </button>
          </div>);
            default:
                return null;
