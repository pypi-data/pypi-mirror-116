...
var DragManager = /** @class */ (function (_super) {
    ...
    function DragManager() {
        ...
        _this.onDragStart = function (viewHandle) {
        ...
        _this.onDragMove = function (event) {
            ...
            var rect = utils_1.rectOfContent(_this.props.interactiveLayerRef.current);
            ...
            switch (_this.state.currentDraggingHandle) {
                case ViewHandleType.Left: {
                    ...
                    _this.setState({
                        ...
                        leftHandlePosition: utils_1.clamp(rawMouseX, min, max),
                    });
                    break;
                }
                case ViewHandleType.Right: {
                    ...
                    _this.setState({
                        ...
                        rightHandlePosition: utils_1.clamp(rawMouseX, min, max),
                    });
                    break;
                }
                default: {
        ...
        _this.onWindowSelectionDragMove = function (event) {
            ...
            var windowSelectionCurrent = utils_1.clamp(rawMouseX, min, max);
            var windowSelectionSize = utils_1.clamp(Math.abs(_this.state.windowSelectionInitial - windowSelectionCurrent), min, max);
            _this.setState({
