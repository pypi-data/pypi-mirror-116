...
var TransactionTags = /** @class */ (function (_super) {
    tslib_1.__extends(TransactionTags, _super);
    function TransactionTags() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = {
            eventView: generateTagsEventView(_this.props.location, utils_1.getTransactionName(_this.props.location)),
        };
    ...
    TransactionTags.getDerivedStateFromProps = function (nextProps, prevState) {
        return tslib_1.__assign(tslib_1.__assign({}, prevState), { eventView: generateTagsEventView(nextProps.location, utils_1.getTransactionName(nextProps.location)) });
    };
    TransactionTags.prototype.getDocumentTitle = function () {
        ...
        if (hasTransactionName) {
            return [String(name).trim(), locale_1.t('Tags')].join(' \u2014 ');
        }
        return [locale_1.t('Summary'), locale_1.t('Tags')].join(' \u2014 ');
    };
    TransactionTags.prototype.render = function () {
        ...
        <feature_1.default features={['performance-tag-page']} organization={organization} renderDisabled={this.renderNoAccess}>
...
exports.default = withGlobalSelection_1.default(withProjects_1.default(withOrganization_1.default(TransactionTags)));
