...
var StreamManager = /** @class */ (function () {
    ...
    StreamManager.prototype.push = function (items) {
        ...
        this.idList = tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(this.idList)), tslib_1.__read(ids));
        this.trim();
    ...
    StreamManager.prototype.unshift = function (items) {
        ...
        var ids = items.map(function (item) { return item.id; });
        this.idList = this.idList.filter(function (id) { return !ids.includes(id); });
        this.idList = tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(ids)), tslib_1.__read(this.idList));
        this.trim();
        this.store.add(items);
    };
