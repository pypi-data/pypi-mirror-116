...
var DropdownMenu = /** @class */ (function (_super) {
    ...
    function DropdownMenu() {
        ...
        _this.checkClickOutside = function (e) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        _this.getActorProps = function (_a) {
            if (_a === void 0) { _a = {}; }
            var onClick = _a.onClick, onMouseEnter = _a.onMouseEnter, onMouseLeave = _a.onMouseLeave, onKeyDown = _a.onKeyDown, _b = _a.style, style = _b === void 0 ? {} : _b, props = tslib_1.__rest(_a, ["onClick", "onMouseEnter", "onMouseLeave", "onKeyDown", "style"]);
            ...
            return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, props), refProps), { style: tslib_1.__assign(tslib_1.__assign({}, style), { outline: 'none' }), onKeyDown: function (e) {
        ...
        _this.getMenuProps = function (_a) {
            if (_a === void 0) { _a = {}; }
            var onClick = _a.onClick, onMouseLeave = _a.onMouseLeave, onMouseEnter = _a.onMouseEnter, props = tslib_1.__rest(_a, ["onClick", "onMouseLeave", "onMouseEnter"]);
            var refProps = { ref: _this.handleMenuMount };
            // Props that the menu needs to have <DropdownMenu> work
            return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, props), refProps), { onMouseEnter: function (e) {
                    if (typeof onMouseEnter === 'function') {
                        onMouseEnter(e);
                    }
