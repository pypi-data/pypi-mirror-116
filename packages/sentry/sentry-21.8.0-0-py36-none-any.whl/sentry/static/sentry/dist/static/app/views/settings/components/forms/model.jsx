...
var FormModel = /** @class */ (function () {
    function FormModel(_a) {
        if (_a === void 0) { _a = {}; }
        var initialData = _a.initialData, apiOptions = _a.apiOptions, options = tslib_1.__rest(_a, ["initialData", "apiOptions"]);
        /**
    ...
    Object.defineProperty(FormModel.prototype, "formChanged", {
         ...
         */
        get: function () {
            return !isEqual_1.default(this.initialData, Object.fromEntries(this.fields.toJSON()));
        },
        enumerable: false,
        configurable: true
    });
    ...
    FormModel.prototype.getTransformedData = function () {
        ...
        return Object.keys(form)
            ...
            var _b = tslib_1.__read(_a, 2), id = _b[0], value = _b[1];
            acc[id] = value;
            return acc;
        }, {});
    };
    ...
    FormModel.prototype.isValidRequiredField = function (id) {
        ...
        var value = this.getValue(id);
        return !isRequired || (value !== '' && utils_1.defined(value));
    };
    ...
    FormModel.prototype.validateField = function (id) {
        ...
        var fieldIsRequiredMessage = locale_1.t('Field is required');
        ...
        errors.forEach(function (_a) {
            var _b = tslib_1.__read(_a, 2), field = _b[0], errorMessage = _b[1];
    ...
    FormModel.prototype.saveField = function (id, currentValue) {
        ...
        return savePromise
            ...
            if (typeof _this.options.allowUndo === 'undefined' || _this.options.allowUndo) {
                indicator_1.saveOnBlurUndoMessage(change, _this, id);
            }
            if (_this.options.onSubmitSuccess) {
    ...
    FormModel.prototype.saveFieldRequest = function (id, currentValue) {
        ...
        if (currentValue === initialValue ||
            (currentValue === '' && !utils_1.defined(initialValue))) {
            return null;
        }
        ...
        request
            ...
            if (resp && resp.responseJSON) {
                ...
                if (Array.isArray(resp.responseJSON[id]) && resp.responseJSON[id].length) {
                    ...
                    indicator_1.addErrorMessage(nonFieldErrors[0], { duration: 10000 });
                    // Reset saving state
                    _this.setError(id, '');
                }
                else {
    ...
    FormModel.prototype.setFieldState = function (id, key, value) {
        var _a;
        var state = tslib_1.__assign(tslib_1.__assign({}, (this.fieldState.get(id) || {})), (_a = {}, _a[key] = value, _a));
