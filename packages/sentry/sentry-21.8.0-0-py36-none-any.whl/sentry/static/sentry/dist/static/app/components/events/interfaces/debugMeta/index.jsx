...
var imageForBar_1 = tslib_1.__importDefault(require("app/components/events/interfaces/imageForBar"));
...
var utils_2 = require("../debugMeta-v2/utils");
var debugImage_1 = tslib_1.__importDefault(require("./debugImage"));
...
var DebugMeta = /** @class */ (function (_super) {
    ...
    DebugMeta.prototype.componentDidUpdate = function (_prevProps, prevState) {
        ...
        if (!isEqual_1.default(prevState.foundFrame, this.state.foundFrame) ||
    ...
    DebugMeta.prototype.filterImage = function (image) {
        ...
        if (searchTerm.length < MIN_FILTER_LEN) {
            ...
            if (!isNil_1.default(image.unwind_status) && image.unwind_status !== 'unused') {
                return true;
            }
            return false;
        }
        ...
        if (searchTerm.indexOf('0x') === 0) {
            ...
            if (needle > 0 && image.image_addr !== '0x0') {
                var _d = tslib_1.__read(utils_1.getImageRange(image), 2), startAddress = _d[0], endAddress = _d[1];
    ...
    DebugMeta.prototype.getFrame = function () {
        ...
        if (relMatch) {
            ...
            var filteredImages_1 = debugImages.filter(function (_a) {
                var _b = tslib_1.__read(_a, 2), _ = _b[0], image = _b[1];
    ...
    DebugMeta.prototype.getDebugImages = function () {
        ...
        // "0xbeef").
        filtered.sort(function (a, b) { return utils_1.parseAddress(a.image_addr) - utils_1.parseAddress(b.image_addr); });
        return filtered;
    };
    DebugMeta.prototype.getNoImagesMessage = function () {
        ...
        if (debugImages.length === 0) {
            return locale_1.t('No loaded images available.');
        }
        if (!showUnused && !filter) {
            return locale_1.tct('No images are referenced in the stack trace. [toggle: Show Unreferenced]', {
                toggle: <button_1.default priority="link" onClick={this.handleShowUnused}/>,
            });
        }
        return locale_1.t('Sorry, no images match your query.');
    };
    DebugMeta.prototype.renderToolbar = function () {
        ...
        <Label>
          ...
          {locale_1.t('show unreferenced')}
        </Label>
        <SearchInputWrapper>
          <StyledSearchBar onChange={this.handleChangeFilter} query={filter} placeholder={locale_1.t('Search images\u2026')}/>
        </SearchInputWrapper>
      </ToolbarWrapper>);
    };
    ...
    DebugMeta.prototype.renderImageList = function () {
        ...
        if (!panelBodyHeight) {
            return filteredImages.map(function (filteredImage) { return (<debugImage_1.default key={filteredImage.debug_id} image={filteredImage} organization={organization} projectId={projectId} showDetails={showDetails}/>); });
        }
...
var StyledEventDataSection = styled_1.default(eventDataSection_1.default)(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  @media (max-width: ", ") {\n    padding-bottom: ", ";\n  }\n  /* to increase specificity */\n  @media (min-width: ", ") {\n    padding-bottom: ", ";\n  }\n"], ["\n  @media (max-width: ", ") {\n    padding-bottom: ", ";\n  }\n  /* to increase specificity */\n  @media (min-width: ", ") {\n    padding-bottom: ", ";\n  }\n"])), function (p) { return p.theme.breakpoints[0]; }, space_1.default(4), function (p) { return p.theme.breakpoints[0]; }, space_1.default(2));
var DebugImagesPanel = styled_1.default(panels_1.Panel)(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n  margin-bottom: ", ";\n  max-height: ", "px;\n  overflow: hidden;\n"], ["\n  margin-bottom: ", ";\n  max-height: ", "px;\n  overflow: hidden;\n"])), space_1.default(1), PANEL_MAX_HEIGHT);
var ToolbarWrapper = styled_1.default('div')(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  @media (max-width: ", ") {\n    flex-wrap: wrap;\n    margin-top: ", ";\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  @media (max-width: ", ") {\n    flex-wrap: wrap;\n    margin-top: ", ";\n  }\n"])), function (p) { return p.theme.breakpoints[0]; }, space_1.default(1));
var SearchInputWrapper = styled_1.default('div')(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["\n  width: 100%;\n\n  @media (max-width: ", ") {\n    width: 100%;\n    max-width: 100%;\n    margin-top: ", ";\n  }\n\n  @media (min-width: ", ") and (max-width: ", ") {\n    max-width: 180px;\n    display: inline-block;\n  }\n\n  @media (min-width: ", ") {\n    width: 330px;\n    max-width: none;\n  }\n\n  @media (min-width: 1550px) {\n    width: 510px;\n  }\n"], ["\n  width: 100%;\n\n  @media (max-width: ", ") {\n    width: 100%;\n    max-width: 100%;\n    margin-top: ", ";\n  }\n\n  @media (min-width: ", ") and (max-width: ", ") {\n    max-width: 180px;\n    display: inline-block;\n  }\n\n  @media (min-width: ", ") {\n    width: 330px;\n    max-width: none;\n  }\n\n  @media (min-width: 1550px) {\n    width: 510px;\n  }\n"])), function (p) { return p.theme.breakpoints[0]; }, space_1.default(1), function (p) { return p.theme.breakpoints[0]; }, function (p) {
...
var StyledSearchBar = styled_1.default(searchBar_1.default)(templateObject_7 || (templateObject_7 = tslib_1.__makeTemplateObject(["\n  .search-input {\n    height: 30px;\n  }\n"], ["\n  .search-input {\n    height: 30px;\n  }\n"])));
