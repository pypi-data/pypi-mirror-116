...
var dataScrubbing_1 = tslib_1.__importDefault(require("app/views/settings/components/dataScrubbing"));
...
function renderComponent(_a) {
    var _b;
    var disabled = _a.disabled, projectId = _a.projectId, endpoint = _a.endpoint, props = tslib_1.__rest(_a, ["disabled", "projectId", "endpoint"]);
    var organization = (_b = props.organization) !== null && _b !== void 0 ? _b : getOrganization();
    if (projectId) {
        return enzyme_1.mountWithTheme(<dataScrubbing_1.default additionalContext={additionalContext} endpoint={endpoint} projectId={projectId} relayPiiConfig={stringRelayPiiConfig} disabled={disabled} organization={organization} onSubmitSuccess={handleUpdateOrganization}/>);
    }
    return enzyme_1.mountWithTheme(<dataScrubbing_1.default additionalContext={additionalContext} endpoint={endpoint} relayPiiConfig={stringRelayPiiConfig} disabled={disabled} organization={organization} onSubmitSuccess={handleUpdateOrganization}/>);
}
describe('Data Scrubbing', function () {
    ...
    describe('Project level', function () {
        ...
        it('Delete rule successfully', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        mockDelete = MockApiClient.addMockResponse({
                            url: endpoint,
                            method: 'PUT',
                            body: getOrganization(JSON.stringify(tslib_1.__assign(tslib_1.__assign({}, relayPiiConfig), { rules: { 0: relayPiiConfig.rules[0] } }))),
                        });
