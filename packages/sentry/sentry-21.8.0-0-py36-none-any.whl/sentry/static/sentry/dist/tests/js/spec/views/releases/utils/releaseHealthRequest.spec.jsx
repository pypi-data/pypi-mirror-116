...
var utils_1 = require("app/views/releases/list/utils");
var releaseHealthRequest_1 = tslib_1.__importDefault(require("app/views/releases/utils/releaseHealthRequest"));
describe('ReleaseHealthRequest', function () {
    var _a = initializeOrg_1.initializeOrg(), organization = _a.organization, routerContext = _a.routerContext, router = _a.router;
    var projectId = 123;
    var selection = {
        projects: [projectId],
        environments: [],
    ...
    MockApiClient.addMockResponse({
        ...
        predicate: function (_url, _a) {
            var query = _a.query;
            return isEqual_1.default(query, {
    ...
    // @ts-expect-error
    var requestForAutoHealthStatsPeriodSessionHistogram = MockApiClient.addMockResponse({
        url: "/organizations/org-slug/sessions/",
        // @ts-ignore Cannot find TestStubs
    ...
    it('calculates correct session health data', function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var healthData, wrapper;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wrapper = enzyme_1.mountWithTheme(<releaseHealthRequest_1.default releases={[
                                '7a82c130be9143361f20bc77252df783cf91e4fc',
                                'e102abb2c46e7fe8686441091005c12aed90da99',
                            ]} organization={organization} location={tslib_1.__assign(tslib_1.__assign({}, router.location), { query: {
                                    project: [projectId],
                                } })} display={[utils_1.DisplayOption.SESSIONS]} selection={selection}>
        {function (_a) {
                                var getHealthData = _a.getHealthData;
                                healthData = getHealthData;
                                return null;
                            }}
      </releaseHealthRequest_1.default>, routerContext);
                        // @ts-expect-error
                        return [4 /*yield*/, tick()];
                    case 1:
                        // @ts-expect-error
...
//# sourceMappingURL=releaseHealthRequest.spec.jsx.map