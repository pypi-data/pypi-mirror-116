...
var edit_1 = tslib_1.__importDefault(require("app/views/settings/components/dataScrubbing/modals/edit"));
var submitRules_1 = tslib_1.__importDefault(require("app/views/settings/components/dataScrubbing/submitRules"));
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    modal = _a.sent();
                    modal_2.openModal(function (modalProps) { return (<edit_1.default {...modalProps} projectId={projectId} savedRules={rules} api={api} endpoint={endpoint} orgSlug={organizationSlug} onSubmitSuccess={successfullySaved} rule={rule}/>); });
                    // @ts-expect-error
                    return [4 /*yield*/, tick()];
                case 2:
                    // @ts-expect-error
...
describe('Edit Modal', function () {
    it('open Edit Rule Modal', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    methodFieldSelectOptions = sortBy_1.default(Object.values(types_1.MethodType)).map(function (value) { return (tslib_1.__assign(tslib_1.__assign({}, utils_1.getMethodLabel(value)), { value: value })); });
                    ...
                    typeFieldSelectOptions = sortBy_1.default(Object.values(types_1.RuleType)).map(function (value) { return ({
    ...
    it('edit Rule Modal', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
