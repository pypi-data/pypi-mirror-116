...
class AbstractUploadMutationCreator(abc.ABC):
    ...
    @abc.abstractmethod
    def _tag_check(self, info, file, name: str, description: str, tag: str, **kwargs) -> Tuple[bool, any]:
        """
    ...
    def _do_if_tags_check_fails(self, info, file, name: str, description: str, tag: str, tag_check_output, **kwargs):
        """
    ...
    @abc.abstractmethod
    def _perform_action_with_file(self, info, file, name: str, description: str, tag: str, **kwargs):
        """
