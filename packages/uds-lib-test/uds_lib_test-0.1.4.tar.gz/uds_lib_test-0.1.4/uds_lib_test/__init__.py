...
def transactions_list(company_id: str, api_key: str, max: int=10, offset: int=0):
    auth = partner_auth(company_id, api_key)
    try:
        params = 'max=' + str_parse(max) + '&offset=' + str_parse(
            offset)
        con = HTTPSConnection('api.uds.app', timeout=60)
        con.request(
            method='GET',
...
def transaction_refund(company_id: str or int, api_key: str, operation_id: str or int, partial_amount: float=None):
    auth = partner_auth(company_id, api_key)
    try:
        con = HTTPSConnection('api.uds.app', timeout=60)
        con.request(
...
# phone - Customer phone number
# skipLoyaltyTotal - A part of the bill amount for which cashback is not credited and to which the discount does not apply (in currency units).
def transaction_calc(company_id: str or int, api_key: str, total: int, code: str or int=None, uid: str=None,
                     phone:str =None, points: float=None, skip_loyalty_total: float=None):
    auth = partner_auth(company_id, api_key)
    try:
        con = HTTPSConnection('api.uds.app', timeout=60)
        con.request(
...
def transaction_reward(company_id: str, api_key: str, points: float, participant_id: str or int,
                       comment: str=None,
                       silent: bool=False):
    auth = partner_auth(company_id, api_key)
...
def customers_list(company_id: str or int, api_key: str, max:int=10, offset: int =0):
    auth = partner_auth(company_id, api_key)
    try:
...
def customer_find(company_id: str or int, api_key: str, code: str or int=None, uid: str=None, phone: str=None,
...
def customer_get(company_id: str or int, api_key: str, participant_id: str or int):
    auth = partner_auth(company_id, api_key)
    try:
        con = HTTPSConnection('api.uds.app')
        con.request(
...
def items_list(company_id: str or int, api_key: str, max: int=10, offset: int=0, node_id: int=None):
    auth = partner_auth(company_id, api_key)
    try:
        params = "max=" + str_parse(max) + "&offset=" + str_parse(offset) + \
...
def create_category(company_id: str or int, api_key: str, name: str, node_id: int=None, external_id: str=None):
    auth = partner_auth(company_id, api_key)
    try:
        con = HTTPSConnection('api.uds.app', timeout=60)
        con.request(
...
def create_item(company_id: str or int, api_key: str, name: str, price: float, node_id: int=None,
                external_id: str=None, description: str=None, in_stock: int=None,
...
def create_varying_item(company_id: str or int, api_key: str, name: str, price: float=None, node_id: int=None,
                        external_id: str=None, description: str=None, variants: list=None,
                        skip_loyalty: bool =None,
                        hidden: bool =False):
    auth = partner_auth(company_id, api_key)
...
def update_category(company_id: str or int, api_key: str, category_id: int, name: str, node_id: int=None,
...
def update_item(company_id: str or int, api_key: str, item_id: int, name: str, price: float, node_id: int=None,
                external_id: str=None, description: str =None, in_stock: int=None,
                offer_price: float=None,
                skip_loyalty: bool=None,
                hidden: bool=False):
...
def update_varying_item(company_id: str or int, api_key: str, item_id: int, name: str, price: float=None,
                        node_id: int =None,
                        external_id: str =None, description: str =None, variants: list =None,
                        skip_loyalty=None,
                        hidden=False):
...
def delete_item_or_category(company_id: str or int , api_key: str, goods_id: int):
    auth = partner_auth(company_id, api_key)
    try:
        con = HTTPSConnection('api.uds.app', timeout=60)
        con.request(
...
def update_order(company_id: str or int, api_key: str, order_id: int, items: list=None, new_items: list=None,
...
def generate_complete_order_code(company_id: str or int, api_key: str, order_id: int):
    auth = partner_auth(company_id, api_key)
    try:
        con = HTTPSConnection('api.uds.app', timeout=60)
        con.request(
...
def voucher_create(company_id: str or int, api_key: str, total: float, nonce: str=None,
                   external_id: str=None, name: str=None, number: str=None,
