...
class Config():
    ...
    datadict_info = { # stores the structure of the config (consists of a header and its containing fields; the field also stores its type)
        'info': {'name': {"data": '' , "type": 'str'},
