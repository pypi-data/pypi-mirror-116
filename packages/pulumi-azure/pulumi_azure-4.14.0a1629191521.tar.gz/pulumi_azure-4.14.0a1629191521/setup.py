...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.14.0-alpha.1629191521+3963f8bd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.14.0-alpha.1629191521+3963f8bd`
                """)
            else:
                raise
