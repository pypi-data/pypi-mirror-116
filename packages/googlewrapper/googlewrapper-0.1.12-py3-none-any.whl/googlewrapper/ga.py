...
class GoogleAnalytics:
    ...
    def set_dimensions(self, d) -> None:
        """
        Parameters
    ...
    def set_dimension_filters(self, f) -> None:
        """
        Parameters
    ...
    def set_dimension_filter_group(self,enum:str):
        """
    ...
    def set_metric_filter_group(self,enum:str):
        """
        By default the grouping for multiple filters is "OR",
        Using this method allows to change that to "AND"
        """
    ...
    def set_start_date(self, d) -> None:
        """
        Parameters
