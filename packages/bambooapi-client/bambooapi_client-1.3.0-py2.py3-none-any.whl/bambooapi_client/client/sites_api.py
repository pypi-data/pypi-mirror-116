...
class SitesApi(object):
    ...
    def list_devices(self, site_id: int, device_type: str='hvac'):
    ...
    def update_measurements(
        ...
        return self._api_instance.insert_device_measurements(site_id,
                                                            device_name,
                                                            _DPs)
    ...
    def read_forecasts(
        ...
        if start and stop:
            _meas = self._api_instance.read_device_forecasts(site_id, device_name,
                                                            horizon=horizon,
                                                            period='CustomRange',
                                                            period_start=start,
                                                            period_stop=stop,
    ...
    def update_forecasts(
        ...
        _DPs = data_frame.reset_index().to_dict(orient='records')
        return self._api_instance.insert_device_forecasts(site_id,
                                                         device_name,
                                                         _DPs,
                                                         horizon=horizon)
    ...
    def read_activations(
        ...
        try:
            return self._api_instance.read_device_activations(site_id, device_name,
                                                             _check_return_type=False)
        except NotFoundException:
            return None
