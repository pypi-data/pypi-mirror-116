...
# -*- coding: utf-8 -*-
#
# ipylife documentation build configuration file
#
...
project = 'ipylife'
copyright = '2021, Afshin T. Darian'
...
_version_py = os.path.join(repo, 'ipylife', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipylife.tex', 'ipylife Documentation',
     'Afshin T. Darian', 'manual'),
]
