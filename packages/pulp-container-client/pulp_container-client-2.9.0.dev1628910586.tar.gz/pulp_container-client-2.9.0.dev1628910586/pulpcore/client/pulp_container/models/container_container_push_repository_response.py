...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, description=None, name=None, pulp_href=None, retained_versions=None, latest_version_href=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
