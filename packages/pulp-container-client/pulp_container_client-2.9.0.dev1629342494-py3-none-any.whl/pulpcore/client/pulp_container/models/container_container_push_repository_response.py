...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, retained_versions=None, versions_href=None, pulp_labels=None, description=None, name=None, latest_version_href=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
