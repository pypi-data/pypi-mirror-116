...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, latest_version_href=None, versions_href=None, name=None, pulp_href=None, retained_versions=None, description=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
