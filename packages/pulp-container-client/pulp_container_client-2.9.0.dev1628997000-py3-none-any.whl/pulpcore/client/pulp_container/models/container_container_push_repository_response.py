...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_labels=None, pulp_created=None, name=None, description=None, latest_version_href=None, retained_versions=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
