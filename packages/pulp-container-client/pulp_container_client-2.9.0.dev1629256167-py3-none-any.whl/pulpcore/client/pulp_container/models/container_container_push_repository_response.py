...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, pulp_created=None, pulp_href=None, versions_href=None, pulp_labels=None, retained_versions=None, name=None, description=None, local_vars_configuration=None):  # noqa: E501
