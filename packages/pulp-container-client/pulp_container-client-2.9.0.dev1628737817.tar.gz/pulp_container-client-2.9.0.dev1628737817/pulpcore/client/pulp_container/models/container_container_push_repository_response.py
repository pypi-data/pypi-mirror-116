...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, description=None, pulp_labels=None, latest_version_href=None, retained_versions=None, name=None, versions_href=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
