...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retained_versions=None, versions_href=None, pulp_labels=None, description=None, pulp_href=None, name=None, pulp_created=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
