...
from hbshare.cta_factor.factor_algo import carry, tsmom, tsrev, xsmom, xsrev, tswr, xswr, mr, mrchg, tsmr, tsbasismom
...
factor_compute(
    window_days_list=window_days_list, data=data, factor_func=tsbasismom, liq_days=liq_d, data_raw=data_contracts
)
