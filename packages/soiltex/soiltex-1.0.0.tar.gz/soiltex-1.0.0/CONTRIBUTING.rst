...
**soiltex** could always use more documentation, whether as
part of the official **soiltex** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `soiltex` for local
development.

1. Fork the `soiltex` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/soiltex.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd soiltex
    (dvlpt) soiltex$ flake8
    (dvlpt) soiltex$ pytest
...
.. _issues: https://gitlab.com/revesansparole/soiltex/issues
