...
class HostItem:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.hostAddr = nebula2_fork.common.ttypes.HostAddr()
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.host = nebula2_fork.common.ttypes.HostAddr()
        ...
        if ftype == TType.LIST:
          ...
          if _size222 >= 0:
            for _i226 in six.moves.range(_size222):
              _elem227 = nebula2_fork.common.ttypes.HostAddr()
              _elem227.read(iprot)
              self.peers.append(_elem227)
          else: 
            while iprot.peekList():
              _elem228 = nebula2_fork.common.ttypes.HostAddr()
              _elem228.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          if _size229 >= 0:
            for _i233 in six.moves.range(_size229):
              _elem234 = nebula2_fork.common.ttypes.HostAddr()
              _elem234.read(iprot)
              self.losts.append(_elem234)
          else: 
            while iprot.peekList():
              _elem235 = nebula2_fork.common.ttypes.HostAddr()
              _elem235.read(iprot)
            ...
            for _i258 in six.moves.range(_size254):
              ...
              if _size261 >= 0:
                for _i265 in six.moves.range(_size261):
                  _elem266 = nebula2_fork.common.ttypes.HostAddr()
                  _elem266.read(iprot)
                  _val260.append(_elem266)
              else: 
                while iprot.peekList():
                  _elem267 = nebula2_fork.common.ttypes.HostAddr()
                  _elem267.read(iprot)
            ...
            while iprot.peekMap():
              ...
              if _size270 >= 0:
                for _i274 in six.moves.range(_size270):
                  _elem275 = nebula2_fork.common.ttypes.HostAddr()
                  _elem275.read(iprot)
                  _val269.append(_elem275)
              else: 
                while iprot.peekList():
                  _elem276 = nebula2_fork.common.ttypes.HostAddr()
                  _elem276.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          if _size291 >= 0:
            for _i295 in six.moves.range(_size291):
              _elem296 = nebula2_fork.common.ttypes.KeyValue()
              _elem296.read(iprot)
              self.pairs.append(_elem296)
          else: 
            while iprot.peekList():
              _elem297 = nebula2_fork.common.ttypes.KeyValue()
              _elem297.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          if _size400 >= 0:
            for _i404 in six.moves.range(_size400):
              _elem405 = nebula2_fork.common.ttypes.HostAddr()
              _elem405.read(iprot)
              self.host_del.append(_elem405)
          else: 
            while iprot.peekList():
              _elem406 = nebula2_fork.common.ttypes.HostAddr()
              _elem406.read(iprot)
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.value = nebula2_fork.common.ttypes.Value()
        ...
        if ftype == TType.LIST:
          ...
          if _size456 >= 0:
            for _i460 in six.moves.range(_size456):
              _elem461 = nebula2_fork.common.ttypes.HostAddr()
              _elem461.read(iprot)
              self.nodes.append(_elem461)
          else: 
            while iprot.peekList():
              _elem462 = nebula2_fork.common.ttypes.HostAddr()
              _elem462.read(iprot)
...
class AddHostIntoZoneReq:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.node = nebula2_fork.common.ttypes.HostAddr()
        ...
        if ftype == TType.LIST:
          ...
          if _size464 >= 0:
            for _i468 in six.moves.range(_size464):
              _elem469 = nebula2_fork.common.ttypes.HostAddr()
              _elem469.read(iprot)
              self.hosts.append(_elem469)
          else: 
            while iprot.peekList():
              _elem470 = nebula2_fork.common.ttypes.HostAddr()
              _elem470.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          if _size472 >= 0:
            for _i476 in six.moves.range(_size472):
              _elem477 = nebula2_fork.common.ttypes.HostAddr()
              _elem477.read(iprot)
              self.nodes.append(_elem477)
          else: 
            while iprot.peekList():
              _elem478 = nebula2_fork.common.ttypes.HostAddr()
              _elem478.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          if _size520 >= 0:
            for _i524 in six.moves.range(_size520):
              _elem525 = nebula2_fork.common.ttypes.HostAddr()
              _elem525.read(iprot)
              self.hosts.append(_elem525)
          else: 
            while iprot.peekList():
              _elem526 = nebula2_fork.common.ttypes.HostAddr()
              _elem526.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          if _size536 >= 0:
            for _i540 in six.moves.range(_size536):
              _elem541 = nebula2_fork.common.ttypes.CheckpointInfo()
              _elem541.read(iprot)
              self.info.append(_elem541)
          else: 
            while iprot.peekList():
              _elem542 = nebula2_fork.common.ttypes.CheckpointInfo()
              _elem542.read(iprot)
...
class HostPair:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.from_host = nebula2_fork.common.ttypes.HostAddr()
          self.from_host.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRUCT:
          self.to_host = nebula2_fork.common.ttypes.HostAddr()
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.graph_addr = nebula2_fork.common.ttypes.HostAddr()
        ...
        if ftype == TType.MAP:
          ...
          if _size630 >= 0:
            for _i634 in six.moves.range(_size630):
              ...
              _val636 = nebula2_fork.common.ttypes.Value()
              _val636.read(iprot)
              self.configs[_key635] = _val636
          else: 
            while iprot.peekMap():
              _key637 = iprot.readString()
              _val638 = nebula2_fork.common.ttypes.Value()
              _val638.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          if _size725 >= 0:
            for _i729 in six.moves.range(_size725):
              _elem730 = nebula2_fork.common.ttypes.HostAddr()
              _elem730.read(iprot)
              self.meta_servers.append(_elem730)
          else: 
            while iprot.peekList():
              _elem731 = nebula2_fork.common.ttypes.HostAddr()
              _elem731.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          if _size732 >= 0:
            for _i736 in six.moves.range(_size732):
              _elem737 = nebula2_fork.common.ttypes.NodeInfo()
              _elem737.read(iprot)
              self.storage_servers.append(_elem737)
          else: 
            while iprot.peekList():
              _elem738 = nebula2_fork.common.ttypes.NodeInfo()
              _elem738.read(iprot)
...
HostItem.thrift_spec = (
  None, # 0
  (1, TType.STRUCT, 'hostAddr', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 1
...
ExecResp.thrift_spec = (
  None, # 0
  (1, TType.I32, 'code', nebula2_fork.common.ttypes.ErrorCode, None, 2, ), # 1
  (2, TType.STRUCT, 'id', [ID, ID.thrift_spec, True], None, 2, ), # 2
  (3, TType.STRUCT, 'leader', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 3
)
...
TaskDesc.thrift_spec = (
  ...
  (2, TType.STRUCT, 'host', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 2
...
AdminJobResp.thrift_spec = (
  None, # 0
  (1, TType.I32, 'code', nebula2_fork.common.ttypes.ErrorCode, None, 2, ), # 1
  (2, TType.STRUCT, 'leader', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 2
...
PartItem.thrift_spec = (
  ...
  (2, TType.STRUCT, 'leader', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 1, ), # 2
  (3, TType.LIST, 'peers', (TType.STRUCT,[nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False]), None, 0, ), # 3
  (4, TType.LIST, 'losts', (TType.STRUCT,[nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False]), None, 0, ), # 4
)
...
GetPartsAllocResp.thrift_spec = (
  ...
  (1, TType.I32, 'code', nebula2_fork.common.ttypes.ErrorCode, None, 2, ), # 1
  (2, TType.STRUCT, 'leader', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 2
  (3, TType.MAP, 'parts', (TType.I32,None,TType.LIST,(TType.STRUCT,[nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False])), None, 2, ), # 3
...
MultiPutReq.thrift_spec = (
  ...
  (2, TType.LIST, 'pairs', (TType.STRUCT,[nebula2_fork.common.ttypes.KeyValue, nebula2_fork.common.ttypes.KeyValue.thrift_spec, False]), None, 2, ), # 2
)
...
BalanceReq.thrift_spec = (
  ...
  (3, TType.LIST, 'host_del', (TType.STRUCT,[nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False]), None, 1, ), # 3
...
ConfigItem.thrift_spec = (
  ...
  (4, TType.STRUCT, 'value', [nebula2_fork.common.ttypes.Value, nebula2_fork.common.ttypes.Value.thrift_spec, True], None, 2, ), # 4
)
...
AddZoneReq.thrift_spec = (
  ...
  (2, TType.LIST, 'nodes', (TType.STRUCT,[nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False]), None, 2, ), # 2
)
...
AddHostIntoZoneReq.thrift_spec = (
  None, # 0
  (1, TType.STRUCT, 'node', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 1
...
GetZoneResp.thrift_spec = (
  ...
  (1, TType.I32, 'code', nebula2_fork.common.ttypes.ErrorCode, None, 2, ), # 1
  (2, TType.STRUCT, 'leader', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 2
  (3, TType.LIST, 'hosts', (TType.STRUCT,[nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False]), None, 2, ), # 3
)
...
BackupInfo.thrift_spec = (
  None, # 0
  (1, TType.STRUCT, 'host', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 1
...
HostPair.thrift_spec = (
  None, # 0
  (1, TType.STRUCT, 'from_host', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 1
  (2, TType.STRUCT, 'to_host', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 2
)
...
FTClient.thrift_spec = (
  None, # 0
  (1, TType.STRUCT, 'host', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 0, ), # 1
...
QueryDesc.thrift_spec = (
  ...
  (5, TType.STRUCT, 'graph_addr', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 5
)
...
Session.thrift_spec = (
  ...
  (6, TType.STRUCT, 'graph_addr', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 6
  (7, TType.I32, 'timezone', None, None, 2, ), # 7
  (8, TType.STRING, 'client_ip', False, None, 2, ), # 8
  (9, TType.MAP, 'configs', (TType.STRING,False,TType.STRUCT,[nebula2_fork.common.ttypes.Value, nebula2_fork.common.ttypes.Value.thrift_spec, True]), None, 2, ), # 9
...
CreateSessionReq.thrift_spec = (
  ...
  (2, TType.STRUCT, 'graph_addr', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 2
...
ListClusterInfoResp.thrift_spec = (
  ...
  (1, TType.I32, 'code', nebula2_fork.common.ttypes.ErrorCode, None, 2, ), # 1
  (2, TType.STRUCT, 'leader', [nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False], None, 2, ), # 2
  (3, TType.LIST, 'meta_servers', (TType.STRUCT,[nebula2_fork.common.ttypes.HostAddr, nebula2_fork.common.ttypes.HostAddr.thrift_spec, False]), None, 2, ), # 3
  (4, TType.LIST, 'storage_servers', (TType.STRUCT,[nebula2_fork.common.ttypes.NodeInfo, nebula2_fork.common.ttypes.NodeInfo.thrift_spec, False]), None, 2, ), # 4
)
