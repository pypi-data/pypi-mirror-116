...
from eagers.update.dispatch_record import  record_initial_conditions

def initialize_observer(gen,subnet,fluid_loop,all_data_nodes,names, zones, pl,test_data,building_observer,ic,stor_perc,date,data_t0,project_name):
    ...
    record_initial_conditions(data_t0, dispatch, subnet, observer, project_name)
    return observer
