...
class Node(t.Generic[_T]):
    ...
    def _create_inputs(self) -> list[InputSlot]:
...
def do_types_match(left_type, right_type) -> bool:
    pass
...
class Edge:
    ...
    def validate(self) -> None:
        if not do_types_match(self.start.data_type, self.end.data_type):
            raise EdgeInvalid("Incompatible types")
