...
class BaseClient:
    def __init__(
        self, base_url, version_str, owner=None, token=None, spell_admin_auth_token=None, adapter=None
    ):
        self.base_url = base_url
        self.version_str = version_str
        self.owner = owner
        self.token = token
        self.spell_admin_auth_token = spell_admin_auth_token
    ...
    def request(
        ...
        if self.spell_admin_auth_token:
            kwargs["cookies"] = {"SpellAdminAuthorization": self.spell_admin_auth_token}
        if timeout:
