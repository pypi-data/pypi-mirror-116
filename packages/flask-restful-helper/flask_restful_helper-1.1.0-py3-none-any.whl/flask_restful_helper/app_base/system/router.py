...
api.add_resource(api_view.User, '/locales', endpoint='locales', methods=['GET', 'POST'])
api.add_resource(api_view.User, '/locales/<pk>', endpoint='locales_pk', methods=['GET', 'PUT', 'PATCH', 'DELETE'])
