...
class User(db.Model):
    ...
    locale_id = db.Column(db.ForeignKey('system_locale.id'), nullable=True)
...
class Locale(db.Model):
    ...
    zh_tw = db.Column(db.String(100), nullable=False, default='')
    zh_cn = db.Column(db.String(100), nullable=False, default='')
    en_us = db.Column(db.String(100), nullable=False, default='')
