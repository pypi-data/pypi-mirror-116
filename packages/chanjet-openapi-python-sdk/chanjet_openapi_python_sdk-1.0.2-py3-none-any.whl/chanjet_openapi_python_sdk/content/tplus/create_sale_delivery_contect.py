...
# 创建销货单的请求体实体
class CreateSaleDeliveryContent(ChanjetContent):

    def __init__(self, voucher_date, external_code, customer_code, invoice_type_code, address, link_man, contact_phone,
                 header_dynamic_property_keys, header_dynamic_property_values):
        self.dto = self.Dto(voucher_date, external_code, customer_code, invoice_type_code, address, link_man, contact_phone,
                            header_dynamic_property_keys, header_dynamic_property_values)
    ...
    class Dto:
        ...
        def __init__(self, voucher_date, external_code, customer_code, invoice_type_code, address, link_man, contact_phone,
            ...
            :param invoice_type_code: 票据类型编码
            :type invoice_type_code: str
            :param address: 送货地址
            :type address: str
            :param link_man: 联系人
            :type link_man: str
            ...
            self.InvoiceType = self.InvoiceTypeInfo(invoice_type_code)
...
# 销货单明细实体
class SaleDeliveryDetail:

    def __init__(self, inventory_code, unit_name, quantity, orig_price, orig_tax_amount, detail_dynamic_property_keys, detail_dynamic_property_values):
        """
        销货单明细实体初始化方法
        ...
        :type quantity: float
        :param orig_price: 报价
        :type orig_price: float
        :param orig_tax_amount: 原币含税金额
        :type orig_tax_amount: float
        ...
        self.OrigPrice = orig_price
        self.OrigTaxAmount = orig_tax_amount
