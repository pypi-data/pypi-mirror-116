...
CLASSIFICATION_RANGES = {
    ...
    PRECISION_CLASSWISE: (0.0, 1.0),
    RECALL_CLASSWISE: (0.0, 1.0),
    F1_CLASSWISE: (0.0, 1.0),
    IOU_CLASSWISE: (0.0, 1.0),
    AUC_CLASSWISE: (0.0, 1.0),
    AVERAGE_PRECISION_CLASSWISE: (0.0, 1.0),
...
CLASSIFICATION_OBJECTIVES = {
    ...
    AUC_CLASSWISE: MAXIMIZE,
    IOU_CLASSWISE: MAXIMIZE,
    AVERAGE_PRECISION_CLASSWISE: MAXIMIZE,
    PRECISION_CLASSWISE: MAXIMIZE,
    RECALL_CLASSWISE: MAXIMIZE,
    F1_CLASSWISE: MAXIMIZE,
