...
class Product(BaseNModel, DictModel, FullTextSearchable):
    ...
    dict_properties = ['product_sku', 'product_name', 'category_code', 'product_desc']
    ...
    @staticmethod
    def create(product_sku, product_name, category_code, merchant_acct, product_desc=None, created_by=None):
        created_by_key = None
        if created_by:
            created_by_key = created_by.create_ndb_key()
    ...
    @staticmethod
    def update(product, product_sku, product_name, category_code, product_desc=None, updated_by=None):
        modified_by_key = None
        if updated_by:
