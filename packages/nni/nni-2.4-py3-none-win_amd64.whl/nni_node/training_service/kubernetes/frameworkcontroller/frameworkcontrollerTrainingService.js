            ...
            case trialConfigMetadataKey_1.TrialConfigMetadataKey.FRAMEWORKCONTROLLER_CLUSTER_CONFIG: {
                ...
                if (this.fcClusterConfig.storageType === 'azureStorage') {
                    ...
                    if (azureFrameworkControllerClusterConfig.configPath !== undefined) {
                        this.fcTemplate = yaml.safeLoad(fs.readFileSync(azureFrameworkControllerClusterConfig.configPath, 'utf8'));
                    }
                    ...
                    if (nfsFrameworkControllerClusterConfig.configPath !== undefined) {
                        this.fcTemplate = yaml.safeLoad(fs.readFileSync(nfsFrameworkControllerClusterConfig.configPath, 'utf8'));
                    }
                    ...
                    const pvcFrameworkControllerClusterConfig = this.fcClusterConfig;
                    this.fcTemplate = yaml.safeLoad(fs.readFileSync(pvcFrameworkControllerClusterConfig.configPath, 'utf8'));
                    await this.createPVCStorage(pvcFrameworkControllerClusterConfig.pvc.path);
