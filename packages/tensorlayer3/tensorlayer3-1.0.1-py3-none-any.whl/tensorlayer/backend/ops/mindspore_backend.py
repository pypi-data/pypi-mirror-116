...
from mindspore.common.initializer import (
    initializer, Constant, Normal, TruncatedNormal, Initializer, _assignment, _calculate_in_and_out, One, Zero, _calculate_fan_in_and_fan_out
)
...
class XavierUniform(Initializer):
    ...
    def _initialize(self, arr):
        n_in, n_out = _calculate_fan_in_and_fan_out(arr)
...
def xaiver_uniform(shape, dtype, seed=None):
...
def xaiver_normal(shape, dtype, seed=None):
