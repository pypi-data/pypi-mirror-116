; RUN: llvm-mutate --not_use_result -f %s -p U1.OP0,C1 -p U1.OP0,A4 | filecheck %s
; CHECK:        opreplaced U1.OP0,C1
; CHECK:        oprepl failed. dest operand U1.OP0 is a function argument with immarg attribute
