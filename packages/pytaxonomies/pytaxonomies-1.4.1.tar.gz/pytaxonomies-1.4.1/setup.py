...
{'': ['*'],
 'pytaxonomies': ['data/misp-taxonomies/*',
                  'data/misp-taxonomies/.github/workflows/*',
                  ...
                  'data/misp-taxonomies/thales_group/*',
                  'data/misp-taxonomies/threatmatch/*',
