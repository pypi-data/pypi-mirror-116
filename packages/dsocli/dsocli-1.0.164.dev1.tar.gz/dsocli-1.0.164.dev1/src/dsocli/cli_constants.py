CLI_COMMANDS_HELP = {
    ...
    'network': {
        'get_subnet_layout': """Get the subnet plan layout of DSO application.\n
                """,
    }
}
...
CLI_COMMANDS_SHORT_HELP = {
    ...
    'network': {
        'get_subnet_layout': "Get subnet plan layout of DSO application.",
    }
...
CLI_PARAMETERS_HELP = {
    ...
    'network': {
        'subnet_plan_layout_mode': "Select the subnet plan layout mode.",
