...
class DataSet(
    ...
    def drop_location(self) -> "DataSetLocation":
        '''
        :stability: experimental
        '''
        return typing.cast("DataSetLocation", jsii.get(self, "dropLocation"))
...
class IPipelineProperties(typing_extensions.Protocol):
    ...
    @data_set_drop_location.setter
    def data_set_drop_location(self, value: DataSetLocation) -> None:
        ...
...
class _IPipelinePropertiesProxy:
    ...
    @data_set_drop_location.setter
    def data_set_drop_location(self, value: DataSetLocation) -> None:
        jsii.set(self, "dataSetDropLocation", value)
...
class RegisteredDataSetProperties:
    ...
    def data_set(self) -> DataSet:
        ...
        assert result is not None, "Required property 'data_set' is missing"
