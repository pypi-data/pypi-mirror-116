...
class DataJobDeployment(object):
    ...
    def __init__(self, vdk_version=None, job_version=None, mode=None, id=None, enabled=True, deployed_by=None, deployed_date=None, schedule=None, resources=None, local_vars_configuration=None):  # noqa: E501
