...
class DataJobsApi(object):
    ...
    def data_job_create(self, team_name, data_job, **kwargs):  # noqa: E501
        ...
        <i>(Introduced in v1.0)</i> | Creates a new Data Job.<br> The name of the Data job should comply to the following naming convention:<br> <li>should start with a letter <li>less than 50 characters <li>more than 5 characters <li>contain only lowercase alphanumeric symbols and dash [a-z0-9\\-] <br><br> When succesfully created clients can download keytab associated with the Data Job to run it locally.<br> To deploy so that it can be executed reguarly in runtime use /data-jobs/for-team/{team_name}/jobs/{job_name}/deployments API.   # noqa: E501
    ...
    def data_job_delete(self, team_name, job_name, **kwargs):  # noqa: E501
        """Delete data Data Job | (Stable)  # noqa: E501

        <i>(Introduced in v1.0)</i> | Delete data Data Job including all its state (properties) and any deployments. Currently executing Data Jobs will be left to finish.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def data_job_keytab_download(self, team_name, job_name, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str team_name: Team Name (required)
        :param str job_name: DataJob Name. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def jobs_list(self, team_name, **kwargs):  # noqa: E501
        ...
        :param int page_size: The number of items in page.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
