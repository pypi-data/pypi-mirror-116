        ...
        if include_optional :
            return DataJobDeploymentStatus(
                ...
                contacts = taurus_datajob_api.models.data_job_contacts.DataJobContacts(
                    notified_on_job_failure_user_error = ["starshot_ops@vmware.com","auserov@vmware.com"], 
                    notified_on_job_failure_platform_error = ["starshot_ops@vmware.com","auserov@vmware.com"], 
                    notified_on_job_success = ["auserov@vmware.com"], 
                    notified_on_job_deploy = ["auserov@vmware.com"], ), 
