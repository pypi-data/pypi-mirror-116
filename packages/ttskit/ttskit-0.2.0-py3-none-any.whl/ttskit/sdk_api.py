...
_mellotron_hparams_path = os.path.join(_home_dir, 'resource', 'model', 'mellotron.kuangdd-rtvc.hparams.json')
...
def download_data(fpath, force=False):
    ...
    if not force and os.path.isfile(fpath) and os.path.getsize(fpath) > 1024:
        return True
