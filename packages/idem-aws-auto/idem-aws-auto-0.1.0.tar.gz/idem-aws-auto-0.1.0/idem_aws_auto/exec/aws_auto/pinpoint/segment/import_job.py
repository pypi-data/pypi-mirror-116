    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.pinpoint.segment.import_job.get_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.pinpoint.segment.import_job.get_all application_id=value, segment_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="pinpoint",
        operation="get_segment_import_jobs",
        op_kwargs={
