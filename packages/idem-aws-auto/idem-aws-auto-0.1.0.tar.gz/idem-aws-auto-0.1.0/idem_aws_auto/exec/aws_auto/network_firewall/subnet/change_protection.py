    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.network_firewall.subnet.change_protection.update(
                ctx, subnet_change_protection=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.network_firewall.subnet.change_protection.update subnet_change_protection=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="network-firewall",
        operation="update_subnet_change_protection",
        op_kwargs={
