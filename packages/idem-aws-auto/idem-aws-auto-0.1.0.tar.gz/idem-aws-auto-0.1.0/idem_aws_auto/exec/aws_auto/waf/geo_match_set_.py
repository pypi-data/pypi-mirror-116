    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.geo_match_set_.create(ctx, name=value, change_token=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf.geo_match_set.create name=value, change_token=value
    """
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.geo_match_set_.delete(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.waf.geo_match_set.delete geo_match_set_id=value, change_token=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.geo_match_set_.get(ctx, geo_match_set_id=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf.geo_match_set.get geo_match_set_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.geo_match_set_.list_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf.geo_match_set.list_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.geo_match_set_.update(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.waf.geo_match_set.update geo_match_set_id=value, change_token=value, updates=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
