    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.rule.init.create(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.waf.rule.init.create name=value, metric_name=value, change_token=value
    """
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.rule.init.delete(ctx, rule_id=value, change_token=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf.rule.init.delete rule_id=value, change_token=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.rule.init.get(ctx, rule_id=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf.rule.init.get rule_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx, service_name="waf", operation="get_rule", op_kwargs={"RuleId": rule_id}
    )
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.rule.init.list_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf.rule.init.list_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.rule.init.update(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.waf.rule.init.update rule_id=value, change_token=value, updates=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
