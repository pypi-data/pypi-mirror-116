...
async def list_all(
    ...
    **Autogenerated function**
    ...
    Args:
        open_id_connect_provider_arn(str): The ARN of the OpenID Connect (OIDC) identity provider whose tags you want to see. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.iam.open_id_connect_provider.tag.list_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.iam.open_id_connect_provider.tag.list_all open_id_connect_provider_arn=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="iam",
        operation="list_open_id_connect_provider_tags",
        op_kwargs={
