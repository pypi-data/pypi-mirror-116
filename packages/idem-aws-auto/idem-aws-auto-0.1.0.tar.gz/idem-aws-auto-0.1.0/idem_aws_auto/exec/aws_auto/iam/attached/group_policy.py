...
async def list_all(
    ...
    **Autogenerated function**
    ...
    Args:
        group_name(str): The name (friendly name, not ARN) of the group to list attached policies for. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.iam.attached.group_policy.list_all(ctx, group_name=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.iam.attached.group_policy.list_all group_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="iam",
        operation="list_attached_group_policies",
        op_kwargs={
