...
async def list_(
    ...
    **Autogenerated function**
    ...
    Args:
        user_name(str): The name of the user to list groups for. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.iam.group.for_user.list(ctx, user_name=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.iam.group.for_user.list user_name=value
    """
