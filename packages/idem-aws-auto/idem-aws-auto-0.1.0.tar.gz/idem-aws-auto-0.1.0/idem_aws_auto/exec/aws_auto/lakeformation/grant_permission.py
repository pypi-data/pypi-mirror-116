...
async def batch(hub, ctx, entries: List, catalog_id: str = None) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        entries(List): A list of up to 20 entries for resource permissions to be granted by batch operation to the principal.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.lakeformation.grant_permission.batch(ctx, entries=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.lakeformation.grant_permission.batch entries=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="lakeformation",
        operation="batch_grant_permissions",
