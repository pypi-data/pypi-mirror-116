    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.servicecatalog_appregistry.associated.attribute_group.list_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.servicecatalog_appregistry.associated.attribute_group.list_all application=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="servicecatalog-appregistry",
        operation="list_associated_attribute_groups",
        op_kwargs={
