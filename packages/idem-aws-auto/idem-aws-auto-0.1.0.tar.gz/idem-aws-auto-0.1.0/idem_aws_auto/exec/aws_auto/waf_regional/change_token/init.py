    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf_regional.change_token.init.get(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf_regional.change_token.init.get
    """
    return await hub.tool.aws.client.exec(
        ctx, service_name="waf-regional", operation="get_change_token", op_kwargs={}
    )
