    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehend.key_phrase.detection_job.describe(ctx, job_id=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.comprehend.key_phrase.detection_job.describe job_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehend",
        operation="describe_key_phrases_detection_job",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehend.key_phrase.detection_job.list_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.comprehend.key_phrase.detection_job.list_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehend",
        operation="list_key_phrases_detection_jobs",
        op_kwargs={
            "Filter": filter_,
...
async def start(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        vpc_config(Dict, optional):  Configuration parameters for an optional private Virtual Private Cloud (VPC) containing the resources you are using for your key phrases detection job. For more information, see Amazon VPC. . Defaults to None.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehend.key_phrase.detection_job.start(
                ctx,
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.comprehend.key_phrase.detection_job.start input_data_config=value, output_data_config=value, data_access_role_arn=value, language_code=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehend",
        operation="start_key_phrases_detection_job",
        op_kwargs={
...
async def stop(hub, ctx, job_id: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        job_id(str): The identifier of the key phrases detection job to stop.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehend.key_phrase.detection_job.stop(ctx, job_id=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.comprehend.key_phrase.detection_job.stop job_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehend",
        operation="stop_key_phrases_detection_job",
        op_kwargs={"JobId": job_id},
    )
