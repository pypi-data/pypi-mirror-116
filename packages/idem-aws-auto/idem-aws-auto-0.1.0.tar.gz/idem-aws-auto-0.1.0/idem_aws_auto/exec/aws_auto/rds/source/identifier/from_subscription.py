...
async def remove(hub, ctx, subscription_name: str, source_identifier: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        subscription_name(str): The name of the RDS event notification subscription you want to remove a source identifier from.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.rds.source.identifier.from_subscription.remove(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.rds.source.identifier.from_subscription.remove subscription_name=value, source_identifier=value
    """
