...
async def list_all(
    hub, ctx, data_set_id: str, max_results: int = None, next_token: str = None
) -> Dict:
    r"""
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.dataexchange.data_set_.revision.list_all(ctx, data_set_id=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.dataexchange.data_set_.revision.list_all data_set_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="dataexchange",
        operation="list_data_set_revisions",
        op_kwargs={
