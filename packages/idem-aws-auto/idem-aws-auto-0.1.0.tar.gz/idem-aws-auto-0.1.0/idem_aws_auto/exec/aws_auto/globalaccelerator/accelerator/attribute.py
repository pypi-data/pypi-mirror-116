...
async def describe_all(hub, ctx, accelerator_arn: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        accelerator_arn(str): The Amazon Resource Name (ARN) of the accelerator with the attributes that you want to describe.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.globalaccelerator.accelerator.attribute.describe_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.globalaccelerator.accelerator.attribute.describe_all accelerator_arn=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="globalaccelerator",
        operation="describe_accelerator_attributes",
...
async def update_multiple(
    ...
    **Autogenerated function**
    ...
    Args:
        accelerator_arn(str): The Amazon Resource Name (ARN) of the accelerator that you want to update.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.globalaccelerator.accelerator.attribute.update_multiple(
                ctx, accelerator_arn=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.globalaccelerator.accelerator.attribute.update_multiple accelerator_arn=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="globalaccelerator",
        operation="update_accelerator_attributes",
        op_kwargs={
