...
async def merge(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        commit_message(str, optional): The commit message for the merge. Defaults to None.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.codecommit.branch.by.squash.merge(
                ctx,
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.codecommit.branch.by.squash.merge repository_name=value, source_commit_specifier=value, destination_commit_specifier=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="codecommit",
        operation="merge_branches_by_squash",
        op_kwargs={
