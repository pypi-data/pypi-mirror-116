    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.compute_optimizer.ebs_volume_recommendation.export(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.compute_optimizer.ebs_volume_recommendation.export s3_destination_config=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="compute-optimizer",
        operation="export_ebs_volume_recommendations",
        op_kwargs={
...
async def get_all(
    ...
    **Autogenerated function**
    ...
    Args:
        volume_arns(List, optional): The Amazon Resource Name (ARN) of the volumes for which to return recommendations. Defaults to None.
        next_token(str, optional): The token to advance to the next page of volume recommendations. Defaults to None.
        max_results(int, optional): The maximum number of volume recommendations to return with a single request. To retrieve the remaining results, make another request with the returned NextToken value. Defaults to None.
        filters(List, optional): An array of objects that describe a filter that returns a more specific list of volume recommendations. Defaults to None.
        account_ids(List, optional): The ID of the AWS account for which to return volume recommendations. If your account is the management account of an organization, use this parameter to specify the member account for which you want to return volume recommendations. Only one account ID can be specified per request. Defaults to None.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.compute_optimizer.ebs_volume_recommendation.get_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.compute_optimizer.ebs_volume_recommendation.get_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="compute-optimizer",
