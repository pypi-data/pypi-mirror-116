    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.elasticache.stop_update_action.batch(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.elasticache.stop_update_action.batch service_update_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="elasticache",
        operation="batch_stop_update_action",
        op_kwargs={
