...
async def list_all(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        filters(List, optional): Filters to scope the results. The following filters are supported:    ProductSKU     Status     Fingerprint     IssuerName     Beneficiary   . Defaults to None.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.license_manager.received.license_.list_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.license_manager.received.license.list_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="license-manager",
        operation="list_received_licenses",
        op_kwargs={
