...
async def describe(hub, ctx, job_id: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        job_id(str): The identifier that Amazon Comprehend Medical generated for the job. The StartEntitiesDetectionV2Job operation returns this identifier in its response.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehendmedical.entity.detection_v2_job.describe(
                ctx, job_id=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.comprehendmedical.entity.detection_v2_job.describe job_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehendmedical",
        operation="describe_entities_detection_v2_job",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehendmedical.entity.detection_v2_job.list_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.comprehendmedical.entity.detection_v2_job.list_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehendmedical",
        operation="list_entities_detection_v2_jobs",
        op_kwargs={
            "Filter": filter_,
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehendmedical.entity.detection_v2_job.start(
                ctx,
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.comprehendmedical.entity.detection_v2_job.start input_data_config=value, output_data_config=value, data_access_role_arn=value, language_code=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehendmedical",
        operation="start_entities_detection_v2_job",
        op_kwargs={
...
async def stop(hub, ctx, job_id: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        job_id(str): The identifier of the medical entities job to stop.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehendmedical.entity.detection_v2_job.stop(
                ctx, job_id=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.comprehendmedical.entity.detection_v2_job.stop job_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehendmedical",
        operation="stop_entities_detection_v2_job",
        op_kwargs={"JobId": job_id},
    )
