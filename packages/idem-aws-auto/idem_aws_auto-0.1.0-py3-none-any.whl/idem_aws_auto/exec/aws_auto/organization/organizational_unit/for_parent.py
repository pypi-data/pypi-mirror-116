...
async def list_(
    ...
    **Autogenerated function**
    ...
    Args:
        parent_id(str): The unique identifier (ID) of the root or OU whose child OUs you want to list. The regex pattern for a parent ID string requires one of the following:    Root - A string that begins with "r-" followed by from 4 to 32 lowercase letters or digits.    Organizational unit (OU) - A string that begins with "ou-" followed by from 4 to 32 lowercase letters or digits (the ID of the root that the OU is in). This string is followed by a second "-" dash and from 8 to 32 additional lowercase letters or digits.  .
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.organization.organizational_unit.for_parent.list(
                ctx, parent_id=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.organization.organizational_unit.for_parent.list parent_id=value
    """
