    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.quicksight.theme.version.list_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.quicksight.theme.version.list_all aws_account_id=value, theme_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="quicksight",
        operation="list_theme_versions",
        op_kwargs={
