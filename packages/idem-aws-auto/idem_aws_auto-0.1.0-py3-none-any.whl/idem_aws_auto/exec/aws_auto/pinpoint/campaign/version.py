...
async def get(hub, ctx, application_id: str, campaign_id: str, version: str) -> Dict:
    r"""
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.pinpoint.campaign.version.get(
                ctx, application_id=value, campaign_id=value, version=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.pinpoint.campaign.version.get application_id=value, campaign_id=value, version=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="pinpoint",
        operation="get_campaign_version",
        op_kwargs={
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.pinpoint.campaign.version.get_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.pinpoint.campaign.version.get_all application_id=value, campaign_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="pinpoint",
        operation="get_campaign_versions",
        op_kwargs={
            "ApplicationId": application_id,
            "CampaignId": campaign_id,
            "PageSize": page_size,
