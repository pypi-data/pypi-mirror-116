...
async def create(hub, ctx, email_template_request: Dict, template_name: str) -> Dict:
    r"""
    **Autogenerated function**
    ...
    Args:
        email_template_request(Dict): Specifies the content and settings for a message template that can be used in messages that are sent through the email channel.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.pinpoint.email.template.create(
                ctx, email_template_request=value, template_name=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.pinpoint.email.template.create email_template_request=value, template_name=value
    """
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.pinpoint.email.template.delete(ctx, template_name=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.pinpoint.email.template.delete template_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="pinpoint",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.pinpoint.email.template.get(ctx, template_name=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.pinpoint.email.template.get template_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="pinpoint",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.pinpoint.email.template.update(
                ctx, email_template_request=value, template_name=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.pinpoint.email.template.update email_template_request=value, template_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="pinpoint",
