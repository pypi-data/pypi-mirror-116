    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.regex.pattern_set_.create(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.waf.regex.pattern_set.create name=value, change_token=value
    """
...
async def delete(hub, ctx, regex_pattern_set_id: str, change_token: str) -> Dict:
    r"""
    **Autogenerated function**
    ...
    Args:
        regex_pattern_set_id(str): The RegexPatternSetId of the RegexPatternSet that you want to delete. RegexPatternSetId is returned by CreateRegexPatternSet and by ListRegexPatternSets.
        change_token(str): The value returned by the most recent call to GetChangeToken.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.regex.pattern_set_.delete(
                ctx, regex_pattern_set_id=value, change_token=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.waf.regex.pattern_set.delete regex_pattern_set_id=value, change_token=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
...
async def get(hub, ctx, regex_pattern_set_id: str) -> Dict:
    r"""
    **Autogenerated function**
    ...
    Args:
        regex_pattern_set_id(str): The RegexPatternSetId of the RegexPatternSet that you want to get. RegexPatternSetId is returned by CreateRegexPatternSet and by ListRegexPatternSets.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.regex.pattern_set_.get(ctx, regex_pattern_set_id=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf.regex.pattern_set.get regex_pattern_set_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
        operation="get_regex_pattern_set",
        op_kwargs={"RegexPatternSetId": regex_pattern_set_id},
    )
...
async def list_all(hub, ctx, next_marker: str = None, limit: int = None) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        next_marker(str, optional): If you specify a value for Limit and you have more RegexPatternSet objects than the value of Limit, AWS WAF returns a NextMarker value in the response that allows you to list another group of RegexPatternSet objects. For the second and subsequent ListRegexPatternSets requests, specify the value of NextMarker from the previous response to get information about another batch of RegexPatternSet objects. Defaults to None.
        limit(int, optional): Specifies the number of RegexPatternSet objects that you want AWS WAF to return for this request. If you have more RegexPatternSet objects than the number you specify for Limit, the response includes a NextMarker value that you can use to get another batch of RegexPatternSet objects. Defaults to None.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.regex.pattern_set_.list_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.waf.regex.pattern_set.list_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
...
async def update(
    hub, ctx, regex_pattern_set_id: str, updates: List, change_token: str
) -> Dict:
    r"""
    **Autogenerated function**
    ...
    Args:
        regex_pattern_set_id(str): The RegexPatternSetId of the RegexPatternSet that you want to update. RegexPatternSetId is returned by CreateRegexPatternSet and by ListRegexPatternSets.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.waf.regex.pattern_set_.update(
                ctx, regex_pattern_set_id=value, updates=value, change_token=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.waf.regex.pattern_set.update regex_pattern_set_id=value, updates=value, change_token=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="waf",
