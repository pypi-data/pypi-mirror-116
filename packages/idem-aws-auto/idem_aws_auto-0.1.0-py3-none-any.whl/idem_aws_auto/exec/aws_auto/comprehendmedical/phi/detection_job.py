...
async def describe(hub, ctx, job_id: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        job_id(str): The identifier that Amazon Comprehend Medical generated for the job. The StartPHIDetectionJob operation returns this identifier in its response.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehendmedical.phi.detection_job.describe(ctx, job_id=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.comprehendmedical.phi.detection_job.describe job_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehendmedical",
        operation="describe_phi_detection_job",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehendmedical.phi.detection_job.list_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.comprehendmedical.phi.detection_job.list_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehendmedical",
        operation="list_phi_detection_jobs",
        op_kwargs={
            "Filter": filter_,
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehendmedical.phi.detection_job.start(
                ctx,
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.comprehendmedical.phi.detection_job.start input_data_config=value, output_data_config=value, data_access_role_arn=value, language_code=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehendmedical",
        operation="start_phi_detection_job",
        op_kwargs={
...
async def stop(hub, ctx, job_id: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        job_id(str): The identifier of the PHI detection job to stop.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.comprehendmedical.phi.detection_job.stop(ctx, job_id=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.comprehendmedical.phi.detection_job.stop job_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="comprehendmedical",
        operation="stop_phi_detection_job",
        op_kwargs={"JobId": job_id},
    )
