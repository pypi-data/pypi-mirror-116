    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.greengrassv2.effective_deployment.list_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.greengrassv2.effective_deployment.list_all core_device_thing_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="greengrassv2",
        operation="list_effective_deployments",
        op_kwargs={
