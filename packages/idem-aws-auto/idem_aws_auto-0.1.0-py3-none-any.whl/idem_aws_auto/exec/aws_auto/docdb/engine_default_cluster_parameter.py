...
async def describe_all(
    ...
    **Autogenerated function**
    ...
    Args:
        db_parameter_group_family(str): The name of the cluster parameter group family to return the engine parameter information for.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.docdb.engine_default_cluster_parameter.describe_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.docdb.engine_default_cluster_parameter.describe_all db_parameter_group_family=value
    """
