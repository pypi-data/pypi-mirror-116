    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.servicecatalog.constraint.for_portfolio.list(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.servicecatalog.constraint.for_portfolio.list portfolio_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="servicecatalog",
        operation="list_constraints_for_portfolio",
        op_kwargs={
