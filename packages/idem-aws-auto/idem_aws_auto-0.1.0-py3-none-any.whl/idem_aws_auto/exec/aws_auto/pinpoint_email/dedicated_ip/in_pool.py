...
async def put(hub, ctx, ip: str, destination_pool_name: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        ip(str): The IP address that you want to move to the dedicated IP pool. The value you specify has to be a dedicated IP address that's associated with your Amazon Pinpoint account.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.pinpoint_email.dedicated_ip.in_pool.put(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.pinpoint_email.dedicated_ip.in_pool.put ip=value, destination_pool_name=value
    """
