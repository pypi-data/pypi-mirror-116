    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.ecr_public.image.init.describe_all(ctx, repository_name=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.ecr_public.image.init.describe_all repository_name=value
    """
...
async def put(
    ...
    **Autogenerated function**
    ...
    Args:
        registry_id(str, optional): The AWS account ID associated with the public registry that contains the repository in which to put the image. If you do not specify a registry, the default public registry is assumed. Defaults to None.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.ecr_public.image.init.put(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.ecr_public.image.init.put repository_name=value, image_manifest=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="ecr-public",
