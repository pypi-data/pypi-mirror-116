...
async def list_(hub, ctx, resource_arn: str) -> Dict:
    ...
    **Autogenerated function**
    ...
    Args:
        resource_arn(str): The Amazon Resource Name (ARN) of the model for which you want to list tags. .
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.lookoutvision.tags_for_resource.list(ctx, resource_arn=value)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.lookoutvision.tags_for_resource.list resource_arn=value
    """
