...
async def list_all(
    hub, ctx, instance_profile_name: str, marker: str = None, max_items: int = None
) -> Dict:
    r"""
    **Autogenerated function**
    ...
    Args:
        instance_profile_name(str): The name of the IAM instance profile whose tags you want to see. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.iam.instance_profile.tag.list_all(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.iam.instance_profile.tag.list_all instance_profile_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="iam",
        operation="list_instance_profile_tags",
        op_kwargs={
