    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.neptune.db.cluster.endpoint.create(
                ctx,
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.neptune.db.cluster.endpoint.create db_cluster_identifier=value, db_cluster_endpoint_identifier=value, endpoint_type=value
    """
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.neptune.db.cluster.endpoint.delete(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.neptune.db.cluster.endpoint.delete db_cluster_endpoint_identifier=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="neptune",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.neptune.db.cluster.endpoint.describe_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.neptune.db.cluster.endpoint.describe_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="neptune",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.neptune.db.cluster.endpoint.modify(
                ctx, db_cluster_endpoint_identifier=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.neptune.db.cluster.endpoint.modify db_cluster_endpoint_identifier=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="neptune",
