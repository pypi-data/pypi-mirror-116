...
async def create(
    ...
    **Autogenerated function**
    ...
    Args:
        ...
        reputation_options(Dict, optional): An object that defines whether or not Amazon SES collects reputation metrics for the emails that you send that use the configuration set. Defaults to None.
        sending_options(Dict, optional): An object that defines whether or not Amazon SES can send email that you send using the configuration set. Defaults to None.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.sesv2.configuration_set_.init.create(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.sesv2.configuration_set_.init.create configuration_set_name=value
    """
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.sesv2.configuration_set_.init.delete(
                ctx, configuration_set_name=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.sesv2.configuration_set_.init.delete configuration_set_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="sesv2",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.sesv2.configuration_set_.init.get(
                ctx, configuration_set_name=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.sesv2.configuration_set_.init.get configuration_set_name=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="sesv2",
    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.sesv2.configuration_set_.init.list_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.sesv2.configuration_set_.init.list_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="sesv2",
