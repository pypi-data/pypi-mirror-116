    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.auditmanager.evidence.folder.by_assessment.control.get(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.auditmanager.evidence.folder.by_assessment.control.get assessment_id=value, control_set_id=value, control_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="auditmanager",
        operation="get_evidence_folders_by_assessment_control",
        op_kwargs={
