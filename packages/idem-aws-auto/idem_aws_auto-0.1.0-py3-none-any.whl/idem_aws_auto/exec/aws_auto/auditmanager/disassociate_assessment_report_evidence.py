    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.auditmanager.disassociate_assessment_report_evidence.batch(
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.auditmanager.disassociate_assessment_report_evidence.batch assessment_id=value, evidence_folder_id=value, evidence_ids=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="auditmanager",
        operation="batch_disassociate_assessment_report_evidence",
        op_kwargs={
