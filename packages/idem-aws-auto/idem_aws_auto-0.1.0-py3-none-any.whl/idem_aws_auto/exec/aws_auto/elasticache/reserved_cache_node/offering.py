    ...
    **Autogenerated function**
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.elasticache.reserved_cache_node.offering.describe_all(ctx)

        Call from CLI:

        .. code-block:: bash

            $ idem exec aws_auto.elasticache.reserved_cache_node.offering.describe_all
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="elasticache",
        operation="describe_reserved_cache_nodes_offerings",
        op_kwargs={
...
async def purchase(
    ...
    **Autogenerated function**
    ...
    Args:
        reserved_cache_nodes_offering_id(str): The ID of the reserved cache node offering to purchase. Example: 438012d3-4052-4cc7-b2e3-8d3372e0e706 .
        reserved_cache_node_id(str, optional): A customer-specified identifier to track this reservation.  The Reserved Cache Node ID is an unique customer-specified identifier to track this reservation. If this parameter is not specified, ElastiCache automatically generates an identifier for the reservation.  Example: myreservationID. Defaults to None.
        cache_node_count(int, optional): The number of cache node instances to reserve. Default: 1 . Defaults to None.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            await hub.exec.aws_auto.elasticache.reserved_cache_node.offering.purchase(
                ctx, reserved_cache_nodes_offering_id=value
            )
        ...
        .. code-block:: bash
            ...
            $ idem exec aws_auto.elasticache.reserved_cache_node.offering.purchase reserved_cache_nodes_offering_id=value
    """
    return await hub.tool.aws.client.exec(
        ctx,
        service_name="elasticache",
        operation="purchase_reserved_cache_nodes_offering",
        op_kwargs={
            "ReservedCacheNodesOfferingId": reserved_cache_nodes_offering_id,
