...
from common.rest_extend.base_models import BaseModels
from django.db import models


class BaseIoT(BaseModels):
    class Meta:
        db_table = 'iot'
        abstract = True
...
class BaseTenant(models.Model):
    ...
    iot = models.ForeignKey(to=AuthIoT, to_field="name", on_delete=models.CASCADE, null=False)
