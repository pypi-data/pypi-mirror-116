...
class ConversationsApi(object):
    ...
    def put_members_information_by_members_id(self, conversation_id, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_members_information_by_members_id(conversation_id, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str conversation_id: ID of the conversation (required)
        :param str id: ID of the member (required)
        :param PutMembersInformationPayload body: Update Members Information Payload
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_members_information_by_members_id_with_http_info(conversation_id, id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_members_information_by_members_id_with_http_info(conversation_id, id, **kwargs)  # noqa: E501
            return data

    def put_members_information_by_members_id_with_http_info(self, conversation_id, id, **kwargs):  # noqa: E501
        """Update an existing member in an conversation.  # noqa: E501

        Update an existing member in an conversation.   This API can be used for updating the unique speakers detected as members from diarization as well.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_members_information_by_members_id_with_http_info(conversation_id, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['conversation_id', 'id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def put_speakers_event_by_conversation_id(self, conversation_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_speakers_event_by_conversation_id(conversation_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str conversation_id: ID of the conversation (required)
        :param PutSpeakersEventsPayload body: Speakers events payload
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_speakers_event_by_conversation_id_with_http_info(conversation_id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_speakers_event_by_conversation_id_with_http_info(conversation_id, **kwargs)  # noqa: E501
            return data

    def put_speakers_event_by_conversation_id_with_http_info(self, conversation_id, **kwargs):  # noqa: E501
        """Speaker Events API provides the functionality to update Speakers who spoke in the conversation after it has been processed.  # noqa: E501

        Speaker Events API provides the functionality to update Speakers who spoke in the conversation after it has been processed. This is achieved by sending the API the list of Speaker Events for that conversation which the API then uses for associating it with the content of the same. This API can be used when you have access to these events for a recorded conversation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_speakers_event_by_conversation_id_with_http_info(conversation_id, async_req=True)
        >>> result = thread.get()
