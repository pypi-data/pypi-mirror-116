...
def parse_args():
  ...
  worker.add_argument('-b', '--logger', dest='logger', type=str, default=None,  help='logger callback function (default: None)')
  worker.add_argument('-v', '--verbosity', dest='verbosity', type=str, default="error",  help='logger verbosity, options are [error, completed, progress] (default: error)')
