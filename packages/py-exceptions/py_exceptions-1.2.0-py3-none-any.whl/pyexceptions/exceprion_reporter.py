...
def handle_exceptions(function: callable = None, is_lambda: bool = False, save: bool = True,
                      exceptions_folder: str = None, exclude: int = None, only_last: bool = True):
    """Organize and coordinate reporting on exceptions.

    Args:
        function (bool, callable): Decorator function. You don't have to set it up yourself.
