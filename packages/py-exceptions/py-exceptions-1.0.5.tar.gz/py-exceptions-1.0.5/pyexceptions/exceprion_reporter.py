...
def handle_exceptions(is_lambda: bool = False, return_only_html: bool = False,
    ...
    Args:
        ...
        return_only_html (bool, optional): Set true if you want the function to return html. Defaults to False.
