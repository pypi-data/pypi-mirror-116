...
class AbstractTestAutoAIAsync(abc.ABC):
    ...
    def test_03_initialize_optimizer(self):
        AbstractTestAutoAIAsync.remote_auto_pipelines = self.experiment.optimizer(**self.experiment_info)
...
class AbstractTestAutoAISync(abc.ABC):
    ...
    def test_03_initialize_optimizer(self):
        AbstractTestAutoAISync.remote_auto_pipelines = self.experiment.optimizer(**self.experiment_info)
