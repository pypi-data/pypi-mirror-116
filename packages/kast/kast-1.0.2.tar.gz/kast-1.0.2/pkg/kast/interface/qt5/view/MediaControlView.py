...
class Ui_MediaControlView(object):
    def setupUi(self, MediaControlView):
        ...
        self._layoutVolume = QtWidgets.QGridLayout()
        self._layoutVolume.setHorizontalSpacing(10)
        self._layoutVolume.setVerticalSpacing(0)
        self._layoutVolume.setObjectName("_layoutVolume")
        ...
        self._layoutVolume.addWidget(self.sliderVolumeLocal, 1, 1, 1, 1)
        ...
        self._layoutVolume.addWidget(self.buttonMuteLocal, 1, 2, 1, 1)
        ...
        self._layoutVolume.addWidget(self.buttonMuteRemote, 2, 2, 1, 1)
        ...
        self._layoutVolume.addWidget(self.sliderVolumeRemote, 2, 1, 1, 1)
        self.labelVolumeRemote = QtWidgets.QLabel(MediaControlView)
        self.labelVolumeRemote.setObjectName("labelVolumeRemote")
        self._layoutVolume.addWidget(self.labelVolumeRemote, 2, 0, 1, 1)
        self.labelVolumeLocal = QtWidgets.QLabel(MediaControlView)
        self.labelVolumeLocal.setObjectName("labelVolumeLocal")
        self._layoutVolume.addWidget(self.labelVolumeLocal, 1, 0, 1, 1)
        self._layoutMediaControl.addLayout(self._layoutVolume, 1, 7, 1, 1)
        ...
        self._layoutMediaControl.addWidget(self.labelTime, 1, 0, 1, 1)
