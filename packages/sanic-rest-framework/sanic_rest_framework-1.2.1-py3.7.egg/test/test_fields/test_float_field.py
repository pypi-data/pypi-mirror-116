...
from srf.fields import FloatField as TestField
...
class TestFloatField(TestBaseField):
    ...
    async def test_external_to_internal(self):
        ...
        self.assertEqual(await tf1.external_to_internal(self.str_pi), self.pi)
        self.assertEqual(await tf1.external_to_internal(self.pi), self.pi)
        self.assertEqual(await tf1.external_to_internal(self.str_max_float), self.max_float)
        self.assertEqual(await tf1.external_to_internal(self.max_int), self.max_int)
