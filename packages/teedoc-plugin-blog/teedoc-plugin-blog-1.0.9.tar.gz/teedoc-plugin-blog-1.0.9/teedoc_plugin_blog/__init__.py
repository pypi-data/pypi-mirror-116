...
if mistune_version >= 20:
    from teedoc_plugin_markdown_parser.renderer_new import create_markdown_parser
else:
    from teedoc_plugin_markdown_parser.renderer_old import create_markdown_parser
