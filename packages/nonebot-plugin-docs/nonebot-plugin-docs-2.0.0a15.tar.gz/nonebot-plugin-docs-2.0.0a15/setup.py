...
{'': ['*'],
 'nonebot_plugin_docs': ['dist/*',
                         ...
                         'dist/2.0.0a10/guide/*',
                         'dist/2.0.0a13.post1/*',
                         'dist/2.0.0a13.post1/advanced/*',
                         'dist/2.0.0a13.post1/api/*',
                         'dist/2.0.0a13.post1/api/adapters/*',
                         'dist/2.0.0a13.post1/api/drivers/*',
                         'dist/2.0.0a13.post1/guide/*',
                         'dist/2.0.0a7/*',
...
install_requires = \
['aiofiles>=0.7.0,<0.8.0', 'nonebot2>=2.0.0-alpha.1,<3.0.0']
