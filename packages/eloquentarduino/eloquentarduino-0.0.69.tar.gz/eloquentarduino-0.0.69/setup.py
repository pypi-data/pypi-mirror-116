...
setup(
  ...
  download_url = 'https://github.com/eloquentarduino/eloquentarduino-python/blob/master/dist/eloquentarduino-0.0.69.tar.gz?raw=true',
  keywords = [
    'ML',
    'Jupyter',
    'microcontrollers',
