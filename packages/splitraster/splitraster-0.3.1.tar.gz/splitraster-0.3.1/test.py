...
n = io.random_crop_image(input_image_path, save_path,  gt_image_path, save_path_gt,
                         crop_size=256, crop_number=20, img_ext='.jpg', label_ext='.png', overwrite=True)

print(f"{n} sample paris of {input_image_path, gt_image_path} are added at {save_path, save_path_gt}")
