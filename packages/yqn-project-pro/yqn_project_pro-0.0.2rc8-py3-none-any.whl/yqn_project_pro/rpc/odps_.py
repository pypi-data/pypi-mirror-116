...
from yqn_project_pro.utils.decorators import time_it
from yqn_project_pro.utils import health_mark, warning_mark
...
class ODPSClient(RPCConfigBase):
    ...
    def connect(self, **kwargs):
        self.odps_access_id = self.get_config("odps_access_id")
        self.odps_secret_access_key = self.get_config("odps_secret_access_key")
        self.odps_project = self.get_config("odps_project")
        self.odps_endpoint = self.get_config("odps_endpoint")
