...
from yqn_project_pro.utils.core.exceptions import BasicException, NameSpaceNotFoundException, ServerNotResponseException
from yqn_project_pro.utils.decorators import decrypt_apollo
...
class ApolloClient:
    ...
    def __init__(
        ...
        self.apollo_secret = apollo_secret  # Apollo加密秘钥
        self.stopped = False
        self._env = env
