...
from yqn_project_pro.utils.handler import auto_view
...
def parse_command():
    ...
    parser.add_argument('-c', '--config', type=str, required=True,
                        help='json-file config absolute path, '
                             'you can reference sample from README.md in installed yqn_project_pro')
    ...
    print(colored('refer to', 'green'),
          ...
          colored('from yqn_project_pro in installed packages for more usage info', 'green'))
