...
def align(BASE_DIR):
    ...
    cursor.execute("""SELECT id, dsc_sequencia, cd_requisicao FROM pipeline_requisicao WHERE sn_cdsearch = True AND sn_align = False AND sn_error = False AND sn_conclusao = False""")
