...
def nj_tree(BASE_DIR, tp_tree="NJ", nm_titulo=None, output="HTML"):
    ...
    cursor.execute("""SELECT id, dsc_sequencia, cd_requisicao FROM pipeline_requisicao WHERE sn_align = True AND sn_error = False AND sn_phylo = False AND sn_conclusao = False""")
