...
def domaintrim(BASE_DIR, database="ALL", output="HTML"):
    ...
    cursor.execute("""SELECT id, dsc_sequencia, cd_requisicao FROM pipeline_requisicao WHERE sn_cdsearch = True AND sn_pdomain = False AND sn_error = False AND sn_conclusao = False""")
