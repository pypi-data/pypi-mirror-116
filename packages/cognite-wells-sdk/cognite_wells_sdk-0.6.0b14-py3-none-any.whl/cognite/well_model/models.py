...
class ExternalIdWithSource(WellsBaseModel):
    class Config:
        allow_population_by_field_name = True
...
class WellMergeRules(WellsBaseModel):
    ...
    wellhead: List[str]
    kb_elevation: List[str] = Field(..., alias="kbElevation")
...
class DeleteWells(WellsBaseModel):
    ...
    items: List[ExternalIdWithSource]
...
class FieldSources(WellsBaseModel):
    ...
    kb_elevation: Optional[AssetSource] = Field(None, alias="kbElevation")
