...
def get_dataset(dataset_name):
    ...
    orig_filepaths = list(glob.glob(dir_name + '/database/*/*', recursive=True))
    ...
    if dataset_name not in list_datasets:
        ...
        if display:
            display_datasets(list_datasets, list_subtypes)
...
def display_datasets(list_datasets, list_subtypes):
    print("\n=========== Available Datasets ===========\n")
    table_list = []
