...
class LogAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, log_id, updated_at, created_at, *args, **kwargs):  # noqa: E501
        """LogAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, log_id, *args, **kwargs):  # noqa: E501
        """LogAllOf - a model defined in OpenAPI
