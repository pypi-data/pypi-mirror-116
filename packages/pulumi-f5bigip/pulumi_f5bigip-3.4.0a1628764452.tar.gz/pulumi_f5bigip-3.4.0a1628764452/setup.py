...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '3.4.0-alpha.1628764452+f3fd5a78'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 3.4.0-alpha.1628764452+f3fd5a78`
                """)
            else:
                raise
