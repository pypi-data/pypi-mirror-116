...
class SnapshotLibrary:
    ...
    def find_documents(self,
                       ...
                       projection: Dict[str, Any] = None) -> list:
        """
        ...
        :param projection: Project fields to return from the query, except for ObjectId and raw html docs.
            ...
            if include_id and include_html:
                ...
                cursor = self.collection.find({
                    ...
                    **filter_criteria
                    ...
                    limit=limit,
                    projection={'_id': include_id, 'search_metadata.raw_html_doc': include_html, **projection})
