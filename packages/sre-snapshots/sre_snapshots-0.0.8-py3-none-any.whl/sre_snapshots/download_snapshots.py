...
class SnapshotLibrary:
    ...
    def find_documents(self,
        ...
        :param include_html: Whether or not to download the 'search_metadata.raw_html_doc' element, which contains the
            full HTML document for the SERP.
        :param kwargs: Additional named arguments to supply to ``find`` PyMongo method.
        ...
        # Can't have both inclusion and exclusion filters in the projection
        if include_id and include_html:
            exclude_fields = None
        elif include_id and not include_html:
            exclude_fields = {'search_metadata.raw_html_doc': False}
        elif not include_id and include_html:
            exclude_fields = {'_id': False}
        else:
            exclude_fields = {'_id': False, 'search_metadata.raw_html_doc': False}
