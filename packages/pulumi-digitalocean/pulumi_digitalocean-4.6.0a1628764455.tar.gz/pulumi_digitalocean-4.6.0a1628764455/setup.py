...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.6.0-alpha.1628764455+dbf99fa4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.6.0-alpha.1628764455+dbf99fa4`
                """)
            else:
                raise
