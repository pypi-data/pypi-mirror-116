...
class RetrieveRequest(google.protobuf.message.Message):
    ...
    class CasesEntry(google.protobuf.message.Message):
        ...
        @property
        def value(self) -> arg_services.graph.v1.graph_pb2.ArgumentGraph: ...

        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[arg_services.graph.v1.graph_pb2.ArgumentGraph] = ...,
            ) -> None: ...
    ...
    @property
    def cases(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, arg_services.graph.v1.graph_pb2.ArgumentGraph]: ...

    @property
    def query_graph(self) -> arg_services.graph.v1.graph_pb2.ArgumentGraph: ...
    ...
    def __init__(self,
        *,
        cases : typing.Optional[typing.Mapping[typing.Text, arg_services.graph.v1.graph_pb2.ArgumentGraph]] = ...,
        query_graph : typing.Optional[arg_services.graph.v1.graph_pb2.ArgumentGraph] = ...,
        query_text : typing.Text = ...,
