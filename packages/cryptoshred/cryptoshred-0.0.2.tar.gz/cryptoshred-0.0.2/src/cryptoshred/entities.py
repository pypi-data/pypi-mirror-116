...
class CryptoContainer(BaseModel, Generic[T]):
    ...
    def value(self, clazz: T) -> Optional[T]:
        ...
        Returns:
            T: The value contained in the container passed through the constructor of the given class
        """
...
def container_for(
    ...
    Returns:
        CryptoContainer[T]: The cryptocontainer containing the passed value
    """
...
def _encrypt(
    ...
    ct = engine.encrypt(data=data, id=id)
