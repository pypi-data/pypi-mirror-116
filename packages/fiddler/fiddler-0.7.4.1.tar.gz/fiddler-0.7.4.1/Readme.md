...
### 0.7.4.1
   - ##### **New Features**
       - `FiddlerApi.experimental` functions added for advanced XAI capabilities.
           - Includes:
               - `tabular_similarity_search`
               - `nlp_similarity_search`
               - `run_nlp_feature_impact`
               - `initialize_embeddings`
               - `upload_dataset_with_nlp_embeddings`
