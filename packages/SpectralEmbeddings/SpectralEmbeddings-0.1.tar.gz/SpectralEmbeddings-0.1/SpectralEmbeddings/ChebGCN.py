# -*- coding: utf-8 -*-
"""
Created on Sat Aug 14 21:35:05 2021
...
def chebyshev_polynomial(adj,k):
    ...
    logging.info("Generated Chebyshev polynomials")
    return list_k[-1]

def get_chebgcn_embeddings(hidden_units,train_df_temp,source_label,target_label,epochs,num_layers,subset,k):
    label_set=[]
...
def get_node_embedding(node,embedding_weights):
    try:
        logging.info(f"Dimension of embedding is denoted by the number of labels {embedding_weights.shape[1]}")
