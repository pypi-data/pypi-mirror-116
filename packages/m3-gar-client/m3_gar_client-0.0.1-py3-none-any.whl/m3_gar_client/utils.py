...
def find_address_objects(filter_string, levels=None, parent_id=None, timeout=None):
    ...
    return config.backend.find_address_objects(filter_string, levels, parent_id, timeout)
...
def find_house(obj_id, house_number='', building_number='', structure_number='', timeout=None):
    ...
    return config.backend.find_house(obj_id, house_number, building_number, structure_number, timeout)
...
def get_full_name(obj, timeout=None):
    ...
    if isinstance(obj, House):
        ...
        obj = get_address_object(obj.parent_id, timeout)
