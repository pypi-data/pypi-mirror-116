...
class Backend(BackendBase):
    ...
    def find_address_objects(self, filter_string, levels=None, parent_id=None, timeout=None):
        ...
        :rtype: generator
        """
        return find_address_objects(filter_string, levels, parent_id, timeout)
    ...
    def find_house(self, obj_id, house_number, building_number='', structure_number='', timeout=None):
        ...
        """
        return find_house(obj_id, house_number, building_number, structure_number, timeout)
