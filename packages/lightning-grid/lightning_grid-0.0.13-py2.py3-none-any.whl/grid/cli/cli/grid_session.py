...
from grid.cli.cli.grid_credentials import print_creds_table
...
from grid.cli.tracking import Segment, TrackingEvents
...
def create(
    ...
    client.validate_and_configure_datastore(grid_config=_grid_config)
