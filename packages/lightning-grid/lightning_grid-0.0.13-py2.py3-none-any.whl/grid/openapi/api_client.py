...
from grid.openapi import rest
from grid.openapi.configuration import Configuration
from grid.openapi.exceptions import ApiException, ApiTypeError, ApiValueError
from grid.openapi.model_utils import (
...
class Endpoint(object):
    def __init__(self, settings=None, params_map=None, root_map=None, headers_map=None, api_client=None, callable=None):
        ...
        self.params_map['all'].extend([
            'async_req', '_host_index', '_preload_content', '_request_timeout', '_return_http_data_only',
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.auth_service_login  # this is an instance of the class Endpoint
        api_instance.auth_service_login()  # this invokes api_instance.auth_service_login.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.auth_service_login.callable or self.callable in this class
