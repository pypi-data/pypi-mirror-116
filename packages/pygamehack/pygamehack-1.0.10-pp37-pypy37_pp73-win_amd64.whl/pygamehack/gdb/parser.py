...
def parse_response(gdb_mi_text: str):
    ...
    # This has been commented out for performance (as it is unnecessary for this project)
    ...
    #     return {"type": "target", "message": None, "payload": payload}
        ...
        return {'type': None} # {"type": "output", "message": None, "payload": gdb_mi_text}


def response_is_finished(gdb_mi_text: str):
