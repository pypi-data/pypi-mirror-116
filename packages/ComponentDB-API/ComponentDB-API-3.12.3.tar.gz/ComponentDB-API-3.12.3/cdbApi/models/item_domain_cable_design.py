...
class ItemDomainCableDesign(object):
    ...
    openapi_types = {
        ...
        'deleted_ier_list': 'list[ItemElementRelationship]',
    ...
    attribute_map = {
        ...
        'deleted_ier_list': 'deletedIerList',
    ...
    def __init__(self, id=None, name=None, item_identifier1=None, item_identifier2=None, qr_id=None, domain=None, derived_from_item=None, item_source_list=None, item_category_list_import=None, primary_image_for_item=None, max_sort_order=None, domain_id=None, description=None, entity_type_list=None, item_category_list=None, item_type_list=None, item_project_list=None, deleted_connector_list=None, deleted_ier_list=None, technical_system_list=None, catalog_item=None, catalog_item_string=None, catalog_item_id=None, alternate_name=None, local_vars_configuration=None):  # noqa: E501
        ...
        if deleted_ier_list is not None:
            self.deleted_ier_list = deleted_ier_list
    ...
    @property
    def deleted_ier_list(self):
        """Gets the deleted_ier_list of this ItemDomainCableDesign.  # noqa: E501


        :return: The deleted_ier_list of this ItemDomainCableDesign.  # noqa: E501
        :rtype: list[ItemElementRelationship]
        """
        return self._deleted_ier_list

    @deleted_ier_list.setter
    def deleted_ier_list(self, deleted_ier_list):
        """Sets the deleted_ier_list of this ItemDomainCableDesign.


        :param deleted_ier_list: The deleted_ier_list of this ItemDomainCableDesign.  # noqa: E501
        :type: list[ItemElementRelationship]
        """

        self._deleted_ier_list = deleted_ier_list
