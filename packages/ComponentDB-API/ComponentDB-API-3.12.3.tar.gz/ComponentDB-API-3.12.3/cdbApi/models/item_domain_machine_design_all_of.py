...
class ItemDomainMachineDesignAllOf(object):
    ...
    def __init__(self, move_to_trash_error_msg=None, move_to_trash_warning_msg=None, current_hierarchy_item_element=None, move_to_trash_row_style=None, alternate_name=None, assigned_item=None, is_housed=None, status_property_type_name=None, local_vars_configuration=None):  # noqa: E501
