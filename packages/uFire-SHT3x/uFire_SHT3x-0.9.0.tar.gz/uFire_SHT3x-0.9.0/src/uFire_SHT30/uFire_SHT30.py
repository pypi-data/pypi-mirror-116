...
SHT30_MEASUREMENT = 0x2400 # high accuracy, no clock stretching
...
class uFire_SHT30():
    ...
    def begin(self, i2c_bus=1):
        self._address = SHT30_I2C_ADDRESS
    ...
    def measure(self):
        ...
        self._i2cPort.write_i2c_block_data(SHT30_I2C_ADDRESS, 0x30, [0xA2])         # reset
        time.sleep(1 / 1000)
        self._i2cPort.write_i2c_block_data(SHT30_I2C_ADDRESS, 0x24, [0x00])         # high accuracy, no clock stretching
        time.sleep(15 / 1000.0)
        data = self._i2cPort.read_i2c_block_data(SHT30_I2C_ADDRESS, 0, 6)
