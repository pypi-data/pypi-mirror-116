...
from Orange.widgets.utils.plot.owconstants import (
...
class OWPlotGUI:
    ...
    def show_one_line_check_box(self, widget):
        '''
            Creates a check box that shows and hides the specified line
        '''
        self._check_box(widget, 'show_one_line', 'Show Line with intercept = 0 and slope = 1',
                        'update_one_line_visibility')

    def show_zero_line_check_box(self, widget):
        '''
            Creates a check box that shows and hides the specified line
        '''
        self._check_box(widget, 'show_zero_line', 'Show Line with intercept = 0 and slope = 0',
                        'update_zero_line_visibility')
    ...
    _functions = {
        ...
        ShowOneLine: show_one_line_check_box,
        ShowZeroLine: show_zero_line_check_box,
