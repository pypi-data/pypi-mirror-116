...
Please make sure to load only Data into the widget and add Test Data after PCA-LDA has finished processing Data!If you have this widget incorporated into a workflow
...
.. image:: icons\\LDAcve.png
  :width: 600
  :alt: Alternative text

To evaluate the lda model objected to the data sets the cross validation error is calculated and presented within the "CVE-plot" tab.
Note: every evaluation mode can be presented by this plot but only a cross validation technique can serve a propper plot.