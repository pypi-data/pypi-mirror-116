...
class PersistentVolumes(ObjDict):
    ...
    def create_volume_instance(self, name, capacity, disk_type=DiskType.DEFAULT, retry_limit=0):
        ...
        """
        if disk_type not in list(DiskType.__members__.values()) or not isinstance(disk_type, DiskType):
        ...
        provision_payload.add_parameter(VOLUME_COMPONENT, 'capacity', disk_capacity)
