...
class IRCListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by IRCParser#value.
    def enterValue(self, ctx:IRCParser.ValueContext):
        pass

    # Exit a parse tree produced by IRCParser#value.
    def exitValue(self, ctx:IRCParser.ValueContext):
        pass
