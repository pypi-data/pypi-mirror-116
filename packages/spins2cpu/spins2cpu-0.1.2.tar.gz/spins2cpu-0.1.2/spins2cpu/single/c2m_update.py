            ...
            for j in range(Y_s):
                for i in range(X_s):
                    ...
                    energy = ( latt[l,k,j,i,0] * ( -Ja * ( latt[l ,k2,y_d2,i  ,0] + latt[l ,k2,y_u2,i,0] ) -
                                                    Jb * ( latt[l ,k1,y_d ,i  ,0] + latt[l ,k3,y_u ,i,0] + latt[l ,k1,y_d ,x_o,0] + latt[l ,k3,y_u ,x_o,0] ) -
                                                    J0 * ( latt[lo,k1,y_d ,i  ,0] + latt[lo,k3,y_u ,i,0] ) -
                                                    J1 *   latt[lo,k ,j   ,x_p,0] ) +
                               latt[l,k,j,i,1] * ( -Ja * ( latt[l ,k2,y_d2,i  ,1] + latt[l ,k2,y_u2,i,1] ) -
                                                    Jb * ( latt[l ,k1,y_d ,i  ,1] + latt[l ,k3,y_u ,i,1] + latt[l ,k1,y_d ,x_o,1] + latt[l ,k3,y_u ,x_o,1] ) -
                                                    J0 * ( latt[lo,k1,y_d ,i  ,1] + latt[lo,k3,y_u ,i,1] ) -
                                                    J1 *   latt[lo,k ,j   ,x_p,1] ) +
