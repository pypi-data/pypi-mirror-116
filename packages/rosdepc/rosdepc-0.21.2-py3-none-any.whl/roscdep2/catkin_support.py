"""
Helper routines for catkin.  These are distributed inside of roscdep2
to protect catkin against future roscdep2 API updatese.  These helper
...
def resolve_for_os(rosdep_key, view, installer, os_name, os_version):
    ...
    :raises: :exc:`roscdep2.ResolutionError`
    """
