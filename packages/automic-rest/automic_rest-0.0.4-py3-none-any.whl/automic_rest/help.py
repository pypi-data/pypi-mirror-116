class help():
    ...
    def show_all_html(self): 
        ...
        print('![version](https://img.shields.io/badge/version-0.0.3-blue) ![coverage](https://img.shields.io/badge/coverage-80%25-yellowgreen) ![state](https://img.shields.io/badge/state-dev-red) ![automic](https://img.shields.io/badge/automic-12.3-green)')
        print('#')
