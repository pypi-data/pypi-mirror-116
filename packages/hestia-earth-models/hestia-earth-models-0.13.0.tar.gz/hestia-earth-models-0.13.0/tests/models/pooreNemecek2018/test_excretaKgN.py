...
from hestia_earth.models.pooreNemecek2018.excretaKgN import run, _should_run

class_path = 'hestia_earth.models.pooreNemecek2018.excretaKgN'
fixtures_folder = f"{fixtures_path}/pooreNemecek2018/excretaKgN"
