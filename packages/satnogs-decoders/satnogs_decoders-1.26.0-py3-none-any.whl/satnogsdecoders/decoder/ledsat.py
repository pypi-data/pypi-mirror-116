...
class Ledsat(KaitaiStruct):
    ...
    class LedsatTlmT(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.trx_pa_temp = self._io.read_u2be()
            ...
            self.mag_x = self._io.read_u2be()
            self.mag_y = self._io.read_u2be()
            self.mag_z = self._io.read_u2be()
            ...
            self.gps_lat = self._io.read_u4be()
            self.gps_lon = self._io.read_u4be()
            self.gps_alt = self._io.read_u4be()
            ...
            self.ext_mag_x = self._io.read_u2be()
            self.ext_mag_y = self._io.read_u2be()
            self.ext_mag_z = self._io.read_u2be()
