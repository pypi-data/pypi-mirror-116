...
import p3dpkg.p3dSkel
from p3dpkg.p3dSkel import *
...
| Syntax:
| ------
| Result = py_p3dSkeletonLabeling ( image_data, dimx, dimy, dimz)
| 
| Return Value:
| ------------
...
| Syntax:
| ------
| Result = py_p3dGVFSkeletonization ( image_data, dimx,dimy,dimz [, mu=value ] [, eps=value ] [, hierarc=value ] [, scale=value |])
| 
| Return Value:
| ------------
...
| Syntax:
| ------
| Result = p3dPKSkeletonization ( image_data, dimx, dimy, dimz )
| 
| Return Value:
| ------------
| Returns a volume with the same dimensions of input volume having value 255 on skeleton voxels and 0 elsewhere.
...
| Syntax:
| ------
| Result = p3dSkeletonAnalysis ( image_data, skeleton_image, dimx, dimy, dimz [, nodes_im=bytearray] [, pores_im=bytearray] [, |throats_im=bytearray] [, pores_im=bytearray][, merging_factor=value] [, tortuosity_depth=value] [, resolution=value]  )
| 
| Return Value:
| ------------
...
| Syntax:
| ------
| Result = py_p3dSkeletonPruning ( image_data, dimx, dimy, dimz [,thresh=value] [,ultimate = bool] [,iterative = bool])
| 
| Return Value:
| ------------
| Returns a volume with the same dimensions of input volume having value 255 on skeleton voxels and 0 elsewhere.
