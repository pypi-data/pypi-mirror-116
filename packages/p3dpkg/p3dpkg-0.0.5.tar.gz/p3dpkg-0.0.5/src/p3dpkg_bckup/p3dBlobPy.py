...
#Blob labeling
def py_p3dBlobLabeling(image_data, dimx, dimy, dimz, conn3D = CONN6 ):
	"""
|
...
# MinVolumeFilter
def py_p3dMinVolumeFilter3D(image_data, dimx, dimy, dimz, min_vol = 5, conn = 6):
	"""
...
# Blob Analysis
def py_p3dBlobAnalysis(image_data, dimx, dimy, dimz, blob_im = None, star_im = None, resolution = 1.0, conn = 6):
	"""
