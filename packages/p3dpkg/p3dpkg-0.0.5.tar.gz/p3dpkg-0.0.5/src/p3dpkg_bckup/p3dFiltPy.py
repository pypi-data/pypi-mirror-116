...
def py_p3dAnisotropicDiffusionFilter8(image_data, dimx, dimy, dimz, m = 1, lambdaP = 0.01, sigma = 0.01, iterP = 10):
	"""
|
...
# BilateralFilter
def py_p3dBilateralFilter8(image_data, dimx,dimy,dimz,size = 3,sigma_d = 1.0,sigma_r = 3,iterations = 10):
	"""
|
...
| Syntax:
| ------
| Result = py_p3dBoinHaibelRingRemover8 ( image_data, dimx, dimy, dimz[, centerX=value ] [,centerY =value ] [, winsize=value ]    |[, |iterations=value ] )
| 
| Return Value:
| ------------
| Returns a filtered image with the same dimensions and type of input images.| 
...
def py_p3dSijbersPostnovRingRemover8(image_data, dimx, dimy, centerX, centerY,
                                     winsize = 5, thresh = 1, iterations = 1, precision = 1.5):
	"""
|
...
| Syntax:
| ------
| Result = py_p3dSijbersPostnovRingRemover8 ( image_data, dimx, dimy, dimz[, centerX=value ] [,centerY =value ] [, winsize=value |] [, thresh=value ][, iterations=1 ][, precision=value ] )
| 
| Return Value:
| ------------
...
# AutoThresholding
def py_p3dAutoThresholding8(image_data, dimx, dimy, dimz, methodNum = 1, thresh_val = 0):
	"""
|
...
#read
def py_p3dReadRaw16(filename, dimx, dimy, dimz, big_endian = 0, is_signed = 0):
	"""
|
...
#write
def py_p3dWriteRaw16(image_data, filename, dimx, dimy, dimz, big_endian = 0, is_unsigned = 0):
	"""
|
...
|
	"""
	#image_data = p3dFilt.malloc_uchar(dimx*dimy*dimz)
	err_code = p3dWriteRaw16(image_data, filename,dimx,dimy,dimz,little_endian, is_unsigned, None, None);
	py_printErrorMessage(err_code)
	return image_data
