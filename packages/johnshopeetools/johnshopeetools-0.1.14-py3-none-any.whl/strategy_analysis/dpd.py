...
class dpd:
    ...
    col_fpdxp_amt: str = None #flexible fpd
    col_is_fpdx: str = None #flexible fpd
    ...
    def dpd_basic(self, x):
        ...
        return pd.Series(d, index=['fpd0p_amt', 'fpd7p_amt','fpd15p_amt','fpd30p_amt','fpd0p_user','fpd7p_user','fpd15p_user','fpd30p_user','user_cnt'])
    ...
    def dpd_checking(self, x):
        ...
        return pd.Series(d, index=['fpd0p_principal', 'fpd7p_principal','fpd15p_principal','fpd30p_principal','fpd0p_user_cnt','fpd7p_user_cnt','fpd15p_user_cnt','fpd30p_user_cnt','user_cnt', 'user_principal'])
