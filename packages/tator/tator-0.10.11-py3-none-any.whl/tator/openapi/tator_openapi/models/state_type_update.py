...
class StateTypeUpdate(object):
    ...
    def __init__(self, delete_child_localizations=None, description=None, grouping_default=None, name=None, visible=None, local_vars_configuration=None):  # noqa: E501
