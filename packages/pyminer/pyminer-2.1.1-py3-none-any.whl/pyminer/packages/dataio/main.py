...
class Extension(BaseExtension):
    ...
    def on_load(self):
        ...
        mysqlIcon = create_icon(':/color/theme/default/icons/MySQL.svg')
        toolbar.append_menu('button_import_database', 'MySQL', lambda: self.import_db('mysql'),
                            mysqlIcon)
        oracleIcon = create_icon(':/color/theme/default/icons/oracle.svg')
        toolbar.append_menu('button_import_database', 'Oracle', lambda: self.import_db('oracle'),
                            oracleIcon)
        postgresqlIcon = create_icon(':/color/theme/default/icons/postgresql.svg')
