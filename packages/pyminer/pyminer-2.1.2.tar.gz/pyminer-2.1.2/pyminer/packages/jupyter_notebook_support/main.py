...
from PySide2.QtCore import Signal, QSize, Qt, QLocale, QTranslator, QCoreApplication
from PySide2.QtGui import QMouseEvent, QContextMenuEvent
from PySide2.QtWidgets import QVBoxLayout, QTextEdit, QPlainTextEdit, QTableWidget, QTableWidgetItem, QWidget, \
...
class Extension(BaseExtension):
    ...
    def on_started(self):
        self.menu_jupyter: QMenu = self.extension_lib.UI.get_toolbar('toolbar_home').append_qmenu(
            'button_open', 'Jupyter Notebook', create_icon(':/color/theme/default/icons/Jupyter.svg')
        )
        self.action_open_notebook = QAction(
            create_icon(':/color/theme/default/icons/Jupyter.svg'),
