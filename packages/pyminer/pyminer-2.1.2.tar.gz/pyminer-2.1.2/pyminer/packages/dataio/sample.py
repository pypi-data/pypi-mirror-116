...
class ImportTextForm(ImportDialog, dataImportFormEngine):
    ...
    def __init__(self, parent=None):
        ...
        self.IconPath = ":/color/theme/default/icons/txt.svg"
...
class ImportCsvForm(ImportDialog, dataImportFormEngine):
    ...
    def __init__(self, parent=None):
        self.IconPath = ":/color/theme/default/icons/csv.svg"
        self.file_types = "*.csv"
        super().__init__(parent)
        self.setupUi(self)
        self.center()
...
class ImportExcelForm(ImportDialog, dataImportFormEngine):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.IconPath = ":/color/theme/default/icons/excel.svg"
        self.setupUi(self)
        self.center()
        self.clearImportParam()
...
class ImportSpssForm(ImportDialog, dataImportFormEngine):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.file_types = "*.sav"
        self.IconPath = ":/color/theme/default/icons/spss.svg"
        self.setupUi(self)
        self.center()
        self.clearImportParam()
        self.updateUIForm()
...
class ImportSasForm(ImportDialog, dataImportFormEngine):
    ...
    def __init__(self, parent=None):
        ...
        self.IconPath = ":/color/theme/default/icons/sas.ico"
        self.setupUi(self)
        self.center()
        self.clearImportParam()
        self.updateUIForm()
...
class ImportMatlabForm(ImportDialog, dataImportFormEngine):
    ...
    def __init__(self, parent=None):
        ...
        self.new_import_filepath = ""
        self.file_types = "*.mat"
        self.IconPath = ":/color/theme/default/icons/matlab.svg"
        self.setupUi(self)
        self.center()
        self.clearImportParam()
        self.updateUIForm()
...
class ImportStataForm(ImportDialog, dataImportFormEngine):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.file_types = "*.dta"
        self.IconPath = ":/color/theme/default/icons/stata.svg"
        self.setupUi(self)
        self.center()
        self.clearImportParam()
        self.updateUIForm()
