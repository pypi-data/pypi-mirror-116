...
def create_layers_rgbd(depthmap_fpath: str, rgb_fpath: str) -> Tuple[np.ndarray, dict]:
...
class ArtifactProcessor:
    ...
    def create_and_save_pickle(self, artifact_dict: dict) -> str:
        ...
        if self.dataset_type == 'depthmap':
            ...
            layers, metadata = create_layers_rgbd(zip_input_full_path, rgb_input_full_path)
        else:
