...
class Depthmap:
    ...
    def create_from_zip_absolute(cls,
                                 ...
                                 should_rotate_rgb: bool = True) -> 'Depthmap':
        # read depthmap data
    ...
    def create_from_zip(cls,
                        ...
                        should_rotate_rgb: bool = False) -> 'Depthmap':

        depthmap_path = Path(depthmap_dir) / 'depth' / depthmap_fname
        rgb_fpath = 0
        if rgb_fname:
            rgb_fpath = Path(depthmap_dir) / 'rgb' / rgb_fname
        return cls.create_from_zip_absolute(depthmap_path, rgb_fpath, calibration_file, should_rotate_rgb)
