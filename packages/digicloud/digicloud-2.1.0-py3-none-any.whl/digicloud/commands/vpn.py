...
class CreateExternalVpnConnection(ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            '--vpn-router-id',
            metavar='<VpnRouterId>',
            help="The id of the router to be used with the VPN",
            required=True
        )
        parser.add_argument(
    ...
    def get_data(self, parsed_args):
        payload = {
            ...
            "local_endpoint_group": {"endpoints": parsed_args.local_endpoint_group},
            ...
            "vpn_service": {"router_id": parsed_args.vpn_router_id},
            "ipsec_policy": {
