...
class Training(abc.ABC):
    ...
    def __subclasshook__(cls, subclass):
        return (hasattr(subclass, 'split_data') and
                ...
                hasattr(subclass, 'input_schema') and
                callable(subclass.input_schema) and
                hasattr(subclass, 'output_schema') and
                callable(subclass.output_schema) and
    ...
    @abc.abstractmethod
    def _log_model(self, model, train_data: pd.DataFrame) -> None:
        """Load in the data set"""
        raise NotImplementedError
    ...
    def __log_artifact(self):
        ...
        self._log_model(self._model, self._train_data)
