...
from ._util._utils import _sanitize_python_variable_name, _get_or_sanitize_python_name, _get_enum
...
class ModuleDto(DesignerModuleDto, TelemetryMixin):
    ...
    def correct_run_settings(self):
        ...
        self.run_setting_parameters = [
            p for p in self.run_setting_parameters if p.run_setting_ui_hint and not p.run_setting_ui_hint.anonymous
        ]
        run_setting_parameters = self.run_setting_parameters
        # Set id
        for p in run_setting_parameters:
        ...
        run_setting_parameters = self.run_setting_parameters = updated
