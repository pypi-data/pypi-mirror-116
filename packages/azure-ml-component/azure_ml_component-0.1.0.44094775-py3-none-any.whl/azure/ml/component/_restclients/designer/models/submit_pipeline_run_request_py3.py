...
class SubmitPipelineRunRequest(Model):
    ...
    def __init__(self, *, compute_target: str=None, step_tags=None, experiment_name: str=None, pipeline_parameters=None, data_path_assignments=None, data_set_definition_value_assignments=None, enable_notification: bool=None, sub_pipelines_info=None, graph=None, module_node_run_settings=None, tags=None, continue_run_on_step_failure: bool=None, description: str=None, properties=None, **kwargs) -> None:
