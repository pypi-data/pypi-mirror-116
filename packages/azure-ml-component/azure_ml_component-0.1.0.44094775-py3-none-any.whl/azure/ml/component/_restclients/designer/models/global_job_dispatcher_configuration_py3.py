...
class GlobalJobDispatcherConfiguration(Model):
    ...
    def __init__(self, *, vm_size=None, compute_type=None, region=None, my_resource_only: bool=None, low_priority_vm_tolerant: bool=None, vc_list=None, plan_id: str=None, plan_region_id: str=None, vc_block_list=None, cluster_block_list=None, **kwargs) -> None:
