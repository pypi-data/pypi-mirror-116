...
class PipelineComponentDefinitionBuilderGenerator:
    ...
    def get_or_create_pipeline_definition_builder(self, user_init_args: dict = {}):
        ...
        cached_builder = self._get_builder_from_cache(non_pipeline_parameters)
        if cached_builder is None:
            builder = PipelineComponentDefinitionBuilder.from_func(**self._builder_init_args,
                                                                   non_pipeline_parameters=non_pipeline_parameters)
            self._add_builder_to_cache(builder, non_pipeline_parameters)
