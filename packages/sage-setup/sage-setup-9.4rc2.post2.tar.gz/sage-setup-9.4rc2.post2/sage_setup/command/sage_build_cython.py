...
class sage_build_cython(Command):
    ...
    def run(self):
        ...
        required_pkgconfig_modules = getattr(self.distribution, 'required_pkgconfig_modules', None)
        if required_pkgconfig_modules is None:
            aliases = cython_aliases()
        else:
            aliases = cython_aliases(required_modules=required_pkgconfig_modules,
                                     optional_modules=())
