...
class PolyscopeObject:
    ...
    def register_surface_mesh(self, name, verts, faces, enabled=None, color=None, edge_color=None, smooth_shade=None, edge_width=None,
                              material=None):
        mesh = PolyscopeMesh(name, verts, faces, enabled=enabled, color=color, edge_color=edge_color, smooth_shade=smooth_shade,
                             edge_width=edge_width, material=material)
