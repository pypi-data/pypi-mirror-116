...
class User(object):
	...
	"""
	"""
	user_external_ids_json = None;

	"""
	"""
	user_limits_json = None;

	"""
	"""
	user_permissions_json = None;

	"""
	"""
	user_custom_prices_json = None;

	"""
	"""
	user_is_testing_mode = None;
