...
class StrategyBacktestStats(Model):
    ...
    def set_base_position(
        ...
        logger.info("更新策略 base_position %s : %s", self.short_name, strategy_settings)
    ...
    def update_backtest_status(
        ...
        if check_account_mapping and backtest_status <= StrategyBacktestStatusEnum.QuasiOnline.value:
            ...
            del_count = AccountStrategyMapping.delete().where(
                AccountStrategyMapping.symbols_info_id == self.symbols_info_id,
                AccountStrategyMapping.stg_info_id == self.stg_info_id,
                AccountStrategyMapping.id_name == self.id_name,
            ).execute()
        else:
            del_count = 0
    ...
    def get_available_status_group_by_strategy(
            ...
            ignore_fields='auto'
    ) -> typing.Dict[typing.Tuple[str, str], list]:
