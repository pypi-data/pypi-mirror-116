...
from vnpy_extra.constants import INSTRUMENT_PRICE_TICK_DIC, SYMBOL_MINUTES_COUNT_DIC, GeneralPeriodEnum, BASE_POSITION, \
...
from vnpy_extra.utils.enhancement import BarGenerator, PriceTypeEnum, CtaSignal
...
class CtaTemplate(CtaTemplateBase):
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        ...
        if self.raise_error_if_setting_not_in_parameters:
            ...
            if mismatches:
                raise ValueError(f"{mismatches} don't existed in parameters=\n{self.parameters}\nsetting=\n{setting}")
        ...
        for variable in [
            ...
            "acc_drawback_rate", "drawback_rate"
        ]:
    ...
    def send_order(
        ...
        if order_datetime is not None and not check_datetime_trade_available(order_datetime) and self._is_realtime_mode:
            log_level = 'warning'
            msg += '【非交易时段】'
            ignore_order = True
        ...
        if trade.offset == Offset.OPEN:
            ...
            if self.pos == 0:
                ...
                if trade.direction == Direction.LONG:
                    rr = 1 - self.exit_price / self.avg_entry_price
                else:
                    rr = self.exit_price / self.avg_entry_price - 1
