...
setup(
    name='dp_path_util',  # Required
    version=version,  # Required
    description='Utilities for Path construction',  # Optional
    long_description=long_description,
    long_description_content_type='text/x-rst',
    url='https://github.com/dataPuzzler/dp_path_util',  # Optional
    ...
    keywords='json, jsonschema',  # Optional
