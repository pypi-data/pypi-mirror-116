...
class MascaraIpaddressService:
    ...
    @inject()
    def list_mascara_ipaddress(self, repository: Provide[MascaraIpaddressRepository]) -> list[MascaraIpaddressVo]:
        result: list = []
    ...
    def get_by_search_criteria(
        self, search_criteria: dict, repository: Provide[MascaraIpaddressRepository]
    ) -> MascaraIpaddressVo:
        mascara_ipaddress = repository.get_by_criteria(search_criteria)
        return MascaraIpaddressVo(
            ipaddress=mascara_ipaddress["ipaddress"], lastconnection=mascara_ipaddress["lastconnection"]
        )
