...
def _join(lst, sep=" ", untag=False):
    ...
    try:
        ...
        from nltkma.tag import tuple2str
...
def in_demo(trace=0, sql=True):
    ...
    query.
    """
    from nltkma.corpus import ieer
...
def conllned(trace=1):
    ...
    from nltkma.corpus import conll2002
...
def ne_chunked():
    ...
    rels = []
    for i, sent in enumerate(nltkma.corpus.treebank.tagged_sents()[:1500]):
        sent = nltkma.ne_chunk(sent)
...
if __name__ == "__main__":
    import nltkma
    from nltkma.sem import relextract
