...
from nltkma.grammar import CFG, FeatureGrammar, PCFG
from nltkma.data import load

from nltkma.parse.chart import Chart, ChartParser
from nltkma.parse.pchart import InsideChartParser
from nltkma.parse.featurechart import FeatureChart, FeatureChartParser
...
def taggedsent_to_conll(sentence):
    ...
    >>> from nltkma import word_tokenize, pos_tag
...
def taggedsents_to_conll(sentences):
    ...
    >>> from nltkma import word_tokenize, sent_tokenize, pos_tag
