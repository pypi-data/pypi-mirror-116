...
from nltkma.tag import ClassifierBasedTagger, pos_tag

try:
    from nltkma.classify import MaxentClassifier
except ImportError:
    pass
...
from nltkma.chunk.api import ChunkParserI
from nltkma.chunk.util import ChunkScore
...
class NEChunkParserTagger(ClassifierBasedTagger):
    ...
    def _english_wordlist(self):
        try:
            ...
            from nltkma.corpus import words
...
if __name__ == "__main__":
    ...
    from nltkma.chunk.named_entity import build_model
