...
from nltkma.grammar import Production, Nonterminal
from nltkma.probability import ProbabilisticMixIn
from nltkma.util import slice_bounds
from nltkma.internals import raise_unorderable_types
...
class Tree(list):
    ...
    def chomsky_normal_form(
        ...
        :type  parentChar: str
        """
        from nltkma.treetransforms import chomsky_normal_form
    ...
    def un_chomsky_normal_form(
        ...
        :type  unaryChar: str
        """
        from nltkma.treetransforms import un_chomsky_normal_form
    ...
    def collapse_unary(self, collapsePOS=False, collapseRoot=False, joinChar="+"):
        ...
        :type  joinChar: str
        """
        from nltkma.treetransforms import collapse_unary
    ...
    def draw(self):
        ...
        """
        from nltkma.draw.tree import draw_trees
    ...
    def pretty_print(self, sentence=None, highlight=(), stream=None, **kwargs):
        ...
        """
        from nltkma.treeprettyprinter import TreePrettyPrinter
    ...
    def _repr_png_(self):
        ...
        import subprocess
        import tempfile
        from nltkma.draw.tree import tree_to_treesegment
        from nltkma.draw.util import CanvasFrame
...
def demo():
    ...
    from nltkma import Tree, ProbabilisticTree
