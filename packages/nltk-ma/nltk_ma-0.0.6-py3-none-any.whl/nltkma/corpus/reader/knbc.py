...
from nltkma.corpus.reader.api import SyntaxCorpusReader, CorpusReader
...
class KNBCorpusReader(SyntaxCorpusReader):
    ...
    >>> from nltkma.corpus.util import LazyCorpusLoader
...
def demo():
    ...
    root = nltkma.data.find("corpora/knbc/corpus1")
    fileids = [
        f
