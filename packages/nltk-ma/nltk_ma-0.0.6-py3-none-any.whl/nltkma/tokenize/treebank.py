...
import re
from nltkma.tokenize.api import TokenizerI
from nltkma.tokenize.util import align_tokens
from nltkma.tokenize.destructive import MacIntyreContractions
...
class TreebankWordTokenizer(TokenizerI):
    ...
    - separate periods that appear at the end of line
        ...
        >>> from nltkma.tokenize import TreebankWordTokenizer
...
class TreebankWordDetokenizer(TokenizerI):
    ...
    - It's not possible to return the original whitespaces as they were because
      ...
      the text.split() operation.
        ...
        >>> from nltkma.tokenize.treebank import TreebankWordTokenizer, TreebankWordDetokenizer
        >>> s = '''Good muffins cost $3.88\nin New York.  Please buy me\ntwo of them.\nThanks.'''
    ...
    >>> from nltkma.tokenize.treebank import TreebankWordDetokenizer
