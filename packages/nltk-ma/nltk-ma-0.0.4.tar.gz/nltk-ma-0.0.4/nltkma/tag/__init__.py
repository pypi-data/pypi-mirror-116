...
An off-the-shelf tagger is available for English. It uses the Penn Treebank tagset:
    ...
    >>> from nltkma import pos_tag, word_tokenize
...
the most frequent tag for *w* was in a training corpus:
    ...
    >>> from nltkma.tag import UnigramTagger
...
from nltkma.tag.util import str2tuple, tuple2str, untag
from nltkma.tag.sequential import (
...
from nltkma.tag.brill import BrillTagger
from nltkma.tag.brill_trainer import BrillTaggerTrainer
from nltkma.tag.tnt import TnT
from nltkma.tag.hunpos import HunposTagger
from nltkma.tag.stanford import StanfordTagger, StanfordPOSTagger, StanfordNERTagger
from nltkma.tag.hmm import HiddenMarkovModelTagger, HiddenMarkovModelTrainer
from nltkma.tag.senna import SennaTagger, SennaChunkTagger, SennaNERTagger
from nltkma.tag.mapping import tagset_mapping, map_tag
from nltkma.tag.crf import CRFTagger
from nltkma.tag.perceptron import PerceptronTagger

from nltkma.data import load, find
...
def pos_tag(tokens, tagset=None, lang="eng"):
    ...
    tag the given list of tokens.
        ...
        >>> from nltkma.tag import pos_tag
