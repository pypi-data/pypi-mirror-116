...
from nltkma.data import show_cfg
from nltkma.tag import RegexpTagger
from nltkma.parse import load_parser
from nltkma.parse.malt import MaltParser
from nltkma.sem.drt import resolve_anaphora, AnaphoraResolutionException
from nltkma.sem.glue import DrtGlue
from nltkma.sem.logic import Expression

from nltkma.inference.mace import MaceCommand
from nltkma.inference.prover9 import Prover9Command
...
class CfgReadingCommand(ReadingCommand):
    ...
    def parse_to_readings(self, sentence):
        ...
        from nltkma.sem import root_semrep
...
def discourse_demo(reading_command=None):
    ...
    background = nltkma.data.load(background_file)
