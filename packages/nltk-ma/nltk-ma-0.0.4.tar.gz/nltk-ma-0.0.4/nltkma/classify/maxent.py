...
from nltkma.data import gzip_open_unicode
from nltkma.util import OrderedDict
from nltkma.probability import DictionaryProbDist

from nltkma.classify.api import ClassifierI
from nltkma.classify.util import CutoffChecker, accuracy, log_likelihood
from nltkma.classify.megam import call_megam, write_megam_file, parse_megam_weights
from nltkma.classify.tadm import call_tadm, write_tadm_file, parse_tadm_weights
...
######################################################################
def demo():
    from nltkma.classify.util import names_demo
