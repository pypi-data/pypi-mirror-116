...
class NaiveBayesDependencyScorer(DependencyScorerI):
    ...
    >>> from nltkma.parse.dependencygraph import DependencyGraph, conll_data2
...
class ProbabilisticNonprojectiveParser:
    ...
    >>> from nltkma.grammar import DependencyGrammar
...
def nonprojective_conll_parse_demo():
    from nltkma.parse.dependencygraph import conll_data2
