...
Example:
    ...
    >>> from nltkma.classify import PositiveNaiveBayesClassifier
...
from nltkma.probability import FreqDist, DictionaryProbDist, ELEProbDist
...
def demo():
    from nltkma.classify.util import partial_names_demo
