...
class LazyMap(AbstractLazySequence):
    ...
    equivalent:
        ...
        >>> from nltkma.collections import LazyMap
        >>> function = str
        >>> sequence = [1,2,3]
...
class LazyZip(LazyMap):
    ...
    ``zip``.  In particular, an evaluated LazyZip is equivalent to a zip:
        ...
        >>> from nltkma.collections import LazyZip
...
class LazyEnumerate(LazyZip):
    ...
    equivalent:
        ...
        >>> from nltkma.collections import LazyEnumerate
...
class Trie(dict):
    ...
    def insert(self, string):
        ...
        >>> from nltkma.collections import Trie
        >>> trie = Trie(["abc", "def"])
