...
from nltkma.corpus.reader import XMLCorpusReader, XMLCorpusView
from nltkma.util import LazyConcatenation, LazyMap, LazyIteratorList
...
class FramenetCorpusReader(XMLCorpusReader):
    ...
    >>> from nltkma.corpus import framenet as fn
...
warnings(True) to display corpus consistency warnings when loading data
    ...
    def frames_by_lemma(self, pat):
        ...
        >>> from nltkma.corpus import framenet as fn
        >>> from nltkma.corpus.reader.framenet import PrettyList
