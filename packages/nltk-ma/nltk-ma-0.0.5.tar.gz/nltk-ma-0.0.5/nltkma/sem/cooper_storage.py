...
from nltkma.sem.logic import LambdaExpression, ApplicationExpression, Variable
from nltkma.parse import load_parser
from nltkma.parse.featurechart import InstantiateVarsChart
...
def demo():
    from nltkma.sem import cooper_storage as cs
