...
try:
    ...
    from nltkma.draw.table import Table
    from nltkma.draw.util import ShowText
except ImportError:
    TKINTER = False
    TclError = ValueError
...
class Downloader:
    ...
    def _update_index(self, url=None):
        ...
        self._index = nltkma.internals.ElementWrapper(
    ...
    def default_download_dir(self):
        ...
        for nltkdir in nltkma.data.path:
            if os.path.exists(nltkdir) and nltkma.internals.is_writable(nltkdir):
                return nltkdir
...
def _find_packages(root):
    ...
    """
    from nltkma.corpus.reader.util import _path_from
