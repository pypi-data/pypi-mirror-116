...
from nltkma.util import transitive_closure, invert_graph
from nltkma.internals import raise_unorderable_types

from nltkma.probability import ImmutableProbabilisticMixIn
from nltkma.featstruct import FeatStruct, FeatDict, FeatStructReader, SLASH, TYPE
...
def cfg_demo():
    ...
    from nltkma import nonterminals, Production, CFG
...
def pcfg_demo():
    ...
    from nltkma.corpus import treebank
    from nltkma import treetransforms
    from nltkma import induce_pcfg
    from nltkma.parse import pchart
...
def fcfg_demo():
    ...
    g = nltkma.data.load("grammars/book_grammars/feat0.fcfg")
    print(g)
    print()
...
def sdg_demo():
    ...
    """
    from nltkma.parse import DependencyGraph
