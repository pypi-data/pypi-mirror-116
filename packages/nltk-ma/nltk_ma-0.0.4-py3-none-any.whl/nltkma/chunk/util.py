...
from nltkma.tag.mapping import map_tag
from nltkma.tag.util import str2tuple

##//////////////////////////////////////////////////////
## EVALUATION
##//////////////////////////////////////////////////////

from nltkma.metrics import accuracy as _accuracy
...
def demo():
    ...
    t = nltkma.chunk.tagstr2tree(s, chunk_label="NP")
    t.pprint()
    print()
...
"""
    ...
    print("CoNLL output:")
    print(nltkma.chunk.tree2conllstr(conll_tree))
    print()
