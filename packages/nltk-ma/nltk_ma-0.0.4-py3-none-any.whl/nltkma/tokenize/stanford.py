...
from nltkma.internals import find_jar, config_java, java, _java_options
from nltkma.tokenize.api import TokenizerI
from nltkma.parse.corenlp import CoreNLPParser
...
class StanfordTokenizer(TokenizerI):
    ...
    >>> from nltkma.tokenize.stanford import StanfordTokenizer
