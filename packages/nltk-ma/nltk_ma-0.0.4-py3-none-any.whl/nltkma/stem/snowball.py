...
from nltkma.stem import porter
from nltkma.stem.util import suffix_replace, prefix_replace
...
class SnowballStemmer(StemmerI):
    ...
    >>> from nltkma.stem import SnowballStemmer
    ...
    >>> from nltkma.stem.snowball import GermanStemmer
...
def demo():
    ...
    from nltkma.corpus import udhr
