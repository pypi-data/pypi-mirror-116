...
from nltkma.util import flatten, LazyMap, LazyConcatenation

from nltkma.corpus.reader.util import concat
from nltkma.corpus.reader.xmldocs import XMLCorpusReader, ElementTree
