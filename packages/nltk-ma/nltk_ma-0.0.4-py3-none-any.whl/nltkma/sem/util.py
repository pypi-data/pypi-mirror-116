...
import codecs
from nltkma.sem import evaluate
...
def parse_sents(inputs, grammar, trace=0):
    ...
    from nltkma.grammar import FeatureGrammar
    from nltkma.parse import FeatureChartParser, load_parser
...
def root_semrep(syntree, semkey="SEM"):
    ...
    """
    from nltkma.grammar import FeatStructNonterminal
