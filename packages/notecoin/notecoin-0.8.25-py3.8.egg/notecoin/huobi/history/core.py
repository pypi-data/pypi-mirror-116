...
ALL_TYPES = [_SPOT, _SWAP, _FUTURE, _OPTION, _LINEARSWAP]
...
class HistoryDownload:
    ...
    def download_symbol_period_day(self, path_url, symbol, period, current, *args, **kwargs) -> Response:
    ...
    def download_spot(self):
        """return date is: [start, end)"""
        self.type = _SPOT
        self.download_symbols()

    def download_future(self):
        self.type = _FUTURE
        self.download_symbols()
