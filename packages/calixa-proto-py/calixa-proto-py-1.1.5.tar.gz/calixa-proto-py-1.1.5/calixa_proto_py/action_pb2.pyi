...
class ActionParams(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"charge_refund_params",b"charge_refund_params",u"coupon_apply_params",b"coupon_apply_params",u"custom_params",b"custom_params",u"opportunity_create_params",b"opportunity_create_params",u"params",b"params",u"redirect_params",b"redirect_params",u"subscription_trial_update_params",b"subscription_trial_update_params",u"task_create_params",b"task_create_params"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"charge_refund_params",b"charge_refund_params",u"coupon_apply_params",b"coupon_apply_params",u"custom_params",b"custom_params",u"opportunity_create_params",b"opportunity_create_params",u"params",b"params",u"redirect_params",b"redirect_params",u"subscription_trial_update_params",b"subscription_trial_update_params",u"task_create_params",b"task_create_params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"params",b"params"]) -> typing_extensions___Literal["charge_refund_params","subscription_trial_update_params","coupon_apply_params","opportunity_create_params","task_create_params","custom_params","redirect_params"]: ...
...
class DisplayField(google___protobuf___message___Message):
    ...
    suppliedByEntityType: common_pb2___EntityTypeValue = ...
    suppliedByIdValue: typing___Text = ...
    suppliedByIdName: typing___Text = ...
    order: builtin___int = ...
    ...
    def __init__(self,
        *,
        ...
        suppliedByEntityType : typing___Optional[common_pb2___EntityTypeValue] = None,
        suppliedByIdValue : typing___Optional[typing___Text] = None,
        suppliedByIdName : typing___Optional[typing___Text] = None,
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"display",b"display",u"field_type",b"field_type",u"initial_value",b"initial_value",u"key",b"key",u"options",b"options",u"order",b"order",u"placeholder",b"placeholder",u"properties",b"properties",u"render_when",b"render_when",u"required",b"required",u"suppliedByEntityType",b"suppliedByEntityType",u"suppliedByIdName",b"suppliedByIdName",u"suppliedByIdValue",b"suppliedByIdValue"]) -> None: ...
