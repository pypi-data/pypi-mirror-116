...
def install_app(app, home_dir, working_dir, github_token):
    if app.startswith("https://"):  # Git repo
        pass  # TODO
    elif "/" in app:  # GitHub project
        working_dir = working_dir
        sh.git("clone", f"https://github.com/{app}.git", _cwd=working_dir)
        sh.poetry("install", _cwd=working_dir + f"/{app}")
