...
class DatasetUsage:
    ...
    total_query_counts: Optional[QueryCounts] = None
    ...
    def from_dict(obj: Any) -> 'DatasetUsage':
        ...
        total_query_counts = from_union([QueryCounts.from_dict, from_none], obj.get("totalQueryCounts"))
        return DatasetUsage(id, aspect_type, created_at, entity_id, dataset_usage_id, latest, query_counts, total_query_counts)
    ...
    def to_dict(self) -> dict:
        ...
        result["totalQueryCounts"] = from_union([lambda x: to_class(QueryCounts, x), from_none], self.total_query_counts)
        return result
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, dataset_created_at, deleted_at, documentation, entity_type, dataset_id, last_modified_at, logical_id, ownership, properties, schema, statistics, support_info, upstream, usage)
