...
class QueryCount:
    ...
    def from_dict(obj: Any) -> 'QueryCount':
        ...
        return QueryCount(last24_hours, last30_days, last365_days, last7_days, last90_days)
...
class DatasetUsage:
    ...
    def from_dict(obj: Any) -> 'DatasetUsage':
        ...
        return DatasetUsage(id, aspect_type, created_at, entity_id, dataset_usage_id, latest, query_count)
