...
(``M``) must be specified, e.g. \ ``n_items=4`` if your App displays
four items. The ``'overlap'`` algorithm assigns every ``i*(M-1)+1``-th
...
.. |image6| image:: https://raw.githubusercontent.com/satzbeleg/bwsample/main/docs/bwsample-process.png
