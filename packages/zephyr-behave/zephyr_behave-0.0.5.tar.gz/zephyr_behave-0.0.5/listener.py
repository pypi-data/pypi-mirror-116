...
class AllureListener(object):
    def __init__(self, behave_config):
        ...
        self.issue_pattern = behave_config.userdata.get('ZephyrFormatter.issue_pattern', None)
        self.link_pattern = behave_config.userdata.get('ZephyrFormatter.link_pattern', None)
        self.hide_excluded = behave_config.userdata.get('ZephyrFormatter.hide_excluded', False)
