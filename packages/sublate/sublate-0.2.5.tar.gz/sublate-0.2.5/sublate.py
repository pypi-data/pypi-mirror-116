...
def main():
    ...
    parser.add_argument('--data', metavar='data', type=str, nargs='*', help='path to project data')
    parser.add_argument('--output', metavar='output', type=str, nargs='?', default='build', help='path to output project')
...
def _build(path, output_path, data, render, remove, root_path):
    ...
    # TODO: skip over output if in src dir
