...
class Node:
    def __init__(self, nodename='pynode', inputs='', outputs='', handler = None, server = 'secure.nodewire.org'):
...
if __name__ == '__main__':
    ...
    ## MAIN PROGRAM
    handler = Handler()
    ctrl = Node(inputs = 'auto_switch', outputs = 'service_required', handler=handler)
