...
def cal_delay(reffile, testfile, samplerate):
        ...
        # print(delays.Nutterances)
        # print(delays.Largest_uttsize)
        # print(delays.Nsurf_samples)
        # print(delays.Crude_DelayEst)
        # print(delays.Crude_DelayConf)
        print(delays.Crude_DelayEst)
        return delays.Crude_DelayEst

if __name__ == '__main__':
       ref = r'E:\files\cle_malePolqaWB_8000.pcm'
       test = r'E:\files\cle_malePolqaWB_8000_d.pcm'
       cal_delay(ref,test,16000)
       pass