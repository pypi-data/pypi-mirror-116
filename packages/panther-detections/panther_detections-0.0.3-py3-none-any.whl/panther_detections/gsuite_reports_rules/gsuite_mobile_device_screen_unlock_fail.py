...
from panther_detections.panther_base_helpers import gsuite_details_lookup as details_lookup
from panther_detections.panther_base_helpers import gsuite_parameter_lookup as param_lookup
