...
class TestMdBacktest(TQBaseTestcase):
    ...
    def test_get_kline_serial_update(self):
        ...
        # 预设服务器端响应
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.md_mock.run(os.path.join(dir_path, "log_file", "test_md_backtest_get_kline_serial_update.script.lzma"))
        md_url = f"ws://127.0.0.1:{self.md_mock.port}/"
    ...
    def test_get_kline_serial_mutli_symbol_update(self):
        ...
        # 预设服务器端响应
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.md_mock.run(os.path.join(dir_path, "log_file", "test_md_backtest_get_kline_serial_mutil_symbol_update.script.lzma"))
        md_url = f"ws://127.0.0.1:{self.md_mock.port}/"
