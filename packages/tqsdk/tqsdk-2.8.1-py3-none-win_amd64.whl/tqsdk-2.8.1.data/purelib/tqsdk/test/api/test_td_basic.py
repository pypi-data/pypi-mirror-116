...
class TestTdBasic(TQBaseTestcase):
    ...
    def test_get_order(self):
        ...
        self.assertEqual(
            str(get_order1),
            "{'order_id': 'PYSDK_insert_1710cf5327ac435a7a97c643656412a9', 'exchange_order_id': 'PYSDK_insert_1710cf5327ac435a7a97c643656412a9', 'exchange_id': 'DCE', 'instrument_id': 'jd2109', 'direction': 'BUY', 'offset': 'OPEN', 'volume_orign': 1, 'volume_left': 0, 'limit_price': nan, 'price_type': 'ANY', 'volume_condition': 'ANY', 'time_condition': 'IOC', 'last_msg': '全部成交', 'status': 'FINISHED', 'user_id': 'TQSIM', 'frozen_margin': 0.0, 'frozen_premium': 0.0}"
        )
        self.assertEqual(
            str(get_order2),
            "{'order_id': 'PYSDK_insert_fd724452ccea71ff4a14876aeaff1a09', 'exchange_order_id': 'PYSDK_insert_fd724452ccea71ff4a14876aeaff1a09', 'exchange_id': 'SHFE', 'instrument_id': 'cu2112', 'direction': 'SELL', 'offset': 'OPEN', 'volume_orign': 2, 'volume_left': 0, 'limit_price': 68900.0, 'price_type': 'LIMIT', 'volume_condition': 'ANY', 'time_condition': 'GFD', 'last_msg': '全部成交', 'status': 'FINISHED', 'user_id': 'TQSIM', 'frozen_margin': 0.0, 'frozen_premium': 0.0}")
    ...
    def test_insert_order_option(self):
        ...
        self.assertEqual(
            {'order_id': 'PYSDK_insert_1710cf5327ac435a7a97c643656412a9',
             'exchange_order_id': 'PYSDK_insert_1710cf5327ac435a7a97c643656412a9', 'exchange_id': 'SHFE',
             'instrument_id': 'cu2106C69000', 'direction': 'BUY', 'offset': 'OPEN', 'volume_orign': 1, 'volume_left': 0,
             'limit_price': 2300.0, 'price_type': 'LIMIT', 'volume_condition': 'ANY', 'time_condition': 'GFD',
             'last_msg': '全部成交', 'status': 'FINISHED', 'user_id': 'TQSIM', 'frozen_margin': 0.0, 'frozen_premium': 0.0},
            order1
        )
        for k, v in order1.trade_records.items():  # 模拟交易为一次性全部成交，因此只有一条成交记录
        ...
        self.assertEqual(
            {'order_id': 'PYSDK_insert_fd724452ccea71ff4a14876aeaff1a09',
             'exchange_order_id': 'PYSDK_insert_fd724452ccea71ff4a14876aeaff1a09', 'exchange_id': 'CZCE',
             'instrument_id': 'SR109C5200', 'direction': 'SELL', 'offset': 'OPEN', 'volume_orign': 2, 'volume_left': 0,
             'limit_price': 270.0, 'price_type': 'LIMIT', 'volume_condition': 'ANY', 'time_condition': 'GFD',
             'last_msg': '全部成交', 'status': 'FINISHED', 'user_id': 'TQSIM', 'frozen_margin': 0.0, 'frozen_premium': 0.0},
            order2
        )
        ...
        self.assertEqual(
            {'order_id': 'PYSDK_insert_c79d679346d4ac7a5c3902b38963dc6e',
             'exchange_order_id': 'PYSDK_insert_c79d679346d4ac7a5c3902b38963dc6e', 'exchange_id': 'DCE',
             'instrument_id': 'm2107-P-3400', 'direction': 'BUY', 'offset': 'OPEN', 'volume_orign': 3, 'volume_left': 0,
             'limit_price': 80.0, 'price_type': 'LIMIT', 'volume_condition': 'ANY', 'time_condition': 'GFD',
             'last_msg': '全部成交', 'status': 'FINISHED', 'user_id': 'TQSIM', 'frozen_margin': 0.0, 'frozen_premium': 0.0},
            order3
        )
