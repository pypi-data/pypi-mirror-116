...
class OneCase:
    ...
    def __init__(self, master_table=None, config=None):
        ...
        self.with_documents = self.config.get('with_documents', True)

        #
        # Means we are doing mass scrape
        #
        self.generic_scrape = self.config.get('generic_scrape', False)
...
if __name__=='__main__':
    o=OneCase(config={'with_documents': False, 'generic_scrape': True})
    o.mass_scrape({'CaseType': 'n', 'CaseDisplayIdentifier': '3851-03-17'})
