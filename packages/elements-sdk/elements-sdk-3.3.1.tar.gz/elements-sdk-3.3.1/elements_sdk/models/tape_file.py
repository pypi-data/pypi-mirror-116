...
class TapeFile(object):
    ...
    def length(self, length):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                length is not None and length > -9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `length`, must be a value less than or equal to `-9223372036854775616`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                length is not None and length < 9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `length`, must be a value greater than or equal to `9223372036854775616`")  # noqa: E501
