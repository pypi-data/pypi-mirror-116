...
class Tape(object):
    ...
    def free_space(self, free_space):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                free_space is not None and free_space > -9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `free_space`, must be a value less than or equal to `-9223372036854775616`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                free_space is not None and free_space < 9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `free_space`, must be a value greater than or equal to `9223372036854775616`")  # noqa: E501
    ...
    def load_counter(self, load_counter):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                load_counter is not None and load_counter > -9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `load_counter`, must be a value less than or equal to `-9223372036854775616`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                load_counter is not None and load_counter < 9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `load_counter`, must be a value greater than or equal to `9223372036854775616`")  # noqa: E501
    ...
    def error_counter(self, error_counter):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                error_counter is not None and error_counter > -9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `error_counter`, must be a value less than or equal to `-9223372036854775616`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                error_counter is not None and error_counter < 9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `error_counter`, must be a value greater than or equal to `9223372036854775616`")  # noqa: E501
