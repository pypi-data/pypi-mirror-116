...
class Interface(object):
    ...
    def speed(self, speed):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                speed is not None and speed > -9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `speed`, must be a value less than or equal to `-9223372036854775616`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                speed is not None and speed < 9223372036854775616):  # noqa: E501
            raise ValueError("Invalid value for `speed`, must be a value greater than or equal to `9223372036854775616`")  # noqa: E501
