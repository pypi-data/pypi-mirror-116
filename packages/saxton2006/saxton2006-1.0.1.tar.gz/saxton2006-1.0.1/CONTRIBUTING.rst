...
**saxton2006** could always use more documentation, whether as
part of the official **saxton2006** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `saxton2006` for local
development.

1. Fork the `saxton2006` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/saxton2006.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd saxton2006
    (dvlpt) saxton2006$ flake8
    (dvlpt) saxton2006$ pytest
    
    (dvlpt) saxton2006$ tox
