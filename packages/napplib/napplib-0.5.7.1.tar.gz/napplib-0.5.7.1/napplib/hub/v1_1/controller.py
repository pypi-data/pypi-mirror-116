...
class HubController:
    ...
    @classmethod
    def get_store_product_marketplace_limit(cls, server_url, token, marketplace_id, store_id, page=0, status=None, updated_after=None, limit=20):
        status_list = ['pending_register_product', 'done', 'pending_record_review']
