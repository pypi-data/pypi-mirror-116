...
const IValidateButtonExtension = new _lumino_coreutils__WEBPACK_IMPORTED_MODULE_2__.Token(PLUGIN_ID);
/**
...
class ValidateButtonExtension {
    constructor() {
        this._validateButtonClicked = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_3__.Signal(this);
        this._validationResultsDisplayed = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_3__.Signal(this);
        this._validationResultsDismissed = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_3__.Signal(this);
    }
    /**
    ...
    createNew(panel, context) {
        const validate = async () => {
            try {
                ...
                let result = await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_4__.showDialog)({
                    title: 'Validation Results',
                    body: new _lumino_widgets__WEBPACK_IMPORTED_MODULE_1__.Widget({ node: body }),
                    buttons: [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_4__.Dialog.okButton()],
                });
        ...
        const validateButton = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_4__.ToolbarButton({
...
//# sourceMappingURL=lib_index_js.de62579f397bf5302463.js.map