...
class RemotingReader:
    ...
    def ReadDateTime(self) -> datetime:
        ba = bytearray(self.binaryReader.getSignedLong().to_bytes(8, byteorder='big', signed=False))
...
class RemotingWriter:
    ...
    def WriteDateTime(self, date_time: datetime):
        ...
        if date_time.tzname() == "UTC":
            ...
            ba[0] = ba[0] | 128
        self.binaryWriter.setSignedLong(int.from_bytes(ba, byteorder='big', signed=False))
