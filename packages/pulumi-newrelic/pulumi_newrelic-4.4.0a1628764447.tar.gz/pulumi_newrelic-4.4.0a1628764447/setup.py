...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '4.4.0-alpha.1628764447+b42db257'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 4.4.0-alpha.1628764447+b42db257`
                """)
            else:
                raise
