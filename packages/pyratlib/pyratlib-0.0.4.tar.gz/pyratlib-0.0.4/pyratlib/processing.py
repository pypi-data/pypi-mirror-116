...
def plotTraj (data, bodyPartTraj, bodyPartBox, cmapType = 'viridis', figureTitle = None, 
...
def heatMapPlot(data, bodyPart, cmapType = 'viridis', figureTitle = None, hSize=6, wSize =8,
                bins = 40, vmax= 1000, fontsize=15, invertY = True, saveName=None, 
                figformat = ".eps"):
    """
