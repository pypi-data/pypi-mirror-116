...
from ndu_gate_camera.utility.download_zipped_helper import download_runner
    ...
    def _connect_with_runners(self):
        ...
        for runner_config in self.runners_configs:
            ...
            try:
                ...
                # TODO - SELF.download_urls içindeki url değerini indir.
                #self._download_runner(runner_type)
                download_runner(runner_type, self.download_urls)
