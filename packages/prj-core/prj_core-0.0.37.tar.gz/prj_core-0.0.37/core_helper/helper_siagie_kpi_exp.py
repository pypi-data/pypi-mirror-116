...
def get_df_por_alum(df_notas_f):
    ...
    dataSet_por_alumno = df_notas_f.assign(
     ...
     NOTA_P_X_ALUMNO = np.where(df_notas_f['DA']=='P',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 

     NOTA_T_X_ALUMNO = np.where(df_notas_f['DA']=='T',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
        
     NOTA_Y_X_ALUMNO = np.where(df_notas_f['DA']=='Y',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 

     NOTA_F_X_ALUMNO = np.where(df_notas_f['DA']=='F',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
           
     NOTA_R_X_ALUMNO = np.where(df_notas_f['DA']=='R',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
        
     NOTA_S_X_ALUMNO = np.where(df_notas_f['DA']=='S',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
     
     NOTA_L_X_ALUMNO = np.where(df_notas_f['DA']=='L',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
     
     
     NOTA_E_X_ALUMNO = np.where(df_notas_f['DA']=='E',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 

     NOTA_D_X_ALUMNO = np.where(df_notas_f['DA']=='D',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
        
     NOTA_G_X_ALUMNO = np.where(df_notas_f['DA']=='G',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 

     NOTA_I_X_ALUMNO = np.where(df_notas_f['DA']=='I',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
           
     NOTA_A_X_ALUMNO = np.where(df_notas_f['DA']=='A',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
        
     NOTA_H_X_ALUMNO = np.where(df_notas_f['DA']=='H',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
     
     NOTA_B_X_ALUMNO = np.where(df_notas_f['DA']=='B',
                                df_notas_f['NOTA_AREA_REGULAR'],np.NaN), 
