class GoogleSheetReader:
    ...
    #####
    Usage:
    t = GoogleSheetReader(scopes,sheetid,rangename,credential,verbal=True) -- Initialization. Check references for more info about these arguments.
    t.read() -- Read the google sheet.
    t.df -- Show the sheet.
    #####
    Ref:
