...
class FEEstimator:
    ...
    def __compute_leverages_Pii(self):
        ...
        self.res['max_leverage'] = (I * Pii).max()

        if self.res['max_leverage'] >= 1:
            leverage_warning = 'Max P_ii is {} which is >= 1. This should not happen - increase your value of ndraw_pii until this warning is no longer raised (ndraw_pii is currently set to {}).'.format(self.res['max_leverage'], self.params['ndraw_pii'])
